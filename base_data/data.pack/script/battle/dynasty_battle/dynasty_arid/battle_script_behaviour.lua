...
local dynasty_character_details = battle_hud_component:CreateComponent("dynasty_mode_character_details", "ui/battle ui/dynasty_mode_character_details.twui.xml");
