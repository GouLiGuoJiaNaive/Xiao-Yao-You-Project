...
-------------------------------------------------------------------------------
------------------ Siege Benchmark ---- Youbeiping 1.0 -------------------------
-------------------------------------------------------------------------------
...
function play_cutscene_intro()
	...
	cutscene_intro:action(function() cam:move_to(v(793.090698,156.122406,-298.931396),v(631.185547,103.544327,-122.631958), 0, true, -1) end, 0);
	cutscene_intro:action(function() cam:move_to(v(633.402893,84.362473,-16.755054),v(451.482422,33.952148,139.523239), 7, true, 0) end, 5000);
	cutscene_intro:action(function() cam:move_to(v(645.132019,83.351799,71.067314),v(415.538635,8.620064,29.100819), 7, true, 0) end, 13000);
	
	-- players right side pan & preparing for inf wall climb -- 
	cutscene_intro:action(function() cam:move_to(v(414.995667,96.651062,174.724731),v(185.978577,9.499535,170.839447), 9, false, -1) end, 21000);

	-- Guan yu cav charge -- 
	cutscene_intro:action(function() cam:move_to(v(276.279602,72.689919,129.652542),v(155.368805,32.817268,339.05719), 10, true, 0) end, 26000);
	cutscene_intro:action(function() cam:move_to(v(217.878143,67.856285,146.018204),v(411.845398,3.866875,281.450104), 10, true, -1) end, 42000);
	
	-- Sun ce Cav Charge --
	cutscene_intro:action(function() cam:move_to(v(-322.328552,104.424911,-45.956818),v(-180.286758,13.515541,131.861099), 5, true, -1) end, 55000);
	cutscene_intro:action(function() cam:move_to(v(-322.328552,104.424911,-45.956818),v(-100.790817,1.535332,-65.815224), 8, true, -1) end, 63000);
	
	-- Regular units attack elite --
	cutscene_intro:action(function() cam:move_to(v(-38.234104,104.424896,-212.067108),v(113.052567,-26.480682,-70.519592), 6, true, -1) end, 73000);
	cutscene_intro:action(function() cam:move_to(v(55.238892,86.335831,-202.073639),v(-121.973831,-18.204506,-68.932663), 6, true, -1) end, 80000);
	
	-- Regular units attack elite GATE --
	cutscene_intro:action(function() cam:move_to(v(161.907455,91.150902,-30.032049),v(348.125885,17.259758,111.115059), 6, true, -1) end, 85000);
	cutscene_intro:action(function() cam:move_to(v(256.061646,75.769867,-5.569464),v(225.867828,-13.843056,220.522644), 6, true, -1) end, 95000);
	
	-- Huang Zhong attacks Cao Cao --
	cutscene_intro:action(function() cam:move_to(v(170.664246,70.189171,-114.256027),v(273.519531,8.972679,-328.10965), 6, true, -1) end, 100000);
	cutscene_intro:action(function() cam:move_to(v(171.278351,74.122574,-230.539474),v(342.552368,-14.502907,-79.308502), 6, true, -1) end, 110000);
	cutscene_intro:action(function() cam:move_to(v(36.433533,150.785385,-579.471436),v(118.595146,93.0345,-355.921539), 6, true, -1) end, 115000);
