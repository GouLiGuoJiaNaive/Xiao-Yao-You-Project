...
cm:add_first_tick_callback_mp_new(
	function() 
		...
		cm:set_camera_position(
			364.050842,	-- camera x position 
			276.137878,	-- camera y position 
			13.779033,	-- camera d position 
			-0.071461,	-- camera b position 
...
function cutscene_intro_play()
	...
	cutscene_intro:action( function() cutscene_intro:cindy_playback("script/campaign/dlc04_mandate/factions/campaign_intro_cutscenes/scenes/scene_01_cao_cao.CindyScene", 0, 4); end, 0 );
	
	cutscene_intro:add_cinematic_trigger_listener( "cao_cao_advisor_01", function() cm:show_advice("3k_dlc04_campaign_faction_intro_cao_cao_01_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "cao_cao_advisor_02", function() cm:show_advice("3k_dlc04_campaign_faction_intro_cao_cao_02_cao_cao"); end );
	cutscene_intro:add_cinematic_trigger_listener( "cao_cao_advisor_03", function() cm:show_advice("3k_dlc04_campaign_faction_intro_cao_cao_03_cao_cao"); end );
	cutscene_intro:add_cinematic_trigger_listener( "cao_cao_advisor_04", function() cm:show_advice("3k_dlc04_campaign_faction_intro_cao_cao_04_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "cao_cao_advisor_05", function() cm:show_advice("3k_dlc04_campaign_faction_intro_cao_cao_05_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "cao_cao_advisor_06", function() cm:show_advice("3k_dlc04_campaign_faction_intro_cao_cao_06_cao_cao"); end );
	cutscene_intro:add_cinematic_trigger_listener( "cao_cao_advisor_07", function() cm:show_advice("3k_dlc04_campaign_faction_intro_cao_cao_07_advisor"); end );
...
function cutscene_intro_skipped(advice_to_play)
	...
	cm:show_advice("3k_dlc04_campaign_faction_intro_cao_cao_01_advisor");
	cm:show_advice("3k_dlc04_campaign_faction_intro_cao_cao_02_cao_cao");
	cm:show_advice("3k_dlc04_campaign_faction_intro_cao_cao_03_cao_cao");
	cm:show_advice("3k_dlc04_campaign_faction_intro_cao_cao_04_advisor");
	cm:show_advice("3k_dlc04_campaign_faction_intro_cao_cao_05_advisor");
	cm:show_advice("3k_dlc04_campaign_faction_intro_cao_cao_06_cao_cao");
	cm:show_advice("3k_dlc04_campaign_faction_intro_cao_cao_07_advisor");
...
function add_turn_one_character_map_pins()
	...
	local map_pin_characters = 
		{
			["3k_dlc04_startpos_pin_cao_cao_cao_cao"] = cm:query_faction("3k_main_faction_cao_cao"):faction_leader():cqi(),
			["3k_dlc04_startpos_pin_cao_cao_cao_song"] = cm:query_faction("3k_dlc04_faction_cao_song"):faction_leader():cqi(),
			["3k_dlc04_startpos_pin_cao_cao_zhang_jue"] = cm:query_faction("3k_dlc04_faction_zhang_jue"):faction_leader():cqi()
		}
...
function add_turn_one_settlement_map_pins()
	...
	local map_pin_settlements = 
		{
			["3k_dlc04_startpos_pin_cao_cao_luoyang"] = "3k_main_luoyang_capital"
		}
