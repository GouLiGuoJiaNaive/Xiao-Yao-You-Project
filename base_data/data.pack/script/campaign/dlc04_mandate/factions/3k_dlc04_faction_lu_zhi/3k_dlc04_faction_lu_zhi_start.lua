...
cm:add_first_tick_callback_mp_new(
	function() 
		...
		cm:set_camera_position(
			321.718811,	-- camera x position 
			387.751709,	-- camera y position 
			13.912934,	-- camera d position 
			-0.000399,	-- camera b position 
			5.96238	-- camera h position
		);
	end
);
...
cm:add_first_tick_callback_mp_each(
	function()
		...
		output("Each MP Game Events Fired for 3k_dlc04_faction_lu_zhi");
	end
);
...
function cutscene_intro_play()
	...
	cutscene_intro:action( function() cutscene_intro:cindy_playback("script/campaign/dlc04_mandate/factions/campaign_intro_cutscenes/scenes/scene_01_lu_zhi.CindyScene", 0, 3); end, 0 );
	
	cutscene_intro:add_cinematic_trigger_listener( "lu_zhi_advisor_01", function() cm:show_advice("3k_dlc04_campaign_faction_intro_lu_zhi_01_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "lu_zhi_advisor_02", function() cm:show_advice("3k_dlc04_campaign_faction_intro_lu_zhi_02_lu_zhi"); end );
	cutscene_intro:add_cinematic_trigger_listener( "lu_zhi_advisor_03", function() cm:show_advice("3k_dlc04_campaign_faction_intro_lu_zhi_03_lu_zhi"); end );
	cutscene_intro:add_cinematic_trigger_listener( "lu_zhi_advisor_04", function() cm:show_advice("3k_dlc04_campaign_faction_intro_lu_zhi_04_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "lu_zhi_advisor_05", function() cm:show_advice("3k_dlc04_campaign_faction_intro_lu_zhi_05_lu_zhi"); end );
	cutscene_intro:add_cinematic_trigger_listener( "lu_zhi_advisor_06", function() cm:show_advice("3k_dlc04_campaign_faction_intro_lu_zhi_06_advisor"); end );
...
function cutscene_intro_skipped(advice_to_play)
	...
	cm:show_advice("3k_dlc04_campaign_faction_intro_lu_zhi_01_advisor");
	cm:show_advice("3k_dlc04_campaign_faction_intro_lu_zhi_02_lu_zhi");
	cm:show_advice("3k_dlc04_campaign_faction_intro_lu_zhi_03_lu_zhi");
	cm:show_advice("3k_dlc04_campaign_faction_intro_lu_zhi_04_advisor");
	cm:show_advice("3k_dlc04_campaign_faction_intro_lu_zhi_05_lu_zhi");
	cm:show_advice("3k_dlc04_campaign_faction_intro_lu_zhi_06_advisor");
...
---------------------------------------------------------------
--	Turn One Region Visibility: Lu Zhi
---------------------------------------------------------------
...
function turn_one_region_visibility()
	...
	local modify_faction = cm:modify_faction("3k_dlc04_faction_lu_zhi");
...
---------------------------------------------------------------
--	Turn One Map Pins: Lu Zhi -- [DS]
---------------------------------------------------------------

function add_turn_one_character_map_pins()
	output("3k_dlc04_faction_lu_zhi_start.lua: Adding turn one character map pins for Lu Zhi's faction.");

	-- Create a table connecting our map_pin records with our derived character CQIs
	local map_pin_characters = 
		{
			["3k_dlc04_startpos_pin_lu_zhi_lu_zhi"] = cm:query_faction("3k_dlc04_faction_lu_zhi"):faction_leader():cqi(),
			["3k_dlc04_startpos_pin_lu_zhi_zhang_jue"] = cm:query_faction("3k_dlc04_faction_zhang_jue"):faction_leader():cqi()
		}
...
function add_turn_one_settlement_map_pins()
	output("3k_dlc04_faction_lu_zhi_start.lua: Adding turn one settlement map pins for Sun Jian's faction.");

	-- Create a table connecting our map_pin records with our region records /settlements
	local map_pin_settlements = 
		{
			["3k_dlc04_startpos_pin_lu_zhi_luoyang"] = "3k_main_luoyang_capital"
		}
...
function end_turn_map_pin_removal_listener()
	output("3k_dlc04_faction_lu_zhi_start.lua: Adding End Turn Map Pin Removal Listener.");
	...
	core:add_listener(
		...
		function(context)
			output("3k_dlc04_faction_lu_zhi_start.lua: Turn one has ended.");
			return context:query_model():turn_number() == 1;
		end,

		-- Remove the scripted pins.
		function(context)
			output("3k_dlc04_faction_lu_zhi_start.lua: Removing guide map pins.");
