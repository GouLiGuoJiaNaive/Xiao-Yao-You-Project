...
cm:add_first_tick_callback_mp_new(
	function() 
		...
		cm:set_camera_position(
			317.930237,	-- camera x position 
			437.041962,	-- camera y position 
			15.795013,	-- camera d position 
			0.000002,	-- camera b position 
			7.715699	-- camera h position			
		);
	end
);
...
function cutscene_intro_play()
	...
	cutscene_intro:action( function() cutscene_intro:cindy_playback("script/campaign/dlc04_mandate/factions/campaign_intro_cutscenes/scenes/scene_01_zhang_jue.CindyScene", 0, 3); end, 0 );
	
	cutscene_intro:add_cinematic_trigger_listener( "zhang_jue_advisor_01", function() cm:show_advice("3k_dlc04_campaign_faction_intro_zhang_jue_01_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "zhang_jue_advisor_02", function() cm:show_advice("3k_dlc04_campaign_faction_intro_zhang_jue_02_zhang_jue"); end );
	cutscene_intro:add_cinematic_trigger_listener( "zhang_jue_advisor_03", function() cm:show_advice("3k_dlc04_campaign_faction_intro_zhang_jue_03_zhang_jue"); end );
	cutscene_intro:add_cinematic_trigger_listener( "zhang_jue_advisor_04", function() cm:show_advice("3k_dlc04_campaign_faction_intro_zhang_jue_04_zhang_liang"); end );
	cutscene_intro:add_cinematic_trigger_listener( "zhang_jue_advisor_05", function() cm:show_advice("3k_dlc04_campaign_faction_intro_zhang_jue_05_zhang_bao"); end );
	cutscene_intro:add_cinematic_trigger_listener( "zhang_jue_advisor_06", function() cm:show_advice("3k_dlc04_campaign_faction_intro_zhang_jue_06_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "zhang_jue_advisor_07", function() cm:show_advice("3k_dlc04_campaign_faction_intro_zhang_jue_07_zhang_jue"); end );
	cutscene_intro:add_cinematic_trigger_listener( "zhang_jue_advisor_08", function() cm:show_advice("3k_dlc04_campaign_faction_intro_zhang_jue_08_advisor"); end );
...
function cutscene_intro_skipped(advice_to_play)
	...
	cm:show_advice("3k_dlc04_campaign_faction_intro_zhang_jue_01_advisor");
	cm:show_advice("3k_dlc04_campaign_faction_intro_zhang_jue_02_zhang_jue");
	cm:show_advice("3k_dlc04_campaign_faction_intro_zhang_jue_03_zhang_jue");
	cm:show_advice("3k_dlc04_campaign_faction_intro_zhang_jue_04_zhang_bao");
	cm:show_advice("3k_dlc04_campaign_faction_intro_zhang_jue_05_zhang_liang");
	cm:show_advice("3k_dlc04_campaign_faction_intro_zhang_jue_06_advisor");
	cm:show_advice("3k_dlc04_campaign_faction_intro_zhang_jue_07_zhang_jue");
...
---------------------------------------------------------------
--	Turn One Region Visibility: Zhang Jue
---------------------------------------------------------------
...
function turn_one_region_visibility()
	...
	local modify_faction = cm:modify_faction("3k_dlc04_faction_zhang_jue");
...
---------------------------------------------------------------
--	Turn One Map Pins: Zhang Jue -- [DS]
---------------------------------------------------------------

function add_turn_one_character_map_pins()
	output("3k_dlc04_faction_zhang_jue_start.lua: Adding turn one character map pins for Zhang Jue's faction.");

	-- Create a table connecting our map_pin records with our derived character CQIs
	local map_pin_characters = 
		{
			["3k_dlc04_startpos_pin_zhang_jue_zhang_jue"] = cm:query_faction("3k_dlc04_faction_zhang_jue"):faction_leader():cqi(),
			["3k_dlc04_startpos_pin_zhang_jue_zhang_bao"] = cm:query_faction("3k_dlc04_faction_zhang_bao"):faction_leader():cqi(),
			["3k_dlc04_startpos_pin_zhang_jue_zhang_liang"] = cm:query_faction("3k_dlc04_faction_zhang_liang"):faction_leader():cqi()
		}
...
function add_turn_one_settlement_map_pins()
	...
	local map_pin_settlements = 
		{
			["3k_dlc04_startpos_pin_zhang_jue_luoyang"] = "3k_main_luoyang_capital"
		}
...
function end_turn_map_pin_removal_listener()
	output("3k_dlc04_faction_zhang_jue_start.lua: Adding End Turn Map Pin Removal Listener.");
	...
	core:add_listener(
		...
		function(context)
			output("3k_dlc04_faction_zhang_jue_start.lua: Turn one has ended.");
			return context:query_model():turn_number() == 1;
		end,

		-- Remove the scripted pins.
		function(context)
			output("3k_dlc04_faction_zhang_jue_start.lua: Removing guide map pins.");
