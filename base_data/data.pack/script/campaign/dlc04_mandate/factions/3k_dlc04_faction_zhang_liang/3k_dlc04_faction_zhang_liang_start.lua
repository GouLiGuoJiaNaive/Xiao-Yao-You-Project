...
cm:add_first_tick_callback_mp_new(
	function() 
		...
		cm:set_camera_position(
			315.798126,	-- camera x position 
			404.964691,	-- camera y position 
			21.346741,	-- camera d position 
			0.000009,	-- camera b position 
			13.457766	-- camera h position			
		);
	end
);
...
function cutscene_intro_play()
	...
	cutscene_intro:action( function() cutscene_intro:cindy_playback("script/campaign/dlc04_mandate/factions/campaign_intro_cutscenes/scenes/scene_01_zhang_liang.CindyScene", 0, 3); end, 0 );
	
	cutscene_intro:add_cinematic_trigger_listener( "zhang_liang_advisor_01", function() cm:show_advice("3k_dlc04_campaign_faction_intro_zhang_liang_01_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "zhang_liang_advisor_02", function() cm:show_advice("3k_dlc04_campaign_faction_intro_zhang_liang_02_zhang_liang"); end );
	cutscene_intro:add_cinematic_trigger_listener( "zhang_liang_advisor_03", function() cm:show_advice("3k_dlc04_campaign_faction_intro_zhang_liang_03_zhang_liang"); end );
	cutscene_intro:add_cinematic_trigger_listener( "zhang_liang_advisor_04", function() cm:show_advice("3k_dlc04_campaign_faction_intro_zhang_liang_04_zhang_jue"); end );
	cutscene_intro:add_cinematic_trigger_listener( "zhang_liang_advisor_05", function() cm:show_advice("3k_dlc04_campaign_faction_intro_zhang_liang_05_zhang_bao"); end );
	cutscene_intro:add_cinematic_trigger_listener( "zhang_liang_advisor_06", function() cm:show_advice("3k_dlc04_campaign_faction_intro_zhang_liang_06_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "zhang_liang_advisor_07", function() cm:show_advice("3k_dlc04_campaign_faction_intro_zhang_liang_07_zhang_liang"); end );
	cutscene_intro:add_cinematic_trigger_listener( "zhang_liang_advisor_08", function() cm:show_advice("3k_dlc04_campaign_faction_intro_zhang_liang_08_advisor"); end );
...
function cutscene_intro_skipped(advice_to_play)
	...
	cm:show_advice("3k_dlc04_campaign_faction_intro_zhang_liang_01_advisor");
	cm:show_advice("3k_dlc04_campaign_faction_intro_zhang_liang_02_zhang_liang");
	cm:show_advice("3k_dlc04_campaign_faction_intro_zhang_liang_03_zhang_liang");
	cm:show_advice("3k_dlc04_campaign_faction_intro_zhang_liang_04_zhang_jue");
	cm:show_advice("3k_dlc04_campaign_faction_intro_zhang_liang_05_zhang_bao");
	cm:show_advice("3k_dlc04_campaign_faction_intro_zhang_liang_06_advisor");
	cm:show_advice("3k_dlc04_campaign_faction_intro_zhang_liang_07_zhang_liang");
	cm:show_advice("3k_dlc04_campaign_faction_intro_zhang_liang_08_advisor");
...
---------------------------------------------------------------
--	Turn One Region Visibility: Zhang Liang
---------------------------------------------------------------
...
function turn_one_region_visibility()
	...
	local modify_faction = cm:modify_faction("3k_dlc04_faction_zhang_liang");
	...
	-- Zhang Jue
	modify_faction:make_region_seen_in_shroud("3k_main_zhongshan_capital");
	modify_faction:make_region_seen_in_shroud("3k_main_zhongshan_resource_1");

	-- Zhang Bao
	modify_faction:make_region_seen_in_shroud("3k_main_anping_capital");
	modify_faction:make_region_seen_in_shroud("3k_main_anping_resource_1");
...
---------------------------------------------------------------
--	Turn One Map Pins: Zhang Liang -- [DS]
---------------------------------------------------------------

function add_turn_one_character_map_pins()
	output("3k_dlc04_faction_zhang_liang_start.lua: Adding turn one character map pins for Zhang Liang's faction.");

	-- Find pinned faction leader character cqis from their faction records
	local map_pin_characters = 
		{
			["3k_dlc04_startpos_pin_zhang_liang_zhang_jue"] = cm:query_faction("3k_dlc04_faction_zhang_jue"):faction_leader():cqi(),
			["3k_dlc04_startpos_pin_zhang_liang_zhang_bao"] = cm:query_faction("3k_dlc04_faction_zhang_bao"):faction_leader():cqi(),
			["3k_dlc04_startpos_pin_zhang_liang_zhang_liang"] = cm:query_faction("3k_dlc04_faction_zhang_liang"):faction_leader():cqi()
		}
...
function add_turn_one_settlement_map_pins()
	...
	local map_pin_settlements = 
		{
			["3k_dlc04_startpos_pin_zhang_liang_luoyang"] = "3k_main_luoyang_capital"
		}
...
function end_turn_map_pin_removal_listener()
	output("3k_dlc04_faction_zhang_liang_start.lua: Adding End Turn Map Pin Removal Listener.");
	...
	core:add_listener(
		...
		function(context)
			output("3k_dlc04_faction_zhang_liang_start.lua: Turn one has ended.");
			return context:query_model():turn_number() == 1;
		end,

		-- Remove the scripted pins.
		function(context)
			output("3k_dlc04_faction_zhang_liang_start.lua: Removing guide map pins.");
