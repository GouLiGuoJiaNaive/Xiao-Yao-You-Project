...
cm:add_first_tick_callback_mp_new(
	function() 
		...
		cm:set_camera_position(
			395.354462,	-- camera x position 
			232.377151,	-- camera y position 
			29.401993,	-- camera d position 
...
function cutscene_intro_play()
	...
	cutscene_intro:action( function() cutscene_intro:cindy_playback("script/campaign/dlc04_mandate/factions/campaign_intro_cutscenes/scenes/scene_01_sun_jian.CindyScene", 0, 6); end, 0 );

	cutscene_intro:add_cinematic_trigger_listener( "sun_jian_advisor_01", function() cm:show_advice("3k_dlc04_campaign_faction_intro_sun_jian_01_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "sun_jian_advisor_02", function() cm:show_advice("3k_dlc04_campaign_faction_intro_sun_jian_02_sun_jian"); end );
	cutscene_intro:add_cinematic_trigger_listener( "sun_jian_advisor_03", function() cm:show_advice("3k_dlc04_campaign_faction_intro_sun_jian_03_sun_jian"); end );
	cutscene_intro:add_cinematic_trigger_listener( "sun_jian_advisor_04", function() cm:show_advice("3k_dlc04_campaign_faction_intro_sun_jian_04_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "sun_jian_advisor_05", function() cm:show_advice("3k_dlc04_campaign_faction_intro_sun_jian_05_sun_jian"); end );
	cutscene_intro:add_cinematic_trigger_listener( "sun_jian_advisor_06", function() cm:show_advice("3k_dlc04_campaign_faction_intro_sun_jian_06_advisor"); end );
...
function cutscene_intro_skipped(advice_to_play)
	...
	cm:show_advice("3k_dlc04_campaign_faction_intro_sun_jian_01_advisor");
	cm:show_advice("3k_dlc04_campaign_faction_intro_sun_jian_02_sun_jian");
	cm:show_advice("3k_dlc04_campaign_faction_intro_sun_jian_03_sun_jian");
	cm:show_advice("3k_dlc04_campaign_faction_intro_sun_jian_04_advisor");
	cm:show_advice("3k_dlc04_campaign_faction_intro_sun_jian_05_sun_jian");
	cm:show_advice("3k_dlc04_campaign_faction_intro_sun_jian_06_advisor");
...
function add_turn_one_character_map_pins()
	...
	local map_pin_characters = 
		{
			["3k_dlc04_startpos_pin_sun_jian_sun_jian"] = cm:query_faction("3k_main_faction_sun_jian"):faction_leader():cqi(),
			["3k_dlc04_startpos_pin_sun_jian_zhang_jue"] = cm:query_faction("3k_dlc04_faction_zhang_jue"):faction_leader():cqi()
		}
...
function add_turn_one_settlement_map_pins()
	...
	local map_pin_settlements = 
		{
			["3k_dlc04_startpos_pin_sun_jian_luoyang"] = "3k_main_luoyang_capital"
		}
