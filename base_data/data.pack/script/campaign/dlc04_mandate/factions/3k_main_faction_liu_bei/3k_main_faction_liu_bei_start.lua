...
cm:add_first_tick_callback_mp_new(
	function() 
		...
		cm:set_camera_position(
			340.128876,	-- camera x position 
			407.093689,	-- camera y position 
			13.779037,	-- camera d position 
			0.018643,	-- camera b position 
...
function cutscene_intro_play()
	...
	cutscene_intro:action( function() cutscene_intro:cindy_playback("script/campaign/dlc04_mandate/factions/campaign_intro_cutscenes/scenes/scene_01_liu_bei.CindyScene", 0, 4); end, 0	);

	cutscene_intro:add_cinematic_trigger_listener( "liu_bei_advisor_01", function() cm:show_advice("3k_dlc04_campaign_faction_intro_liu_bei_01_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "liu_bei_advisor_02", function() cm:show_advice("3k_dlc04_campaign_faction_intro_liu_bei_02_liu_bei"); end );
	cutscene_intro:add_cinematic_trigger_listener( "liu_bei_advisor_03", function() cm:show_advice("3k_dlc04_campaign_faction_intro_liu_bei_03_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "liu_bei_advisor_04", function() cm:show_advice("3k_dlc04_campaign_faction_intro_liu_bei_04_liu_bei"); end );
	cutscene_intro:add_cinematic_trigger_listener( "liu_bei_advisor_05", function() cm:show_advice("3k_dlc04_campaign_faction_intro_liu_bei_05_liu_bei"); end );
	cutscene_intro:add_cinematic_trigger_listener( "liu_bei_advisor_06", function() cm:show_advice("3k_dlc04_campaign_faction_intro_liu_bei_06_advisor"); end );
...
function cutscene_intro_skipped(advice_to_play)
	...
	cm:show_advice("3k_dlc04_campaign_faction_intro_liu_bei_01_advisor");
	cm:show_advice("3k_dlc04_campaign_faction_intro_liu_bei_02_liu_bei");
	cm:show_advice("3k_dlc04_campaign_faction_intro_liu_bei_03_advisor");
	cm:show_advice("3k_dlc04_campaign_faction_intro_liu_bei_04_liu_bei");
	cm:show_advice("3k_dlc04_campaign_faction_intro_liu_bei_05_liu_bei");
	cm:show_advice("3k_dlc04_campaign_faction_intro_liu_bei_06_advisor");
...
function add_turn_one_character_map_pins()
	output("3k_main_faction_liu_bei_start.lua: Adding turn one character map pins for Cao Cao's faction.");

	-- Create a table connecting our map_pin records with our derived character CQIs
	local map_pin_characters = 
		{
			["3k_dlc04_startpos_pin_liu_bei_liu_bei"] = cm:query_faction("3k_main_faction_liu_bei"):faction_leader():cqi(),
			["3k_dlc04_startpos_pin_liu_bei_lu_zhi"] = cm:query_faction("3k_dlc04_faction_lu_zhi"):faction_leader():cqi(),
			["3k_dlc04_startpos_pin_liu_bei_zhang_jue"] = cm:query_faction("3k_dlc04_faction_zhang_jue"):faction_leader():cqi()
		}
...
function add_turn_one_settlement_map_pins()
	output("3k_main_faction_liu_bei_start.lua: Adding turn one settlement map pins for Liu Bei's faction.");

	-- Create a table connecting our map_pin records with our region records /settlements
	local map_pin_settlements = 
		{
			["3k_dlc04_startpos_pin_liu_bei_luoyang"] = "3k_main_luoyang_capital"
		}
