...
cm:add_first_tick_callback_mp_new(
	function() 
		...
		cm:set_camera_position(
			314.38504,	-- camera x position 
			349.520355,	-- camera y position 
			21.22522,	-- camera d position 
			0.000004,	-- camera b position 
			13.327213	-- camera h position
...
cm:add_first_tick_callback_mp_each(
	function()
		...
		output("Each MP Game Events Fired for 3k_dlc04_faction_prince_liu_chong");
	end
);
...
function cutscene_intro_play()
	...
	cutscene_intro:action( function() cutscene_intro:cindy_playback("script/campaign/dlc04_mandate/factions/campaign_intro_cutscenes/scenes/scene_01_prince_liu_chong.CindyScene", 0, 3); end, 0 );
	
	cutscene_intro:add_cinematic_trigger_listener( "liu_chong_advisor_01", function() cm:show_advice("3k_dlc04_campaign_faction_intro_prince_liu_chong_01_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "liu_chong_advisor_02", function() cm:show_advice("3k_dlc04_campaign_faction_intro_prince_liu_chong_02_liu_chong"); end );
	cutscene_intro:add_cinematic_trigger_listener( "liu_chong_advisor_03", function() cm:show_advice("3k_dlc04_campaign_faction_intro_prince_liu_chong_03_liu_chong"); end );
	cutscene_intro:add_cinematic_trigger_listener( "liu_chong_advisor_04", function() cm:show_advice("3k_dlc04_campaign_faction_intro_prince_liu_chong_04_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "liu_chong_advisor_05", function() cm:show_advice("3k_dlc04_campaign_faction_intro_prince_liu_chong_05_liu_chong"); end );
	cutscene_intro:add_cinematic_trigger_listener( "liu_chong_advisor_06", function() cm:show_advice("3k_dlc04_campaign_faction_intro_prince_liu_chong_06_advisor"); end );
...
function cutscene_intro_skipped(advice_to_play)
	...
	cm:show_advice("3k_dlc04_campaign_faction_intro_prince_liu_chong_01_advisor");
	cm:show_advice("3k_dlc04_campaign_faction_intro_prince_liu_chong_02_liu_chong");
	cm:show_advice("3k_dlc04_campaign_faction_intro_prince_liu_chong_03_liu_chong");
	cm:show_advice("3k_dlc04_campaign_faction_intro_prince_liu_chong_04_advisor");
	cm:show_advice("3k_dlc04_campaign_faction_intro_prince_liu_chong_05_liu_chong");
	cm:show_advice("3k_dlc04_campaign_faction_intro_prince_liu_chong_06_advisor");
...
---------------------------------------------------------------
--	Turn One Region Visibility: Liu Chong
---------------------------------------------------------------
...
---------------------------------------------------------------
--	Turn One Map Pins: Liu Chong -- [DS]
---------------------------------------------------------------

function add_turn_one_character_map_pins()
	output("3k_dlc04_faction_prince_liu_chong_start.lua: Adding turn one character map pins for Liu Chong's faction.");

	-- Create a table connecting our map_pin records with our derived character CQIs
	local map_pin_characters = 
		{
			["3k_dlc04_startpos_pin_liu_chong_liu_chong"] = cm:query_faction("3k_dlc04_faction_prince_liu_chong"):faction_leader():cqi(),
			["3k_dlc04_startpos_pin_liu_chong_zhang_jue"] = cm:query_faction("3k_dlc04_faction_zhang_jue"):faction_leader():cqi()
		}
...
function add_turn_one_settlement_map_pins()
	...
	local map_pin_settlements = 
		{
			["3k_dlc04_startpos_pin_liu_chong_luoyang"] = "3k_main_luoyang_capital"
		}
...
function end_turn_map_pin_removal_listener()
	output("3k_dlc04_faction_prince_liu_chong_start.lua: Adding End Turn Map Pin Removal Listener.");
	...
	core:add_listener(
		...
		function(context)
			output("3k_dlc04_faction_prince_liu_chong_start.lua: Turn one has ended.");
			return context:query_model():turn_number() == 1;
		end,

		-- Remove the scripted pins.
		function(context)
			output("3k_dlc04_faction_prince_liu_chong_start.lua: Removing guide map pins.");
