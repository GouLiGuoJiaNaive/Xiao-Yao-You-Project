...
cm:add_first_tick_callback_mp_new(
	function() 
		...
		cm:set_camera_position(
			264.820129,	-- camera x position 
			276.342041,	-- camera y position 
			13.779036,	-- camera d position 
			-0.191602,	-- camera b position 
...
function cutscene_intro_play()
	...
	cutscene_intro:action( function() cutscene_intro:cindy_playback("script/campaign/dlc04_mandate/factions/campaign_intro_cutscenes/scenes/scene_01_liu_bao.CindyScene", 0, 3); end, 0 );

	cutscene_intro:add_cinematic_trigger_listener( "liu_bao_advisor_01", function() cm:show_advice("3k_dlc04_campaign_faction_intro_liu_biao_01_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "liu_bao_advisor_02", function() cm:show_advice("3k_dlc04_campaign_faction_intro_liu_biao_02_liu_biao"); end );
	cutscene_intro:add_cinematic_trigger_listener( "liu_bao_advisor_03", function() cm:show_advice("3k_dlc04_campaign_faction_intro_liu_biao_03_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "liu_bao_advisor_04", function() cm:show_advice("3k_dlc04_campaign_faction_intro_liu_biao_04_liu_biao"); end );
	cutscene_intro:add_cinematic_trigger_listener( "liu_bao_advisor_05", function() cm:show_advice("3k_dlc04_campaign_faction_intro_liu_biao_05_liu_biao"); end );
	cutscene_intro:add_cinematic_trigger_listener( "liu_bao_advisor_06", function() cm:show_advice("3k_dlc04_campaign_faction_intro_liu_biao_06_advisor"); end );
...
function cutscene_intro_skipped(advice_to_play)
	...
	cm:show_advice("3k_dlc04_campaign_faction_intro_liu_biao_01_advisor");
	cm:show_advice("3k_dlc04_campaign_faction_intro_liu_biao_02_liu_biao");
	cm:show_advice("3k_dlc04_campaign_faction_intro_liu_biao_03_advisor");
	cm:show_advice("3k_dlc04_campaign_faction_intro_liu_biao_04_liu_biao");
	cm:show_advice("3k_dlc04_campaign_faction_intro_liu_biao_05_liu_biao");
	cm:show_advice("3k_dlc04_campaign_faction_intro_liu_biao_06_advisor");
...
function add_turn_one_character_map_pins()
	...
	local map_pin_characters = 
		{
			["3k_dlc04_startpos_pin_liu_biao_liu_biao"] = cm:query_faction("3k_main_faction_liu_biao"):faction_leader():cqi(),
			["3k_dlc04_startpos_pin_liu_biao_zhang_jue"] = cm:query_faction("3k_dlc04_faction_zhang_jue"):faction_leader():cqi()
		}
...
function add_turn_one_settlement_map_pins()
	...
	local map_pin_settlements = 
		{
			["3k_dlc04_startpos_pin_liu_biao_luoyang"] = "3k_main_luoyang_capital"
		}
