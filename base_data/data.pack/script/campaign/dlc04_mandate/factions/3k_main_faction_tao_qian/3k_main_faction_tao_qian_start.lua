...
cm:add_first_tick_callback_mp_new(
	function() 
		...
		cm:set_camera_position(
			409.692993,	-- camera x position 
			355.18399,	-- camera y position 
			21.225225,	-- camera d position 
			-0.080551,	-- camera b position 
			13.327211	-- camera h position			
		);
	end
);
...
function cutscene_intro_play()
	...
	cutscene_intro:action( function() cutscene_intro:cindy_playback("script/campaign/dlc04_mandate/factions/campaign_intro_cutscenes/scenes/scene_01_tao_qian.CindyScene", 0, 3); end, 0 );
	
	cutscene_intro:add_cinematic_trigger_listener( "tao_qian_advisor_01", function() cm:show_advice("3k_dlc04_campaign_faction_intro_tao_qian_01_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "tao_qian_advisor_02", function() cm:show_advice("3k_dlc04_campaign_faction_intro_tao_qian_02_tao_qian"); end );
	cutscene_intro:add_cinematic_trigger_listener( "tao_qian_advisor_03", function() cm:show_advice("3k_dlc04_campaign_faction_intro_tao_qian_03_tao_qian"); end );
	cutscene_intro:add_cinematic_trigger_listener( "tao_qian_advisor_04", function() cm:show_advice("3k_dlc04_campaign_faction_intro_tao_qian_04_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "tao_qian_advisor_05", function() cm:show_advice("3k_dlc04_campaign_faction_intro_tao_qian_05_tao_qian"); end );
	cutscene_intro:add_cinematic_trigger_listener( "tao_qian_advisor_06", function() cm:show_advice("3k_dlc04_campaign_faction_intro_tao_qian_06_advisor"); end );
...
function cutscene_intro_skipped(advice_to_play)
	...
	cm:show_advice("3k_dlc04_campaign_faction_intro_tao_qian_01_advisor");
	cm:show_advice("3k_dlc04_campaign_faction_intro_tao_qian_02_tao_qian");
	cm:show_advice("3k_dlc04_campaign_faction_intro_tao_qian_03_tao_qian");
	cm:show_advice("3k_dlc04_campaign_faction_intro_tao_qian_04_advisor");
	cm:show_advice("3k_dlc04_campaign_faction_intro_tao_qian_05_tao_qian");
	cm:show_advice("3k_dlc04_campaign_faction_intro_tao_qian_06_advisor");
...
---------------------------------------------------------------
--	Turn One Region Visibility: Tao Qian
---------------------------------------------------------------
...
function add_turn_one_character_map_pins()
	...
	local map_pin_characters = 
		{
			["3k_dlc04_startpos_pin_tao_qian_tao_qian"] = cm:query_faction("3k_main_faction_tao_qian"):faction_leader():cqi(),
			["3k_dlc04_startpos_pin_tao_qian_zhang_jue"] = cm:query_faction("3k_dlc04_faction_zhang_jue"):faction_leader():cqi()
		}
...
function add_turn_one_settlement_map_pins()
	...
	local map_pin_settlements = 
		{
			["3k_dlc04_startpos_pin_tao_qian_luoyang"] = "3k_main_luoyang_capital"
		}
