...
cm:add_first_tick_callback_mp_new(
	function() 
		...
		cm:set_camera_position(
			207.449432,	-- camera x position 
			469.153534,	-- camera y position 
			13.779055,	-- camera d position 
			0.345948,	-- camera b position 
...
function cutscene_intro_play()
	...
	cutscene_intro:action( function() cutscene_intro:cindy_playback("script/campaign/dlc04_mandate/factions/campaign_intro_cutscenes/scenes/scene_01_dong_zhuo.CindyScene", 0, 3); end, 0 );
	
	cutscene_intro:add_cinematic_trigger_listener( "dong_zhuo_advisor_01", function() cm:show_advice("3k_dlc04_campaign_faction_intro_dong_zhuo_01_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "dong_zhuo_advisor_02", function() cm:show_advice("3k_dlc04_campaign_faction_intro_dong_zhuo_02_dong_zhuo"); end );
	cutscene_intro:add_cinematic_trigger_listener( "dong_zhuo_advisor_03", function() cm:show_advice("3k_dlc04_campaign_faction_intro_dong_zhuo_03_dong_zhuo"); end );
	cutscene_intro:add_cinematic_trigger_listener( "dong_zhuo_advisor_04", function() cm:show_advice("3k_dlc04_campaign_faction_intro_dong_zhuo_04_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "dong_zhuo_advisor_05", function() cm:show_advice("3k_dlc04_campaign_faction_intro_dong_zhuo_05_dong_zhuo"); end );
	cutscene_intro:add_cinematic_trigger_listener( "dong_zhuo_advisor_06", function() cm:show_advice("3k_dlc04_campaign_faction_intro_dong_zhuo_06_advisor"); end );
...
function cutscene_intro_skipped(advice_to_play)
	...
	cm:show_advice("3k_dlc04_campaign_faction_intro_dong_zhuo_01_advisor");
	cm:show_advice("3k_dlc04_campaign_faction_intro_dong_zhuo_02_dong_zhuo");
	cm:show_advice("3k_dlc04_campaign_faction_intro_dong_zhuo_03_dong_zhuo");
	cm:show_advice("3k_dlc04_campaign_faction_intro_dong_zhuo_04_advisor");
	cm:show_advice("3k_dlc04_campaign_faction_intro_dong_zhuo_05_dong_zhuo");
	cm:show_advice("3k_dlc04_campaign_faction_intro_dong_zhuo_06_advisor");
...
function add_turn_one_character_map_pins()
	...
	local map_pin_characters = 
		{
			["3k_dlc04_startpos_pin_dong_zhuo_dong_zhuo"] = cm:query_faction("3k_main_faction_dong_zhuo"):faction_leader():cqi(),
			["3k_dlc04_startpos_pin_dong_zhuo_zhang_jue"] = cm:query_faction("3k_dlc04_faction_zhang_jue"):faction_leader():cqi()
		}
...
function add_turn_one_settlement_map_pins()
	...
	local map_pin_settlements = 
		{
			["3k_dlc04_startpos_pin_dong_zhuo_luoyang"] = "3k_main_luoyang_capital"
		}
