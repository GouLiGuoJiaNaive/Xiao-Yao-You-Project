...
cm:add_first_tick_callback_mp_new(
	function() 
		...
		cm:set_camera_position(
			265.490387,	-- camera x position 
			373.56488,	-- camera y position 
			40.976334,	-- camera d position 
			-0.139145,	-- camera b position 
			35.49823	-- camera h position
...
function cutscene_intro_play()
	...
	cutscene_intro:action( function() cutscene_intro:cindy_playback("script/campaign/dlc04_mandate/factions/campaign_intro_cutscenes/scenes/scene_01_empress_he.CindyScene", 0, 3); end, 0	);

	cutscene_intro:add_cinematic_trigger_listener( "empress_he_advisor_01", function() cm:show_advice("3k_dlc04_campaign_faction_intro_emperor_ling_01_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "empress_he_advisor_02", function() cm:show_advice("3k_dlc04_campaign_faction_intro_emperor_ling_02_emperor_ling"); end );
	cutscene_intro:add_cinematic_trigger_listener( "empress_he_advisor_03", function() cm:show_advice("3k_dlc04_campaign_faction_intro_emperor_ling_03_emperor_ling"); end );
	cutscene_intro:add_cinematic_trigger_listener( "empress_he_advisor_04", function() cm:show_advice("3k_dlc04_campaign_faction_intro_emperor_ling_04_eunuch"); end );
	cutscene_intro:add_cinematic_trigger_listener( "empress_he_advisor_05", function() cm:show_advice("3k_dlc04_campaign_faction_intro_emperor_ling_05_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "empress_he_advisor_06", function() cm:show_advice("3k_dlc04_campaign_faction_intro_emperor_ling_06_emperor_ling"); end );
	cutscene_intro:add_cinematic_trigger_listener( "empress_he_advisor_07", function() cm:show_advice("3k_dlc04_campaign_faction_intro_emperor_ling_07_advisor"); end );
...
function cutscene_intro_skipped(advice_to_play)
	...
	cm:show_advice("3k_dlc04_campaign_faction_intro_emperor_ling_01_advisor");
	cm:show_advice("3k_dlc04_campaign_faction_intro_emperor_ling_02_emperor_ling");
	cm:show_advice("3k_dlc04_campaign_faction_intro_emperor_ling_03_emperor_ling");
	cm:show_advice("3k_dlc04_campaign_faction_intro_emperor_ling_04_eunuch");
	cm:show_advice("3k_dlc04_campaign_faction_intro_emperor_ling_05_advisor");
	cm:show_advice("3k_dlc04_campaign_faction_intro_emperor_ling_06_emperor_ling");
	cm:show_advice("3k_dlc04_campaign_faction_intro_emperor_ling_07_advisor");
...
---------------------------------------------------------------
--	Turn One Region Visibility: Empress He
---------------------------------------------------------------
...
function turn_one_region_visibility()
	...
	local modify_faction = cm:modify_faction("3k_dlc04_faction_empress_he");
...
---------------------------------------------------------------
--	Turn One Map Pins: Empress He -- [DS]
---------------------------------------------------------------

function add_turn_one_character_map_pins()
	output("3k_dlc04_faction_empress_he_start.lua: Adding turn one character map pins for Empress He's faction.");

	-- Create a table connecting our map_pin records with our derived character CQIs
	local map_pin_characters = 
		{
			["3k_dlc04_startpos_pin_empress_he_empress_he"] = cm:query_faction("3k_dlc04_faction_empress_he"):faction_leader():cqi(),
			["3k_dlc04_startpos_pin_empress_he_he_jin"] = cm:query_faction("3k_dlc04_faction_empress_he"):faction_leader():cqi(),
			["3k_dlc04_startpos_pin_empress_he_zhang_jue"] = cm:query_faction("3k_dlc04_faction_zhang_jue"):faction_leader():cqi()
		}
...
function add_turn_one_settlement_map_pins()
	...
	local map_pin_settlements = 
		{
			["3k_dlc04_startpos_pin_empress_he_luoyang"] = "3k_main_luoyang_capital"
		}
...
function end_turn_map_pin_removal_listener()
	output("3k_dlc04_faction_empress_he_start.lua: Adding End Turn Map Pin Removal Listener.");
	...
	core:add_listener(
		...
		function(context)
			output("3k_dlc04_faction_empress_he_start.lua: Turn one has ended.");
			return context:query_model():turn_number() == 1;
		end,

		-- Remove the scripted pins.
		function(context)
			output("3k_dlc04_faction_empress_he_start.lua: Removing guide map pins.");
