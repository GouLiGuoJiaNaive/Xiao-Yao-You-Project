...
function setup_gating()
	...
	local function has_unlocked_tax_slider(query_faction)
		return progression:has_progression_feature(query_faction, "tax_slider", false); -- DLC04 -- Replaced progression level test with feature_test
	end;
	...
	local function has_unlocked_faction_council( query_faction )
		return query_faction:is_human() and progression:has_progression_feature(query_faction, "faction_council", false)  -- DLC04 -- Replaced progression level test with feature_test;
	end;
