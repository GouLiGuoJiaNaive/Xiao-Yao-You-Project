...
function setup_gating()
	...
	local function has_unlocked_tax_slider(query_faction)
		return progression:has_progression_feature(query_faction, "tax_slider") and query_faction:is_human();
	end;
	...
	local function has_unlocked_faction_council( query_faction )
		return progression:has_progression_feature(query_faction, "faction_council") and query_faction:is_human();
	end;
