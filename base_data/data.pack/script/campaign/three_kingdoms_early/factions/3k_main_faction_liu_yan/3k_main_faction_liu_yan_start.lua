...
cm:add_first_tick_callback_mp_new(
	function() 
		...
		cm:set_camera_position(
			108.42,	-- camera x position 
			284.47,	-- camera y position 
			10.48,	-- camera d position 
			-0.382593,	-- camera b position 
			5.03	-- camera h position			
		);
	end
...
function cutscene_intro_play()
	...
	cutscene_intro:action( function() cutscene_intro:cindy_playback("script/campaign/dlc07_guandu/factions/campaing_intro_cutscenes/scenes/liu_yan_190.CindyScene", 0, 6); end, 0 );

	cutscene_intro:add_cinematic_trigger_listener( "liu_yan_190_01", function() cm:show_advice("3k_dlc07_190_campaign_faction_intro_liu_yan_01_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "liu_yan_190_02", function() cm:show_advice("3k_dlc07_190_campaign_faction_intro_liu_yan_02_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "liu_yan_190_03", function() cm:show_advice("3k_dlc07_190_campaign_faction_intro_liu_yan_03_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "liu_yan_190_04", function() cm:show_advice("3k_dlc07_190_campaign_faction_intro_liu_yan_04_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "liu_yan_190_05", function() cm:show_advice("3k_dlc07_190_campaign_faction_intro_liu_yan_05_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "liu_yan_190_06", function() cm:show_advice("3k_dlc07_190_campaign_faction_intro_liu_yan_06_advisor"); end );
...
function cutscene_intro_skipped(advice_to_play)
	...
	cm:show_advice("3k_dlc07_190_campaign_faction_intro_liu_yan_01_advisor");
	cm:show_advice("3k_dlc07_190_campaign_faction_intro_liu_yan_02_advisor");
	cm:show_advice("3k_dlc07_190_campaign_faction_intro_liu_yan_03_advisor");
	cm:show_advice("3k_dlc07_190_campaign_faction_intro_liu_yan_04_advisor");
	cm:show_advice("3k_dlc07_190_campaign_faction_intro_liu_yan_05_advisor");
	cm:show_advice("3k_dlc07_190_campaign_faction_intro_liu_yan_06_advisor");
