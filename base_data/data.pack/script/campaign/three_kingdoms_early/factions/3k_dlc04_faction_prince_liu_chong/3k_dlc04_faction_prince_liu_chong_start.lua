...
cm:add_first_tick_callback_mp_new(
	function() 
		...
		cm:set_camera_position(
			305.06366,		-- camera x position 
			359.161469, 	-- camera y position
			29.53104, 		-- camera d position
			0.018642, 		-- camera b position
			22.538807		-- camera h position
		);
	end
);
...
function cutscene_intro_play()
	...
	cutscene_intro:action( function() cutscene_intro:cindy_playback("script/campaign/three_kingdoms_early/factions/campaign_intro_cutscenes/scenes/scene_01_prince_liu_chong.CindyScene", 0, 10); end, 0	);

	cutscene_intro:add_cinematic_trigger_listener( "main_liu_chong_advisor_01", function() cm:show_advice("3k_main_campaign_faction_intro_prince_liu_chong_01_liu_chong"); end );
	cutscene_intro:add_cinematic_trigger_listener( "main_liu_chong_advisor_02", function() cm:show_advice("3k_main_campaign_faction_intro_prince_liu_chong_02_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "main_liu_chong_advisor_03", function() cm:show_advice("3k_main_campaign_faction_intro_prince_liu_chong_03_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "main_liu_chong_advisor_04", function() cm:show_advice("3k_main_campaign_faction_intro_prince_liu_chong_04_liu_chong"); end );
	cutscene_intro:add_cinematic_trigger_listener( "main_liu_chong_advisor_05", function() cm:show_advice("3k_main_campaign_faction_intro_prince_liu_chong_05_liu_chong"); end );
	cutscene_intro:add_cinematic_trigger_listener( "main_liu_chong_advisor_06", function() cm:show_advice("3k_main_campaign_faction_intro_prince_liu_chong_06_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "main_liu_chong_advisor_07", function() cm:show_advice("3k_main_campaign_faction_intro_prince_liu_chong_07_liu_chong"); end );
...
function cutscene_intro_skipped(advice_to_play)
	...
	cm:show_advice("3k_main_campaign_faction_intro_prince_liu_chong_01_liu_chong");
	cm:show_advice("3k_main_campaign_faction_intro_prince_liu_chong_02_advisor");
	cm:show_advice("3k_main_campaign_faction_intro_prince_liu_chong_03_advisor");
	cm:show_advice("3k_main_campaign_faction_intro_prince_liu_chong_04_liu_chong");
	cm:show_advice("3k_main_campaign_faction_intro_prince_liu_chong_05_liu_chong");
	cm:show_advice("3k_main_campaign_faction_intro_prince_liu_chong_06_advisor");
	cm:show_advice("3k_main_campaign_faction_intro_prince_liu_chong_07_liu_chong");
...
function turn_one_region_visibility()
	...
	local modify_faction = cm:modify_faction("3k_dlc04_faction_prince_liu_chong");
	...
	-- Wang Lang
	modify_faction:make_region_seen_in_shroud("3k_main_penchang_capital");

	-- Liu Bei
	modify_faction:make_region_seen_in_shroud("3k_main_dong_resource_1");
...
---------------------------------------------------------------
--	Turn One Map Pins: Liu Chong
---------------------------------------------------------------0

function add_turn_one_character_map_pins()
	output("3k_dlc04_faction_prince_liu_chong_start.lua: Adding turn one character map pins for Tao Qian's faction.");
	...
	local coalition = cm:query_faction("3k_dwmain_faction_yuan_shao"):faction_leader():cqi(); 
	...
	local map_pin_characters = 
		{
			["3k_startpos_pin_tao_qian_dong_zhuo"] = dong_zhuo,
			["3k_startpos_pin_tao_qian_cao_cao"] = cao_cao,
			["3k_startpos_pin_tao_qian_coalition"] = coalition,
			["3k_startpos_pin_tao_qian_yellow_turbans_he_yi"] = he_yi,
			["3k_startpos_pin_tao_qian_yellow_turbans_huang_shao"] = huang_shao
		}
...
function add_turn_one_settlement_map_pins()
	output("3k_main_faction_tao_qian_start.lua: Adding turn one settlement map pins for Sun Jian's faction.");

	-- Create a table connecting our map_pin records with our region records /settlements
	local map_pin_settlements = 
		{
			["3k_startpos_pin_tao_qian_luoyang"] = "3k_main_luoyang_capital",
			["3k_startpos_pin_tao_qian_emperor"] = "3k_main_changan_capital"
		}
...
function end_turn_map_pin_removal_listener()
	output("3k_main_faction_tao_qian_start.lua: Adding End Turn Map Pin Removal Listener.");
	...
	core:add_listener(
		...
		function(context)
			output("3k_main_faction_tao_qian_start.lua: Turn one has ended.");
			return context:query_model():turn_number() == 1;
		end,

		-- Remove the scripted pins.
		function(context)
			output("3k_main_faction_tao_qian_start.lua: Removing guide map pins.");
