...
cm:add_first_tick_callback_mp_new(
	function() 
		...
		cm:set_camera_position(
			367.404205,	-- camera x position 
			363.710663,	-- camera y position 
			13.8862,	-- camera d position 
			0.0,	-- camera b position 
			5.876275	-- camera h position
		);
	end
);
...
function cutscene_intro_play()
	...
	cutscene_intro:action(
		function()
			cutscene_intro:cindy_playback("script/campaign/three_kingdoms_early/factions/campaign_intro_cutscenes/scenes/scene_01_tao_qian.CindyScene", 0, 10);
		end,
		0
	);
	
	cutscene_intro:add_cinematic_trigger_listener( "main_tao_qian_advisor_01", function() cm:show_advice("3k_main_faction_intro_tao_qian_01_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "main_tao_qian_advisor_02", function() cm:show_advice("3k_main_faction_intro_tao_qian_02_tao_qian"); end );
	cutscene_intro:add_cinematic_trigger_listener( "main_tao_qian_advisor_03", function() cm:show_advice("3k_main_faction_intro_tao_qian_03_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "main_tao_qian_advisor_04", function() cm:show_advice("3k_main_faction_intro_tao_qian_04_tao_qian"); end );
	cutscene_intro:add_cinematic_trigger_listener( "main_tao_qian_advisor_05", function() cm:show_advice("3k_main_faction_intro_tao_qian_05_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "main_tao_qian_advisor_06", function() cm:show_advice("3k_main_faction_intro_tao_qian_06_tao_qian"); end );
	cutscene_intro:add_cinematic_trigger_listener( "main_tao_qian_advisor_07", function() cm:show_advice("3k_main_faction_intro_tao_qian_07_advisor"); end );
...
function cutscene_intro_skipped(advice_to_play)
	...
	cm:show_advice("3k_main_faction_intro_tao_qian_01_advisor");
	cm:show_advice("3k_main_faction_intro_tao_qian_02_tao_qian");
	cm:show_advice("3k_main_faction_intro_tao_qian_03_advisor");
	cm:show_advice("3k_main_faction_intro_tao_qian_04_tao_qian");
	cm:show_advice("3k_main_faction_intro_tao_qian_05_advisor");
	cm:show_advice("3k_main_faction_intro_tao_qian_06_tao_qian");
	cm:show_advice("3k_main_faction_intro_tao_qian_07_advisor");
...
function turn_one_region_visibility()
	...
	local modify_faction = cm:modify_faction("3k_main_faction_tao_qian");
...
---------------------------------------------------------------
--	Turn One Map Pins: Tao Qian -- [DS]
---------------------------------------------------------------0

function add_turn_one_character_map_pins()
	output("3k_main_faction_tao_qian_start.lua: Adding turn one character map pins for Tao Qian's faction.");
