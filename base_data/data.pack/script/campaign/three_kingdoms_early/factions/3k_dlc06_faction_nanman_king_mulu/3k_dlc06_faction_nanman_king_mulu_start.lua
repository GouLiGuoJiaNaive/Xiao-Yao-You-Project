...
cm:add_first_tick_callback_mp_new(
	function() 
		...
		cm:set_camera_position(
			143.354462,	-- camera x position 
			160.377151,	-- camera y position 
			20.401993,	-- camera d position 
			-0.000012,	-- camera b position 
			20.39278	-- camera h position			
		);
	end
);
...
function cutscene_intro_play()
	...
	cutscene_intro:action( function() cutscene_intro:cindy_playback("script/campaign/three_kingdoms_early/factions/campaign_intro_cutscenes/scenes/scene_01_king_mulu.CindyScene", 0, 6); end, 0 );

	cutscene_intro:add_cinematic_trigger_listener( "3k_dlc06_190_campaign_faction_intro_king_mulu_01_advisor", function() cm:show_advice("3k_dlc06_190_campaign_faction_intro_king_mulu_01_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "3k_dlc06_190_campaign_faction_intro_king_mulu_02_advisor", function() cm:show_advice("3k_dlc06_190_campaign_faction_intro_king_mulu_02_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "3k_dlc06_190_campaign_faction_intro_king_mulu_03_advisor", function() cm:show_advice("3k_dlc06_190_campaign_faction_intro_king_mulu_03_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "3k_dlc06_190_campaign_faction_intro_king_mulu_04_advisor", function() cm:show_advice("3k_dlc06_190_campaign_faction_intro_king_mulu_04_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "3k_dlc06_190_campaign_faction_intro_king_mulu_05_advisor", function() cm:show_advice("3k_dlc06_190_campaign_faction_intro_king_mulu_05_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "3k_dlc06_190_campaign_faction_intro_king_mulu_06_advisor", function() cm:show_advice("3k_dlc06_190_campaign_faction_intro_king_mulu_06_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "3k_dlc06_190_campaign_faction_intro_king_mulu_07_advisor", function() cm:show_advice("3k_dlc06_190_campaign_faction_intro_king_mulu_07_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "3k_dlc06_190_campaign_faction_intro_king_mulu_08_advisor", function() cm:show_advice("3k_dlc06_190_campaign_faction_intro_king_mulu_08_advisor"); end );
...
function cutscene_intro_skipped(advice_to_play)
	...
	cm:show_advice("3k_dlc06_190_campaign_faction_intro_king_mulu_01_advisor");
	cm:show_advice("3k_dlc06_190_campaign_faction_intro_king_mulu_02_advisor");
	cm:show_advice("3k_dlc06_190_campaign_faction_intro_king_mulu_03_advisor");
	cm:show_advice("3k_dlc06_190_campaign_faction_intro_king_mulu_04_advisor");
	cm:show_advice("3k_dlc06_190_campaign_faction_intro_king_mulu_05_advisor");
	cm:show_advice("3k_dlc06_190_campaign_faction_intro_king_mulu_06_advisor");
	cm:show_advice("3k_dlc06_190_campaign_faction_intro_king_mulu_07_advisor");
	cm:show_advice("3k_dlc06_190_campaign_faction_intro_king_mulu_08_advisor");
...
function add_turn_one_settlement_map_pins()
	...
	local map_pin_settlements = 
		{
			["3k_dlc06_startpos_pin_king_mulu_jiaozhi"] = "3k_main_jiaozhi_resource_2"
		}
