...
start_historical_mission_listener(
    ...
    function()
		if progression:has_progression_feature(cm:query_faction("3k_main_faction_kong_rong"), "coalitions") then --DLC04 - Replaced with progression level check for coalitions being unlocked.
           return true
        end
