...
start_tutorial_mission_listener(
    ...
    {
        "total 4",
		"region 3k_main_xindu_resource_2",
    },                                                  -- conditions (single string or table of strings)
    {
...
start_tutorial_mission_cancel_listener(
    ...
    {
        "3k_dlc05_tutorial_mission_yan_baihu_capture_settlement",
        "3k_dlc05_tutorial_mission_yan_baihu_construct_building",
        "3k_dlc05_tutorial_mission_yan_baihu_recruit_units",
        "3k_dlc05_tutorial_mission_yan_baihu_secure_province",
    },
