...
cm:add_first_tick_callback_mp_new(
	function() 
		...
		cm:set_camera_position(
			398.52001,		-- camera x position 
			264.46001,  	-- camera y position
			13.779056, 		-- camera d position
			4.390863, 		-- camera b position
			6.709736		-- camera h position
		);
	end
);
...
function cutscene_intro_play()
	...
	cutscene_intro:action(
		function()
			cutscene_intro:cindy_playback("script/campaign/three_kingdoms_early/factions/campaign_intro_cutscenes/scenes/early_yan_baihu.CindyScene", 0, 10);
		end,
		0
	);

	cutscene_intro:add_cinematic_trigger_listener( "yan_baihu_advisor_01", function() cm:show_advice("3k_main_campaign_faction_intro_yan_baihu_01_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "yan_baihu_advisor_02", function() cm:show_advice("3k_main_campaign_faction_intro_yan_baihu_02_yan_baihu"); end );
	cutscene_intro:add_cinematic_trigger_listener( "yan_baihu_advisor_03", function() cm:show_advice("3k_main_campaign_faction_intro_yan_baihu_03_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "yan_baihu_advisor_04", function() cm:show_advice("3k_main_campaign_faction_intro_yan_baihu_04_yan_baihu"); end );
	cutscene_intro:add_cinematic_trigger_listener( "yan_baihu_advisor_05", function() cm:show_advice("3k_main_campaign_faction_intro_yan_baihu_05_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "yan_baihu_advisor_06", function() cm:show_advice("3k_main_campaign_faction_intro_yan_baihu_06_yan_baihu"); end );
	cutscene_intro:add_cinematic_trigger_listener( "yan_baihu_advisor_07", function() cm:show_advice("3k_main_campaign_faction_intro_yan_baihu_07_yan_baihu"); end );
...
function cutscene_intro_skipped(advice_to_play)
	...
	cm:show_advice("3k_main_campaign_faction_intro_yan_baihu_01_advisor");
	cm:show_advice("3k_main_campaign_faction_intro_yan_baihu_02_yan_baihu");
	cm:show_advice("3k_main_campaign_faction_intro_yan_baihu_03_advisor");
	cm:show_advice("3k_main_campaign_faction_intro_yan_baihu_04_yan_baihu");
	cm:show_advice("3k_main_campaign_faction_intro_yan_baihu_05_advisor");
	cm:show_advice("3k_main_campaign_faction_intro_yan_baihu_06_yan_baihu");
	cm:show_advice("3k_main_campaign_faction_intro_yan_baihu_07_yan_baihu");
...
---------------------------------------------------------------
--	Turn One Region Visibility: White Tiger Yan
---------------------------------------------------------------
...
---------------------------------------------------------------
--	Turn One Map Pins: White Tiger Yan -- [DS]
---------------------------------------------------------------0

function add_turn_one_character_map_pins()
	output("3k_dlc05_faction_white_tiger_yan_start.lua: Adding turn one character map pins for Zhang Yan's faction.");

	-- Find pinned faction leader character cqis from their faction records
	local han_empire = cm:query_faction("3k_main_faction_han_empire"):faction_leader():cqi();
	...
	local yellow_turban = cm:query_faction("3k_main_faction_yellow_turban_generic"):faction_leader():cqi();


	-- Create a table connecting our map_pin records with our derived character CQIs
	local map_pin_characters = 
		{
			["3k_dlc05_startpos_pin_yan_baihu_liu_yao"] = liu_yao,
			["3k_dlc05_startpos_pin_yan_baihu_han_empire"] = han_empire,
			["3k_dlc05_startpos_pin_yan_baihu_yan_baihu"] = white_tiger_yan,
			["3k_dlc05_startpos_pin_yan_baihu_yellow_turban"] = yellow_turban
		}
...
function add_turn_one_settlement_map_pins()
	output("3k_dlc05_faction_white_tiger_yan_start.lua: Adding turn one settlement map pins for Sun Jian's faction.");
--[[
...
function end_turn_map_pin_removal_listener()
	output("3k_dlc05_faction_white_tiger_yan_start.lua: Adding End Turn Map Pin Removal Listener.");
	core:add_listener(
		"Turn One End Check",
		"FactionTurnEnd",
