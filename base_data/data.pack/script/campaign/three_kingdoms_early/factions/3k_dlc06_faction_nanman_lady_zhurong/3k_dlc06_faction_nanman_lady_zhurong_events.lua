...
nanman_shared_progression_events:setup(local_faction_key, "3k_dlc06_faction_nanman_yunnan");

-- Initial Logic.
local function initial_set_up()
	cm:trigger_incident(local_faction_key, "3k_dlc06_introduction_lady_zhurong_190_incident", true)
end;
