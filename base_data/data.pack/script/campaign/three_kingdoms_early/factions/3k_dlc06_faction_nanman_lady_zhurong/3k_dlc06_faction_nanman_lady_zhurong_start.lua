...
cm:add_first_tick_callback_mp_new(
	function() 
		...
		cm:set_camera_position(
			73.354462,	-- camera x position 
			205.377151,	-- camera y position 
			18.401993,	-- camera d position 
			-0.000012,	-- camera b position 
			18.39278	-- camera h position			
		);
	end
);
...
function cutscene_intro_play()
	...
	cutscene_intro:action( function() cutscene_intro:cindy_playback("script/campaign/three_kingdoms_early/factions/campaign_intro_cutscenes/scenes/scene_01_lady_zhurong.CindyScene", 0, 6); end, 0 );

	cutscene_intro:add_cinematic_trigger_listener( "3k_dlc06_190_campaign_faction_intro_lady_zhurong_01_advisor", function() cm:show_advice("3k_dlc06_190_campaign_faction_intro_lady_zhurong_01_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "3k_dlc06_190_campaign_faction_intro_lady_zhurong_02_advisor", function() cm:show_advice("3k_dlc06_190_campaign_faction_intro_lady_zhurong_02_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "3k_dlc06_190_campaign_faction_intro_lady_zhurong_03_advisor", function() cm:show_advice("3k_dlc06_190_campaign_faction_intro_lady_zhurong_03_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "3k_dlc06_190_campaign_faction_intro_lady_zhurong_04_advisor", function() cm:show_advice("3k_dlc06_190_campaign_faction_intro_lady_zhurong_04_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "3k_dlc06_190_campaign_faction_intro_lady_zhurong_05_advisor", function() cm:show_advice("3k_dlc06_190_campaign_faction_intro_lady_zhurong_05_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "3k_dlc06_190_campaign_faction_intro_lady_zhurong_06_advisor", function() cm:show_advice("3k_dlc06_190_campaign_faction_intro_lady_zhurong_06_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "3k_dlc06_190_campaign_faction_intro_lady_zhurong_07_advisor", function() cm:show_advice("3k_dlc06_190_campaign_faction_intro_lady_zhurong_07_advisor"); end );
...
function cutscene_intro_skipped(advice_to_play)
	...
	cm:show_advice("3k_dlc06_190_campaign_faction_intro_lady_zhurong_01_advisor");
	cm:show_advice("3k_dlc06_190_campaign_faction_intro_lady_zhurong_02_advisor");
	cm:show_advice("3k_dlc06_190_campaign_faction_intro_lady_zhurong_03_advisor");
	cm:show_advice("3k_dlc06_190_campaign_faction_intro_lady_zhurong_04_advisor");
	cm:show_advice("3k_dlc06_190_campaign_faction_intro_lady_zhurong_05_advisor");
	cm:show_advice("3k_dlc06_190_campaign_faction_intro_lady_zhurong_06_advisor");
	cm:show_advice("3k_dlc06_190_campaign_faction_intro_lady_zhurong_07_advisor");
...
---------------------------------------------------------------
--	Turn One Region Visibility: Lady Zhurong
---------------------------------------------------------------
...
function turn_one_region_visibility()
	...
	local modify_faction = cm:modify_faction("3k_dlc06_faction_nanman_lady_zhurong");
	...
	-- Meng Huo
	modify_faction:make_region_seen_in_shroud("3k_main_jianning_capital");
	
end

---------------------------------------------------------------
--	Turn One Map Pins: Lady Zhurong -- [DS]
---------------------------------------------------------------

function add_turn_one_character_map_pins()
	output("3k_dlc06_faction_nanman_lady_zhurong_start.lua: Adding turn one character map pins for Lady Zhurong's faction.");

	-- Create a table connecting our map_pin records with our derived character CQIs
	local map_pin_characters = 
		{
			["3k_dlc06_startpos_pin_lady_zhurong_lady_zhurong"] = cm:query_faction(local_faction_key):faction_leader():cqi(),
			["3k_dlc06_startpos_pin_lady_zhurong_meng_huo"] = cm:query_faction("3k_dlc06_faction_nanman_king_meng_huo"):faction_leader():cqi()
		}
...
function add_turn_one_settlement_map_pins()
	output("3k_dlc06_faction_nanman_lady_zhurong_start.lua: Adding turn one settlement map pins for Lady Zhurong's faction.");
...
function end_turn_map_pin_removal_listener()
	output("3k_dlc06_faction_nanman_lady_zhurong_start.lua: Adding End Turn Map Pin Removal Listener.");
	...
	core:add_listener(
		...
		function(context)
			output("3k_dlc06_faction_nanman_lady_zhurong_start.lua: Turn one has ended.");
			return context:query_model():turn_number() == 1;
		end,

		-- Remove the scripted pins.
		function(context)
			output("3k_dlc06_faction_nanman_lady_zhurong_start.lua: Removing guide map pins.");
