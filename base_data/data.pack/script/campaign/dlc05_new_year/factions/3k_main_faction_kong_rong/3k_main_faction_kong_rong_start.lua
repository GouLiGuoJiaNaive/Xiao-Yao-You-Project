...
cm:add_first_tick_callback_sp_new(
	function() 
		...
		cm:teleport_character_by_startpos_id("1392909171",575,539)
...
cm:add_first_tick_callback_mp_new(
	function() 
		...
		cm:set_camera_position(
			419.60006,		-- camera x position 
			406.97001,  	-- camera y position
			13.77904, 		-- camera d position
			0.160815, 		-- camera b position
...
function cutscene_intro_play()
	...
	cutscene_intro:action(
		function()
			cutscene_intro:cindy_playback("script/campaign/dlc05_new_year/factions/dlc05_cutscenes/scenes/dlc05_kong_rong.CindyScene", 0, 10);
		end,
		0
	);

	cutscene_intro:add_cinematic_trigger_listener( "kong_rong_advisor_01", function() cm:show_advice("3k_dlc05_campaign_faction_intro_kong_rong_01_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "kong_rong_advisor_02", function() cm:show_advice("3k_dlc05_campaign_faction_intro_kong_rong_02_kong_rong"); end );
	cutscene_intro:add_cinematic_trigger_listener( "kong_rong_advisor_03", function() cm:show_advice("3k_dlc05_campaign_faction_intro_kong_rong_03_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "kong_rong_advisor_04", function() cm:show_advice("3k_dlc05_campaign_faction_intro_kong_rong_04_kong_rong"); end );
	cutscene_intro:add_cinematic_trigger_listener( "kong_rong_advisor_05", function() cm:show_advice("3k_dlc05_campaign_faction_intro_kong_rong_05_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "kong_rong_advisor_06", function() cm:show_advice("3k_dlc05_campaign_faction_intro_kong_rong_06_kong_rong"); end );
	cutscene_intro:add_cinematic_trigger_listener( "kong_rong_advisor_07", function() cm:show_advice("3k_dlc05_campaign_faction_intro_kong_rong_07_advisor"); end );
...
function cutscene_intro_skipped(advice_to_play)
	...
	cm:show_advice("3k_dlc05_campaign_faction_intro_kong_rong_01_advisor");
	cm:show_advice("3k_dlc05_campaign_faction_intro_kong_rong_02_kong_rong");
	cm:show_advice("3k_dlc05_campaign_faction_intro_kong_rong_03_advisor");
	cm:show_advice("3k_dlc05_campaign_faction_intro_kong_rong_04_kong_rong");
	cm:show_advice("3k_dlc05_campaign_faction_intro_kong_rong_05_advisor");
	cm:show_advice("3k_dlc05_campaign_faction_intro_kong_rong_06_kong_rong");
	cm:show_advice("3k_dlc05_campaign_faction_intro_kong_rong_07_advisor");
...
function add_turn_one_character_map_pins()
	...
	local map_pin_characters = 
		{
			["3k_dlc05_startpos_pin_kong_rong_lu_bu"] = lu_bu,
			["3k_dlc05_startpos_pin_kong_rong_kong_rong"] = kong_rong,
			["3k_dlc05_startpos_pin_kong_rong_yuan_shao"] = yuan_shao
		}
