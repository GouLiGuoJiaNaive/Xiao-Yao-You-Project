...
cm:add_first_tick_callback_mp_new(
	function() 
		...
		cm:set_camera_position(
			85.354462,	-- camera x position 
			205.077151,	-- camera y position 
			22.401993,	-- camera d position 
			-0.000012,	-- camera b position 
			22.39278	-- camera h position			
		);
	end
);
...
function cutscene_intro_play()
	...
	cutscene_intro:action( function() cutscene_intro:cindy_playback("script/campaign/dlc05_new_year/factions/dlc05_cutscenes/scenes/scene_01_lady_zhurong.CindyScene", 0, 6); end, 0 );

	cutscene_intro:add_cinematic_trigger_listener( "3k_dlc06_194_campaign_faction_intro_lady_zhurong_01_advisor", function() cm:show_advice("3k_dlc06_194_campaign_faction_intro_lady_zhurong_01_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "3k_dlc06_194_campaign_faction_intro_lady_zhurong_02_advisor", function() cm:show_advice("3k_dlc06_194_campaign_faction_intro_lady_zhurong_02_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "3k_dlc06_194_campaign_faction_intro_lady_zhurong_03_advisor", function() cm:show_advice("3k_dlc06_194_campaign_faction_intro_lady_zhurong_03_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "3k_dlc06_194_campaign_faction_intro_lady_zhurong_04_advisor", function() cm:show_advice("3k_dlc06_194_campaign_faction_intro_lady_zhurong_04_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "3k_dlc06_194_campaign_faction_intro_lady_zhurong_05_advisor", function() cm:show_advice("3k_dlc06_194_campaign_faction_intro_lady_zhurong_05_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "3k_dlc06_194_campaign_faction_intro_lady_zhurong_06_advisor", function() cm:show_advice("3k_dlc06_194_campaign_faction_intro_lady_zhurong_06_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "3k_dlc06_194_campaign_faction_intro_lady_zhurong_07_advisor", function() cm:show_advice("3k_dlc06_194_campaign_faction_intro_lady_zhurong_07_advisor"); end );
...
function cutscene_intro_skipped(advice_to_play)
	...
	cm:show_advice("3k_dlc06_194_campaign_faction_intro_lady_zhurong_01_advisor");
	cm:show_advice("3k_dlc06_194_campaign_faction_intro_lady_zhurong_02_advisor");
	cm:show_advice("3k_dlc06_194_campaign_faction_intro_lady_zhurong_03_advisor");
	cm:show_advice("3k_dlc06_194_campaign_faction_intro_lady_zhurong_04_advisor");
	cm:show_advice("3k_dlc06_194_campaign_faction_intro_lady_zhurong_05_advisor");
	cm:show_advice("3k_dlc06_194_campaign_faction_intro_lady_zhurong_06_advisor");
	cm:show_advice("3k_dlc06_194_campaign_faction_intro_lady_zhurong_07_advisor");
