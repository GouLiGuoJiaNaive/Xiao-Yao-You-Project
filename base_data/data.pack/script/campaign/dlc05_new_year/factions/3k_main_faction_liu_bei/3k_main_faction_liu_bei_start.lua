...
cm:add_first_tick_callback_mp_new(
	function() 
		...
		cm:set_camera_position(
			381.41998,		-- camera x position 
			364.865965, 	-- camera y position
			13.779095, 		-- camera d position
			0.507516, 		-- camera b position
...
function cutscene_intro_play()
	...
	cutscene_intro:action(
		function()
			cutscene_intro:cindy_playback("script/campaign/dlc05_new_year/factions/dlc05_cutscenes/scenes/dlc05_liu_bei.CindyScene", 0, 10);
		end,
		0
	);

	cutscene_intro:add_cinematic_trigger_listener( "liu_bei_advisor_01", function() cm:show_advice("3k_dlc05_campaign_faction_intro_liu_bei_01_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "liu_bei_advisor_02", function() cm:show_advice("3k_dlc05_campaign_faction_intro_liu_bei_02_liu_bei"); end );
	cutscene_intro:add_cinematic_trigger_listener( "liu_bei_advisor_03", function() cm:show_advice("3k_dlc05_campaign_faction_intro_liu_bei_03_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "liu_bei_advisor_04", function() cm:show_advice("3k_dlc05_campaign_faction_intro_liu_bei_04_liu_bei"); end );
	cutscene_intro:add_cinematic_trigger_listener( "liu_bei_advisor_05", function() cm:show_advice("3k_dlc05_campaign_faction_intro_liu_bei_05_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "liu_bei_advisor_06", function() cm:show_advice("3k_dlc05_campaign_faction_intro_liu_bei_06_liu_bei"); end );
	cutscene_intro:add_cinematic_trigger_listener( "liu_bei_advisor_07", function() cm:show_advice("3k_dlc05_campaign_faction_intro_liu_bei_07_advisor"); end );
...
function cutscene_intro_skipped(advice_to_play)
	...
	cm:show_advice("3k_dlc05_campaign_faction_intro_liu_bei_01_advisor");
	cm:show_advice("3k_dlc05_campaign_faction_intro_liu_bei_02_liu_bei");
	cm:show_advice("3k_dlc05_campaign_faction_intro_liu_bei_03_advisor");
	cm:show_advice("3k_dlc05_campaign_faction_intro_liu_bei_04_liu_bei");
	cm:show_advice("3k_dlc05_campaign_faction_intro_liu_bei_05_advisor");
	cm:show_advice("3k_dlc05_campaign_faction_intro_liu_bei_06_liu_bei");
	cm:show_advice("3k_dlc05_campaign_faction_intro_liu_bei_07_advisor");
...
function turn_one_region_visibility()
	...
	modify_faction:make_region_seen_in_shroud("3k_main_beihai_resource_1");
	
	-- Yuan Shao/Tan
	modify_faction:make_region_seen_in_shroud("3k_main_taishan_capital");
	modify_faction:make_region_seen_in_shroud("3k_main_taishan_resource_1");
...
function add_turn_one_character_map_pins()
	...
	local map_pin_characters = 
		{
			["3k_dlc05_startpos_pin_liu_bei_zheng_jiang"] = zheng_jiang,
			["3k_dlc05_startpos_pin_liu_bei_yuan_shu"] = yuan_shu,
			["3k_dlc05_startpos_pin_liu_bei_cao_cao"] = cao_cao,
			["3k_dlc05_startpos_pin_liu_bei_liu_bei"] = liu_bei,
			["3k_dlc05_startpos_pin_liu_bei_lu_bu"] = lu_bu
		}
