...
cm:add_first_tick_callback_mp_new(
	function() 
		...
		cm:set_camera_position(
			377.329132,		-- camera x position 
			258.461304, 	-- camera y position
			13.779056, 		-- camera d position
			2.4412, 		-- camera b position
			6.923189		-- camera h position
		);
	end
);
...
function cutscene_intro_play()
	...
	cutscene_intro:action(
		function()
			cutscene_intro:cindy_playback("script/campaign/dlc05_new_year/factions/dlc05_cutscenes/scenes/dlc05_yan_baihu.CindyScene", 0, 10);
		end,
		0
	);

	cutscene_intro:add_cinematic_trigger_listener( "yan_baihu_advisor_01", function() cm:show_advice("3k_dlc05_campaign_faction_intro_yan_baihu_01_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "yan_baihu_advisor_02", function() cm:show_advice("3k_dlc05_campaign_faction_intro_yan_baihu_02_yan_baihu"); end );
	cutscene_intro:add_cinematic_trigger_listener( "yan_baihu_advisor_03", function() cm:show_advice("3k_dlc05_campaign_faction_intro_yan_baihu_03_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "yan_baihu_advisor_04", function() cm:show_advice("3k_dlc05_campaign_faction_intro_yan_baihu_04_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "yan_baihu_advisor_05", function() cm:show_advice("3k_dlc05_campaign_faction_intro_yan_baihu_05_yan_baihu"); end );
	cutscene_intro:add_cinematic_trigger_listener( "yan_baihu_advisor_06", function() cm:show_advice("3k_dlc05_campaign_faction_intro_yan_baihu_06_yan_baihu"); end );
...
function cutscene_intro_skipped(advice_to_play)
	...
	cm:show_advice("3k_dlc05_campaign_faction_intro_yan_baihu_01_advisor");
	cm:show_advice("3k_dlc05_campaign_faction_intro_yan_baihu_02_yan_baihu");
	cm:show_advice("3k_dlc05_campaign_faction_intro_yan_baihu_03_advisor");
	cm:show_advice("3k_dlc05_campaign_faction_intro_yan_baihu_04_advisor");
	cm:show_advice("3k_dlc05_campaign_faction_intro_yan_baihu_05_yan_baihu");
	cm:show_advice("3k_dlc05_campaign_faction_intro_yan_baihu_06_yan_baihu");
...
function add_turn_one_character_map_pins()
	...
	local yan_baihu = cm:query_faction("3k_dlc05_faction_white_tiger_yan"):faction_leader():cqi();
	...
	local map_pin_characters = 
		{
			...
			["3k_dlc05_startpos_pin_yan_baihu_sun_ce"] = sun_ce,
			["3k_dlc05_startpos_pin_yan_baihu_yan_baihu"] = yan_baihu,
