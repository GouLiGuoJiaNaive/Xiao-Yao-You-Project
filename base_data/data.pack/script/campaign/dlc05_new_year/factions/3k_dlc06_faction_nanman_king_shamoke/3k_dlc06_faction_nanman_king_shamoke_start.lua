...
function cutscene_intro_play()
	...
	cutscene_intro:action( function() cutscene_intro:cindy_playback("script/campaign/dlc05_new_year/factions/dlc05_cutscenes/scenes/scene_01_king_shamoke.CindyScene", 0, 6); end, 0 );

	cutscene_intro:add_cinematic_trigger_listener( "3k_dlc06_194_campaign_faction_intro_king_shamoke_01_advisor", function() cm:show_advice("3k_dlc06_194_campaign_faction_intro_king_shamoke_01_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "3k_dlc06_194_campaign_faction_intro_king_shamoke_02_advisor", function() cm:show_advice("3k_dlc06_194_campaign_faction_intro_king_shamoke_02_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "3k_dlc06_194_campaign_faction_intro_king_shamoke_03_advisor", function() cm:show_advice("3k_dlc06_194_campaign_faction_intro_king_shamoke_03_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "3k_dlc06_194_campaign_faction_intro_king_shamoke_04_advisor", function() cm:show_advice("3k_dlc06_194_campaign_faction_intro_king_shamoke_04_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "3k_dlc06_194_campaign_faction_intro_king_shamoke_05_advisor", function() cm:show_advice("3k_dlc06_194_campaign_faction_intro_king_shamoke_05_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "3k_dlc06_194_campaign_faction_intro_king_shamoke_06_advisor", function() cm:show_advice("3k_dlc06_194_campaign_faction_intro_king_shamoke_06_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "3k_dlc06_194_campaign_faction_intro_king_shamoke_07_advisor", function() cm:show_advice("3k_dlc06_194_campaign_faction_intro_king_shamoke_07_advisor"); end );
...
function cutscene_intro_skipped(advice_to_play)
	...
	cm:show_advice("3k_dlc06_194_campaign_faction_intro_king_shamoke_01_advisor");
	cm:show_advice("3k_dlc06_194_campaign_faction_intro_king_shamoke_02_advisor");
	cm:show_advice("3k_dlc06_194_campaign_faction_intro_king_shamoke_03_advisor");
	cm:show_advice("3k_dlc06_194_campaign_faction_intro_king_shamoke_04_advisor");
	cm:show_advice("3k_dlc06_194_campaign_faction_intro_king_shamoke_05_advisor");
	cm:show_advice("3k_dlc06_194_campaign_faction_intro_king_shamoke_06_advisor");
	cm:show_advice("3k_dlc06_194_campaign_faction_intro_king_shamoke_07_advisor");
...
function add_turn_one_character_map_pins()
	output("3k_dlc06_faction_nanman_king_shamoke_start.lua: Adding turn one character map pins.");
...
function add_turn_one_settlement_map_pins()
	output("3k_dlc06_faction_nanman_king_shamoke_start.lua: Adding turn one settlement map pins.");

	-- Create a table connecting our map_pin records with our region records /settlements
	local map_pin_settlements = 
		{
			["3k_dlc06_startpos_pin_zangke_capital"] = "3k_main_zangke_capital", -- Duosi capital
			["3k_dlc06_startpos_pin_jianning_capital"] = "3k_main_jianning_capital", -- Meng Huo capital
			["3k_dlc06_startpos_pin_yunnan_capital"] = "3k_dlc06_yunnan_capital", -- Lady Zhurong capital
			["3k_dlc06_startpos_pin_jiaozhi_resource_3"] = "3k_dlc06_jiaozhi_resource_3", -- Mulu capital
			["3k_dlc06_startpos_pin_jiangyang_capital"] = "3k_main_jiangyang_capital", -- Wutugu capital
		}
