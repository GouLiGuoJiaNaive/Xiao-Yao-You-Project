...
cm:add_first_tick_callback_mp_new(
	function() 
		...
		cm:set_camera_position(
			259.207672,		-- camera x position 
			423.174756, 	-- camera y position
			13.779056, 		-- camera d position
			3.405038, 		-- camera b position
			6.033240		-- camera h position
		);
	end
);
...
output("cutscene_intro_play");
	...
	cutscene_intro:action(
		function()
			cutscene_intro:cindy_playback("script/campaign/dlc05_new_year/factions/dlc05_cutscenes/scenes/dlc05_zhang_yan.CindyScene", 0, 10);
		end,
		0
	);

	cutscene_intro:add_cinematic_trigger_listener( "zhang_yan_advisor_01", function() cm:show_advice("3k_dlc05_campaign_faction_intro_zhang_yan_01_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "zhang_yan_advisor_02", function() cm:show_advice("3k_dlc05_campaign_faction_intro_zhang_yan_02_zhang_yan"); end );
	cutscene_intro:add_cinematic_trigger_listener( "zhang_yan_advisor_03", function() cm:show_advice("3k_dlc05_campaign_faction_intro_zhang_yan_03_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "zhang_yan_advisor_04", function() cm:show_advice("3k_dlc05_campaign_faction_intro_zhang_yan_04_zhang_yan"); end );
	cutscene_intro:add_cinematic_trigger_listener( "zhang_yan_advisor_05", function() cm:show_advice("3k_dlc05_campaign_faction_intro_zhang_yan_05_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "zhang_yan_advisor_06", function() cm:show_advice("3k_dlc05_campaign_faction_intro_zhang_yan_06_zhang_yan"); end );
	cutscene_intro:add_cinematic_trigger_listener( "zhang_yan_advisor_07", function() cm:show_advice("3k_dlc05_campaign_faction_intro_zhang_yan_07_zhang_yan"); end );
...
function cutscene_intro_skipped(advice_to_play)
	...
	cm:show_advice("3k_dlc05_campaign_faction_intro_zhang_yan_01_advisor");
	cm:show_advice("3k_dlc05_campaign_faction_intro_zhang_yan_01_zhang_yan");
	cm:show_advice("3k_dlc05_campaign_faction_intro_zhang_yan_03_advisor");
	cm:show_advice("3k_dlc05_campaign_faction_intro_zhang_yan_04_zhang_yan");
	cm:show_advice("3k_dlc05_campaign_faction_intro_zhang_yan_05_advisor");
	cm:show_advice("3k_dlc05_campaign_faction_intro_zhang_yan_06_zhang_yan");
	cm:show_advice("3k_dlc05_campaign_faction_intro_zhang_yan_07_zhang_yan");
...
function add_turn_one_character_map_pins()
	...
	local map_pin_characters = 
		{
			["3k_dlc05_faction_dong_zhuo_li_jue"] = li_jue,
			["3k_dlc05_startpos_pin_zhang_yan_yuan_shao"] = yuan_shao,
			--["3k_dlc05_startpos_pin_yuan_shao_zhang_yan"] = zhang_yan,
			["3k_dlc05_startpos_pin_zhang_yan_zhang_yan"] = zhang_yan,
			["3k_dlc05_startpos_pin_zhang_yan_gongsun_zan"] = gongsun_zan
		}
