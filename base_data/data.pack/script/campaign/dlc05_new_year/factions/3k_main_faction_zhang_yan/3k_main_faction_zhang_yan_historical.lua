...
start_historical_mission_listener(
    ...
    function()
        if not cm:query_faction("3k_main_faction_gongsun_zan"):is_dead() and not diplomacy_manager:is_allied_to("3k_main_faction_zhang_yan", "3k_main_faction_gongsun_zan") then
            return true
        end
    end,
	"ScriptEventZhangYanHistoricalMission01Failure",
	nil,
	25
)
...
start_historical_mission_listener(
	...
	"ScriptEventZhangYanHistoricalMission01Complete",      -- completion event
	nil,
	"ScriptEventZhangYanHistoricalMission01Complete",
	nil,
	25
)
...
start_historical_mission_listener(
	...
	"ScriptEventZhangYanHistoricalMission02Failure",       -- failure event
	nil,
	25
)
...
start_historical_mission_listener(
	...
	"ScriptEventZhangYanHistoricalMission02Complete",      -- completion event
	nil,
	"ScriptEventZhangYanHistoricalMission02Complete",
	nil,
	25
)
...
start_historical_mission_listener(
	...
	nil,
	"ScriptEventZhangYanHistoricalMission03Complete",
	nil,
	25
)
...
start_historical_mission_listener(
	...
	"ScriptEventZhangYanHistoricalMission04Complete",      -- completion event
	nil,
	"ScriptEventZhangYanHistoricalMission04Complete",
	nil,
	25
)