...
cm:add_first_tick_callback_mp_new(
	function() 
		...
		cm:set_camera_position(
			135.46,	-- camera x position 
			266.37,	-- camera y position 
			7.11,	-- camera d position 
			-0.372767,	-- camera b position 
			1.72	-- camera h position			
		);
	end
...
function cutscene_intro_play()
	...
	cutscene_intro:action( function() cutscene_intro:cindy_playback("script/campaign/dlc07_guandu/factions/campaing_intro_cutscenes/scenes/lui_zhang_194.CindyScene", 0, 6); end, 0 );

	cutscene_intro:add_cinematic_trigger_listener( "liu_yan_194_01", function() cm:show_advice("3k_dlc07_194_campaign_faction_intro_liu_yan_01_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "liu_yan_194_02", function() cm:show_advice("3k_dlc07_194_campaign_faction_intro_liu_yan_02_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "liu_yan_194_03", function() cm:show_advice("3k_dlc07_194_campaign_faction_intro_liu_yan_03_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "liu_yan_194_04", function() cm:show_advice("3k_dlc07_194_campaign_faction_intro_liu_yan_04_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "liu_yan_194_05", function() cm:show_advice("3k_dlc07_194_campaign_faction_intro_liu_yan_05_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "liu_yan_194_06", function() cm:show_advice("3k_dlc07_194_campaign_faction_intro_liu_yan_06_advisor"); end );
...
function cutscene_intro_skipped(advice_to_play)
	...
	cm:show_advice("3k_dlc07_194_campaign_faction_intro_liu_yan_01_advisor");
	cm:show_advice("3k_dlc07_194_campaign_faction_intro_liu_yan_02_advisor");
	cm:show_advice("3k_dlc07_194_campaign_faction_intro_liu_yan_03_advisor");
	cm:show_advice("3k_dlc07_194_campaign_faction_intro_liu_yan_04_advisor");
	cm:show_advice("3k_dlc07_194_campaign_faction_intro_liu_yan_05_advisor");
	cm:show_advice("3k_dlc07_194_campaign_faction_intro_liu_yan_06_advisor");
...
function add_turn_one_character_map_pins()
	output("3k_main_faction_liu_yan_start.lua: Adding turn one character map pins.");
