...
cm:add_first_tick_callback_mp_new(
	function() 
		...
		cm:set_camera_position(
			365.859955,		-- camera x position 
			407.119995, 	-- camera y position
			13.779059, 		-- camera d position
			2.234453, 		-- camera b position
			5.855420		-- camera h position
		);
	end
);
...
function cutscene_intro_play()
	...
	cutscene_intro:action(
		function()
			cutscene_intro:cindy_playback("script/campaign/dlc05_new_year/factions/dlc05_cutscenes/scenes/dlc05_yuan_shao.CindyScene", 0, 10);
		end,
		0
	);
	
	cutscene_intro:add_cinematic_trigger_listener( "yuan_shao_advisor_01", function() cm:show_advice("3k_dlc05_campaign_faction_intro_yuan_shao_01_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "yuan_shao_advisor_02", function() cm:show_advice("3k_dlc05_campaign_faction_intro_yuan_shao_02_yuan_shao"); end );
	cutscene_intro:add_cinematic_trigger_listener( "yuan_shao_advisor_03", function() cm:show_advice("3k_dlc05_campaign_faction_intro_yuan_shao_03_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "yuan_shao_advisor_04", function() cm:show_advice("3k_dlc05_campaign_faction_intro_yuan_shao_04_yuan_shao"); end );
	cutscene_intro:add_cinematic_trigger_listener( "yuan_shao_advisor_05", function() cm:show_advice("3k_dlc05_campaign_faction_intro_yuan_shao_05_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "yuan_shao_advisor_06", function() cm:show_advice("3k_dlc05_campaign_faction_intro_yuan_shao_06_yuan_shao"); end );
...
function cutscene_intro_skipped(advice_to_play)
	...
	cm:show_advice("3k_dlc05_campaign_faction_intro_yuan_shao_01_advisor");
	cm:show_advice("3k_dlc05_campaign_faction_intro_yuan_shao_02_yuan_shao");
	cm:show_advice("3k_dlc05_campaign_faction_intro_yuan_shao_03_advisor");
	cm:show_advice("3k_dlc05_campaign_faction_intro_yuan_shao_04_yuan_shao");
	cm:show_advice("3k_dlc05_campaign_faction_intro_yuan_shao_05_advisor");
	cm:show_advice("3k_dlc05_campaign_faction_intro_yuan_shao_06_yuan_shao");
...
function turn_one_region_visibility()
	...
	-- Additional visibility for non-adjacent importants factions
...
function add_turn_one_character_map_pins()
	...
	local map_pin_characters = 
		{
			["3k_dlc05_startpos_pin_yuan_shao_lu_bu"] = lu_bu,
			["3k_dlc05_startpos_pin_yuan_shao_kong_rong"] = kong_rong,
			["3k_dlc05_startpos_pin_yuan_shao_cao_cao"] = cao_cao,
			["3k_dlc05_startpos_pin_yuan_shao_yuan_shao"] = yuan_shao,
			["3k_dlc05_startpos_pin_yuan_shao_zhang_yan"] = zhang_yan,
			["3k_dlc05_startpos_pin_yuan_shao_gongsun_zan"] = gongsun_zan
		}	
...
function add_turn_one_settlement_map_pins()
	...
	local map_pin_settlements = 
		{
			["3k_dlc05_startpos_pin_yuan_shao_luoyang"] = "3k_main_luoyang_capital"
		}
