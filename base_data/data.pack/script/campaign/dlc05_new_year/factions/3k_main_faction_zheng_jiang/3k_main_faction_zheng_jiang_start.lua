...
cm:add_first_tick_callback_mp_new(
	function() 
		...
		cm:set_camera_position(
			346.589966,		-- camera x position 
			373.399563, 	-- camera y position
			13.779043, 		-- camera d position
			0.08323, 		-- camera b position
...
function cutscene_intro_play()
	...
	cutscene_intro:action(
		function()
			cutscene_intro:cindy_playback("script/campaign/dlc05_new_year/factions/dlc05_cutscenes/scenes/dlc05_zheng_jiang.CindyScene", 0, 10);
		end,
		0
	);

	cutscene_intro:add_cinematic_trigger_listener( "zheng_jiang_advisor_01", function() cm:show_advice("3k_dlc05_campaign_faction_intro_zheng_jiang_01_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "zheng_jiang_advisor_02", function() cm:show_advice("3k_dlc05_campaign_faction_intro_zheng_jiang_02_zheng_jiang"); end );
	cutscene_intro:add_cinematic_trigger_listener( "zheng_jiang_advisor_03", function() cm:show_advice("3k_dlc05_campaign_faction_intro_zheng_jiang_03_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "zheng_jiang_advisor_04", function() cm:show_advice("3k_dlc05_campaign_faction_intro_zheng_jiang_04_zheng_jiang"); end );
	cutscene_intro:add_cinematic_trigger_listener( "zheng_jiang_advisor_05", function() cm:show_advice("3k_dlc05_campaign_faction_intro_zheng_jiang_05_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "zheng_jiang_advisor_06", function() cm:show_advice("3k_dlc05_campaign_faction_intro_zheng_jiang_06_zheng_jiang"); end );
...
function cutscene_intro_skipped(advice_to_play)
	...
	cm:show_advice("3k_dlc05_campaign_faction_intro_zheng_jiang_01_advisor");
	cm:show_advice("3k_dlc05_campaign_faction_intro_zheng_jiang_02_zheng_jiang");
	cm:show_advice("3k_dlc05_campaign_faction_intro_zheng_jiang_03_advisor");
	cm:show_advice("3k_dlc05_campaign_faction_intro_zheng_jiang_04_zheng_jiang");
	cm:show_advice("3k_dlc05_campaign_faction_intro_zheng_jiang_05_advisor");
	cm:show_advice("3k_dlc05_campaign_faction_intro_zheng_jiang_06_zheng_jiang");
...
function turn_one_region_visibility()
	...
	-- Zhang Yan
	modify_faction:make_region_seen_in_shroud("3k_main_taiyuan_capital");
	modify_faction:make_region_seen_in_shroud("3k_main_changan_capital");
...
function add_turn_one_character_map_pins()
	...
	local map_pin_characters = 
		{
			["3k_dlc05_startpos_pin_zheng_jiang_lu_bu"] = lu_bu,
			["3k_dlc05_startpos_pin_zheng_jiang_kong_rong"] = kong_rong,
			["3k_dlc05_startpos_pin_zheng_jiang_cao_cao"] = cao_cao,
			["3k_dlc05_startpos_pin_zheng_jiang_zheng_jiang"] = zheng_jiang,
			["3k_dlc05_startpos_pin_zheng_jiang_liu_bei"] = liu_bei
		}
