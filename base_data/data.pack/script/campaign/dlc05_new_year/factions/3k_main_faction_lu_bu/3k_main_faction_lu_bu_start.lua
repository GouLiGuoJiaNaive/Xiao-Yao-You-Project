...
cm:add_first_tick_callback_mp_new(
	function() 
		...
		cm:set_camera_position(
			331.040089,	-- camera x position 
			366.889984, 	-- camera y position
			13.8186125,		-- camera d position
			8.683646, 		-- camera b position
			5.766371		-- camera h position
		);
	end
);
...
function cutscene_intro_play()
	...
	cutscene_intro:action(
		function()
			cutscene_intro:cindy_playback("script/campaign/dlc05_new_year/factions/dlc05_cutscenes/scenes/dlc05_lu_bu.CindyScene", 0, 10);
		end,
		0
	);

	cutscene_intro:add_cinematic_trigger_listener( "lu_bu_advisor_01", function() cm:show_advice("3k_dlc05_campaign_faction_intro_lu_bu_01_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "lu_bu_advisor_02", function() cm:show_advice("3k_dlc05_campaign_faction_intro_lu_bu_02_lu_bu"); end );
	cutscene_intro:add_cinematic_trigger_listener( "lu_bu_advisor_03", function() cm:show_advice("3k_dlc05_campaign_faction_intro_lu_bu_03_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "lu_bu_advisor_04", function() cm:show_advice("3k_dlc05_campaign_faction_intro_lu_bu_04_lu_bu"); end );
	cutscene_intro:add_cinematic_trigger_listener( "lu_bu_advisor_05", function() cm:show_advice("3k_dlc05_campaign_faction_intro_lu_bu_05_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "lu_bu_advisor_06", function() cm:show_advice("3k_dlc05_campaign_faction_intro_lu_bu_06_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "lu_bu_advisor_07", function() cm:show_advice("3k_dlc05_campaign_faction_intro_lu_bu_07_lu_bu"); end );
	cutscene_intro:add_cinematic_trigger_listener( "lu_bu_advisor_08", function() cm:show_advice("3k_dlc05_campaign_faction_intro_lu_bu_08_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "lu_bu_advisor_09", function() cm:show_advice("3k_dlc05_campaign_faction_intro_lu_bu_09_lu_bu"); end );
...
function cutscene_intro_skipped(advice_to_play)
	...
	cm:show_advice("3k_dlc05_campaign_faction_intro_lu_bu_01_advisor");
	cm:show_advice("3k_dlc05_campaign_faction_intro_lu_bu_02_lu_bu");
	cm:show_advice("3k_dlc05_campaign_faction_intro_lu_bu_03_advisor");
	cm:show_advice("3k_dlc05_campaign_faction_intro_lu_bu_04_lu_bu");
	cm:show_advice("3k_dlc05_campaign_faction_intro_lu_bu_05_advisor");
	cm:show_advice("3k_dlc05_campaign_faction_intro_lu_bu_06_advisor");
	cm:show_advice("3k_dlc05_campaign_faction_intro_lu_bu_07_lu_bu");
	cm:show_advice("3k_dlc05_campaign_faction_intro_lu_bu_08_advisor");
	cm:show_advice("3k_dlc05_campaign_faction_intro_lu_bu_09_lu_bu");
...
---------------------------------------------------------------
--	Turn One Region Visibility: Lu Bu
---------------------------------------------------------------
...
function add_turn_one_character_map_pins()
	...
	local map_pin_characters = 
		{
			["3k_dlc05_startpos_pin_lu_bu_lu_bu"] = lu_bu,
			["3k_dlc05_startpos_pin_lu_bu_liu_bei"] = liu_bei,
			["3k_dlc05_startpos_pin_lu_bu_cao_cao"] = cao_cao,
			["3k_dlc05_startpos_pin_lu_bu_yuan_shao"] = yuan_shao,
			["3k_dlc05_startpos_pin_lu_bu_yuan_shu"] = yuan_shu,
			["3k_dlc05_startpos_pin_lu_bu_zheng_jiang"] = zheng_jiang
		}	
...
function end_turn_map_pin_removal_listener()
	output("3k_main_faction_lu_bu__start.lua: Adding End Turn Map Pin Removal Listener.");
	core:add_listener(
		"Turn One End Check",
		"FactionTurnEnd",
		...
		function(context)
			output("3k_main_faction_lu_bu__start.lua: Turn one has ended.");
			return context:query_model():turn_number() == 1;
		end,

		-- Remove the scripted pins.
		function(context)
			output("3k_main_faction_lu_bu_start.lua: Removing guide map pins.");
...
function teleport_character(startpos_id,coordinate_x,coordinate_y)
    local character = cm:query_model():character_for_startpos_id(startpos_id)
    cm:modify_model():get_modify_character(character):teleport_to(coordinate_x,coordinate_y)
end;

function annexation_treaty_setup()
...
function annexation_treaty_listener() --- we use this to apply the annexation treaty to any new factions Lu Bu encounters, in case of emergent factions, civil wars or rebels
	core:add_listener(
