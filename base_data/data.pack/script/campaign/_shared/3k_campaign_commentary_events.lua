---------------------------------------------------------------------------------------------------------
---------------------------------------------------------------------------------------------------------
----- Name:			3k_campaign_commentary_events.lua
...
cm:add_first_tick_callback(function() commentary_events:initialise() end); --Self register function
...
function commentary_events:setup_first_trade_agreement_trigger(event_key, faction_key)
	core:add_listener(
		...
		function(context) -- Criteria
			return diplomacy_manager:faction_signed_component_in_deals(context:deals(), faction_key, "treaty_components_trade");
		end,
...
function commentary_events:setup_first_alliance_trigger(event_key, faction_key)
	...
	core:add_listener(
		...
		"DiplomacyDealNegotiated", -- Campaign Event to listen for
		function(context) -- Criteria
			return diplomacy_manager:faction_signed_component_in_deals(context:deals(), faction_key, "treaty_components_create_alliance")
			or diplomacy_manager:faction_signed_component_in_deals(context:deals(), faction_key, "treaty_components_create_alliance_yuan_shao")
			or diplomacy_manager:faction_signed_component_in_deals(context:deals(), faction_key, "treaty_components_create_alliance_yuan_shu")
			or diplomacy_manager:faction_signed_component_in_deals(context:deals(), faction_key, "treaty_components_join_alliance_proposers")
			or diplomacy_manager:faction_signed_component_in_deals(context:deals(), faction_key, "treaty_components_join_alliance_recipients")
		end,
		function(context) -- What to do if listener fires.
...
function commentary_events:setup_first_proxy_war_trigger(event_key, faction_key)
	core:add_listener(
		...
		"DiplomacyDealNegotiated", -- Campaign Event to listen for
		function(context) -- Criteria
			return diplomacy_manager:faction_signed_component_in_deals(context:deals(), faction_key, "treaty_components_instigate_proxy_war_proposer");
		end,
		function(context) -- What to do if listener fires.
