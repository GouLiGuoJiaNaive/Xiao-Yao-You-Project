---------------------------------------------------------------------------------------------------------
---------------------------------------------------------------------------------------------------------
----- Name:			3k_progression_missions.lua
----- Description: 	Three Kingdoms system to handle progression missions. Deprecated by 3k_campaign_cdir_mission_manager.lua
---------------------------------------------------------------------------------------------------------
---------------------------------------------------------------------------------------------------------

out("3k_progression_missions.lua: Loading");

function start_progression_mission_listener(faction_key, mission_key, objective, conditions, mission_rewards, trigger_event, completion_event, precondition, failure_event, optional_turn_limit)
	...
	if conditions and objective ~= "ATTAIN_FACTION_PROGRESSION_LEVEL" then
		for i = 1, #conditions do
