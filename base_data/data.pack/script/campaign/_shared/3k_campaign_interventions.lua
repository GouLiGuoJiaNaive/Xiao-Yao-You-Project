---------------------------------------------------------------------------------------------------------
---------------------------------------------------------------------------------------------------------
----- Name:			3k_campaign_interventions.lua, 
----- Description: 	Advisor scripts for 3k.
---------------------------------------------------------------------------------------------------------
---------------------------------------------------------------------------------------------------------
...
function start_global_interventions()
	...
	if effect.get_advice_level() >= 2
	and campaign_tutorial 
	and campaign_tutorial:faction_has_tutorial(cm:get_local_faction())
	and not effect.get_advice_history_string_seen(campaign_tutorial.finished_tutorial_advice_key) then
...
in_tax_advice:add_trigger_condition(
	"FactionFameLevelUp", 
	function(context)
		if progression:has_progression_feature(context:faction(), "tax_slider") then
...
-- Trigger diplomacy advice 2 when reaching seccond marquis
in_diplomacy_advice_02:add_trigger_condition(
	"FactionFameLevelUp",
	function(context)
		if progression:has_progression_feature(context:faction(), "rank_second_marquis") then
			return context:faction():is_human()
		end
	end
);
...
in_diplomacy_advice_03:add_trigger_condition(
	"FactionFameLevelUp",
	function(context)
		if progression:has_progression_feature(context:faction(), "rank_marquis") then
			return context:faction():is_human()
		end
	end
);
...
in_spy_advice:add_trigger_condition(
	"FactionFameLevelUp", 
	function(context)
		return progression:has_progression_feature(context:faction(), "spies");
	end
);
...
in_diplomacy_personalities_advice:add_trigger_condition(
	"ScriptEventHumanFactionTurnStart",
	function(context)
		return progression:has_progression_feature(context:faction(), "rank_second_marquis");
	end
);
...
in_diplomacy_threats_advice:add_trigger_condition(
	"ScriptEventHumanFactionTurnStart",
	function(context)
		return progression:has_progression_feature(context:faction(), "rank_marquis");
	end
);
...
in_court_nobles_advice:add_trigger_condition(
	"ScriptEventHumanFactionTurnStart",
	function(context)
		return progression:has_progression_feature(context:faction(), "faction_council");
	end
);
...
in_minister_advice:add_trigger_condition(
	"FactionFameLevelUp", 
	function(context)
		if progression:has_progression_feature(context:faction(), "faction_council", false) then -- DLC04 replaced with progression feature check.
			return context:faction():is_human()
		end
	end
);
