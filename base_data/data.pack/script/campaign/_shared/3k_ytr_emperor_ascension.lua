---------------------------------------------------------------------------------------------------------
---------------------------------------------------------------------------------------------------------
----- Name:			3k_ytr_emperor_ascension.lua
----- Description: 	This gives a yellow turban faction a big bonus when achieving a certain progression level
...
if cm.name == "ep_eight_princes"
	...
	output("yt_emperor_ascension: Not loaded in this campaign." );
	return;
end;

cm:add_first_tick_callback(function() yt_emperor_ascension:initialise() end); --Self register function
