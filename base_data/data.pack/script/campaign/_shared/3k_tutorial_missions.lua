---------------------------------------------------------------------------------------------------------
---------------------------------------------------------------------------------------------------------
----- Name:			3k_tutorial_missions.lua
----- Description: 	Three Kingdoms system to handle tutorial missions. Deprecated by 3k_campaign_cdir_mission_manager.lua
---------------------------------------------------------------------------------------------------------
---------------------------------------------------------------------------------------------------------
...
function start_tutorial_mission_listener(faction_key, mission_key, objective, conditions, mission_rewards, trigger_event, completion_event, precondition, failure_event, optional_misison_issuer,optional_turn_limit)
	start_historical_mission_listener(faction_key, mission_key, objective, conditions, mission_rewards, trigger_event, completion_event, precondition, failure_event, "CLAN_ELDERS", optional_turn_limit);
end;
