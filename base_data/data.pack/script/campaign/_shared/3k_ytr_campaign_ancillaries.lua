---------------------------------------------------------------------------------------------------------
---------------------------------------------------------------------------------------------------------
----- Name:			3k_ytr_campaign_ancillaries.lua, 
----- Description: 	Three Kingdoms system to handle yellow turban armour upgrades
---------------------------------------------------------------------------------------------------------
---------------------------------------------------------------------------------------------------------
-- Early exit if we're in eight princes.
if cm.name == "ep_eight_princes" then
	output("yt_ancillaries: Not loaded in this campaign." );
	return;
end;

cm:add_first_tick_callback(function() yt_ancillaries:initialise() end); --Self register function
