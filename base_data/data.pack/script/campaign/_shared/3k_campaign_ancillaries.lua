...
cm:add_first_tick_callback_new(function() ancillaries:new_game_faction_starting_ancillaries() end); -- Selt register new game
cm:add_first_tick_callback(function() ancillaries:initialise() end); --Self register function
...
ancillaries.faction_start_trigger_overrides = -- YT have different spawned ancillaries.
{
    ...
    ["3k_dlc04_faction_zhang_liang"] 	= "3k_ytr_ceo_trigger_faction_starting_ancillaries",
    ["3k_dlc04_faction_zhang_jue"] 	= "3k_ytr_ceo_trigger_faction_starting_ancillaries",
	["3k_dlc04_faction_zhang_bao"] 	= "3k_ytr_ceo_trigger_faction_starting_ancillaries",
    ["3k_dlc06_faction_nanman_zangke"] 	= "3k_dlc06_ceo_trigger_faction_nanman_starting_ancillaries",
    ["3k_dlc06_faction_nanman_yunnan"] 	= "3k_dlc06_ceo_trigger_faction_nanman_starting_ancillaries",
	["3k_dlc06_faction_nanman_yongchang"] 	= "3k_dlc06_ceo_trigger_faction_nanman_starting_ancillaries",
	["3k_dlc06_faction_nanman_yang_feng"] 	= "3k_dlc06_ceo_trigger_faction_nanman_starting_ancillaries",
    ["3k_dlc06_faction_nanman_xi_ni"] 	= "3k_dlc06_ceo_trigger_faction_nanman_starting_ancillaries",
    ["3k_dlc06_faction_nanman_tu_an"] 	= "3k_dlc06_ceo_trigger_faction_nanman_starting_ancillaries",
	["3k_dlc06_faction_nanman_rebels"] 	= "3k_dlc06_ceo_trigger_faction_nanman_starting_ancillaries",
	["3k_dlc06_faction_nanman_mangyachang"] 	= "3k_dlc06_ceo_trigger_faction_nanman_starting_ancillaries",
    ["3k_dlc06_faction_nanman_lady_zhurong"] 	= "3k_dlc06_ceo_trigger_faction_nanman_starting_ancillaries",
    ["3k_dlc06_faction_nanman_king_wutugu"] 	= "3k_dlc06_ceo_trigger_faction_nanman_starting_ancillaries",
	["3k_dlc06_faction_nanman_king_shamoke"] 	= "3k_dlc06_ceo_trigger_faction_nanman_starting_ancillaries",
	["3k_dlc06_faction_nanman_king_mulu"] 	= "3k_dlc06_ceo_trigger_faction_nanman_starting_ancillaries",
    ["3k_dlc06_faction_nanman_king_meng_huo"] 	= "3k_dlc06_ceo_trigger_faction_nanman_starting_ancillaries",
    ["3k_dlc06_faction_nanman_king_duosi"] 	= "3k_dlc06_ceo_trigger_faction_nanman_starting_ancillaries",
	["3k_dlc06_faction_nanman_jinhuansanjie"] 	= "3k_dlc06_ceo_trigger_faction_nanman_starting_ancillaries",
	["3k_dlc06_faction_nanman_jiaozhi"] 	= "3k_dlc06_ceo_trigger_faction_nanman_starting_ancillaries",
    ["3k_dlc06_faction_nanman_jianning"] 	= "3k_dlc06_ceo_trigger_faction_nanman_starting_ancillaries",
    ["3k_dlc06_faction_nanman_jiangyang"] 	= "3k_dlc06_ceo_trigger_faction_nanman_starting_ancillaries",
	["3k_dlc06_faction_nanman_dongtuna"] 	= "3k_dlc06_ceo_trigger_faction_nanman_starting_ancillaries",
	["3k_dlc06_faction_nanman_ahuinan"] 	= "3k_dlc06_ceo_trigger_faction_nanman_starting_ancillaries"
}
...
function ancillaries:new_game_faction_starting_ancillaries()
	...
	for i=0, all_factions:num_items() - 1 do
		...
		elseif not query_faction:ceo_management() or query_faction:ceo_management():is_null_interface() then

			script_error( "ancillaries:new_game_faction_starting_ancillaries() Faction has not CEO Management interface. Please add it!" );
...
-- TRIGGER CEOS ON THE FACTION
	...
	if not trigger_key then
		script_error("Could not find trigger for query_character key[" .. tostring(query_character:generation_template_key()) .. "] subtype[" .. tostring(query_character:character_subtype_key()) .. "]");
		return false;
	end;
...
-- EQUIP THE CEO ON THE CHARACTER
	if ceo_key == "" or ceo_category_key == "" then
		--script_error("Didn't return a CEO!"); -- TODO: Seems something is broken and the listeners aren't working. this means equipping isn't currently supported from triggers.
		return false;
	end;
...
function ancillaries:get_num_starting_ancillaries( query_character )
	...
	if misc:is_transient_character(query_character) then
		return false;
	end;
...
function ancillaries:equip_ceo_on_character( query_character, ceo_key, ceo_category_key )
    ...
    local valid_equipment_slot_for_ceo_category = self:get_valid_slot_for_category(query_character, ceo_category_key);
...
function ancillaries:faction_has_ceo_key(ceo_management, ceo_key, opt_category)
	
	if self:faction_get_ceo(ceo_management, ceo_key, opt_category) then
		return true;
	end;
...
function ancillaries:faction_has_ceo_node_key(ceo_management, ceo_node_key, opt_category)

	if self:faction_get_ceo_by_node(ceo_management, ceo_node_key, opt_category) then
		return true;
	end;
...
function ancillaries:faction_get_ceo(ceo_management, ceo_key, opt_category)
	local ceo_list;

	if opt_category then
		ceo_list = ceo_management:all_ceos_for_category(opt_category);
	else
		ceo_list = ceo_management:all_ceos();
	end;

	if ceo_list:is_empty() then
		return;
	end;

	for i = 0, ceo_list:num_items() - 1 do
		if ceo_list:item_at(i):ceo_data_key() == ceo_key then
			return ceo_list:item_at(i);
		end;
	end;
...
function ancillaries:faction_get_ceo_by_node(ceo_management, ceo_node_key, opt_category)
	local ceo_list;
	...
	for i = 0, ceo_list:num_items() - 1 do
		if ceo_list:item_at(i):current_node_key() == ceo_node_key then
			return ceo_list:item_at(i);
		end;
	end;
