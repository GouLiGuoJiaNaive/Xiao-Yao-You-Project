...
cm:add_first_tick_callback_mp_new(
	function() 
		...
		cm:set_camera_position(
			180.27,	-- camera x position 
			297.75,	-- camera y position 
			8.42,	-- camera d position 
			-0.417181,	-- camera b position 
			2.68	-- camera h position			
		);
	end
...
function cutscene_intro_play()
	...
	cutscene_intro:action( function() cutscene_intro:cindy_playback("script/campaign/dlc07_guandu/factions/campaing_intro_cutscenes/scenes/liu_zhang_198.CindyScene", 0, 6); end, 0 );

	cutscene_intro:add_cinematic_trigger_listener( "liu_zhang_01", function() cm:show_advice("3k_dlc07_campaign_faction_intro_liu_yan_01_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "liu_zhang_02", function() cm:show_advice("3k_dlc07_campaign_faction_intro_liu_yan_02_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "liu_zhang_03", function() cm:show_advice("3k_dlc07_campaign_faction_intro_liu_yan_03_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "liu_zhang_04", function() cm:show_advice("3k_dlc07_campaign_faction_intro_liu_yan_04_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "liu_zhang_05", function() cm:show_advice("3k_dlc07_campaign_faction_intro_liu_yan_05_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "liu_zhang_06", function() cm:show_advice("3k_dlc07_campaign_faction_intro_liu_yan_06_advisor"); end );
...
function cutscene_intro_skipped(advice_to_play)
	...
	cm:show_advice("3k_dlc07_campaign_faction_intro_liu_yan_01_advisor");
	cm:show_advice("3k_dlc07_campaign_faction_intro_liu_yan_02_advisor");
	cm:show_advice("3k_dlc07_campaign_faction_intro_liu_yan_03_advisor");
	cm:show_advice("3k_dlc07_campaign_faction_intro_liu_yan_04_advisor");
	cm:show_advice("3k_dlc07_campaign_faction_intro_liu_yan_05_advisor");
	cm:show_advice("3k_dlc07_campaign_faction_intro_liu_yan_06_advisor");
...
function turn_one_region_visibility()
	...
	local modify_faction = cm:modify_faction("3k_main_faction_liu_yan");
	...
	-- Ma Teng
	modify_faction:make_region_seen_in_shroud("3k_main_wudu_capital");
...
function add_turn_one_character_map_pins()
	output("3k_main_faction_liu_yan_start.lua: Adding turn one character map pins for Liu Yans's faction.");

	-- Create a table connecting our map_pin records with our derived character CQIs
	local map_pin_characters = 
		{
			["3k_dlc07_startpos_pin_liu_yan_zhang_lu"] = cm:query_faction("3k_dlc07_faction_zhang_lu"):faction_leader():cqi(),
			["3k_dlc07_startpos_pin_liu_yan_cao_cao"] = cm:query_faction("3k_main_faction_cao_cao"):faction_leader():cqi(),
			["3k_dlc07_startpos_pin_liu_yan_shamoke"] = cm:query_faction("3k_dlc06_faction_nanman_king_shamoke"):faction_leader():cqi(),
			["3k_dlc07_startpos_pin_liu_yan_mulu"] = cm:query_faction("3k_dlc06_faction_nanman_king_mulu"):faction_leader():cqi(),
			["3k_dlc07_startpos_pin_liu_yan_meng_huo"] = cm:query_faction("3k_dlc06_faction_nanman_king_meng_huo"):faction_leader():cqi(),
		}
...
function add_turn_one_settlement_map_pins()
	output("3k_main_faction_liu_yan_start.lua: Adding turn one settlement map pins.");
...
function end_turn_map_pin_removal_listener()
	output("3k_main_faction_liu_yan_start.lua: Adding End Turn Map Pin Removal Listener.");
	...
	core:add_listener(
		...
		function(context)
			output("3k_main_faction_liu_yan_start.lua: Turn one has ended.");
			return context:query_model():turn_number() == 1;
		end,

		-- Remove the scripted pins.
		function(context)
			output("3k_main_faction_liu_yan_start.lua: Removing guide map pins.");
