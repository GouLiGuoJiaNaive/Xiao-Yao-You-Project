...
cm:add_first_tick_callback_mp_new(
	function() 
		...
		cm:set_camera_position(
			261.83,	-- camera x position 
			263.28,	-- camera y position 
			5.43,	-- camera d position 
			-0.346119,	-- camera b position 
			0.78	-- camera h position			
		);
	end
...
function cutscene_intro_play()
	...
	cutscene_intro:action( function() cutscene_intro:cindy_playback("script/campaign/dlc07_guandu/factions/campaing_intro_cutscenes/scenes/liu_biao_198.CindyScene", 0, 6); end, 0 );

	cutscene_intro:add_cinematic_trigger_listener( "liu_biao_01", function() cm:show_advice("3k_dlc07_campaign_faction_intro_liu_biao_01_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "liu_biao_02", function() cm:show_advice("3k_dlc07_campaign_faction_intro_liu_biao_02_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "liu_biao_03", function() cm:show_advice("3k_dlc07_campaign_faction_intro_liu_biao_03_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "liu_biao_04", function() cm:show_advice("3k_dlc07_campaign_faction_intro_liu_biao_04_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "liu_biao_05", function() cm:show_advice("3k_dlc07_campaign_faction_intro_liu_biao_05_advisor"); end );
...
function cutscene_intro_skipped(advice_to_play)
	...
	cm:show_advice("3k_dlc07_campaign_faction_intro_liu_biao_01_advisor");
	cm:show_advice("3k_dlc07_campaign_faction_intro_liu_biao_02_advisor");
	cm:show_advice("3k_dlc07_campaign_faction_intro_liu_biao_03_advisor");
	cm:show_advice("3k_dlc07_campaign_faction_intro_liu_biao_04_advisor");
	cm:show_advice("3k_dlc07_campaign_faction_intro_liu_biao_05_advisor");
...
function add_turn_one_character_map_pins()
	...
	output("3k_main_faction_liu_biao_start.lua: Adding turn one character map pins.");
	-- Create a table connecting our map_pin records with our derived character CQIs
	local map_pin_characters = 
	{
		["3k_dlc07_startpos_pin_liu_biao_liu_biao"] = cm:query_faction("3k_main_faction_liu_biao"):faction_leader():cqi(),
		["3k_dlc07_startpos_pin_liu_biao_sun_ce"] = cm:query_faction("3k_dlc05_faction_sun_ce"):faction_leader():cqi(),
		["3k_startpos_pin_liu_biao_huang_zu"] = cm:query_faction("3k_main_faction_huang_zu"):faction_leader():cqi(),
	}
