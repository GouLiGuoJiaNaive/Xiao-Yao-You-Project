...
cm:add_first_tick_callback_mp_new(
	function() 
		...
		cm:set_camera_position(
			151.81,	-- camera x position 
			357.84,	-- camera y position 
			13.31,	-- camera d position 
			-0.433175,	-- camera b position 
			6.91	-- camera h position			
		);
	end
...
function cutscene_intro_play()
	...
	cutscene_intro:action( function() cutscene_intro:cindy_playback("script/campaign/dlc07_guandu/factions/campaing_intro_cutscenes/scenes/ma_teng_198.CindyScene", 0, 6); end, 0 );

	cutscene_intro:add_cinematic_trigger_listener( "ma_teng_01", function() cm:show_advice("3k_dlc07_campaign_faction_intro_ma_teng_01_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "ma_teng_02", function() cm:show_advice("3k_dlc07_campaign_faction_intro_ma_teng_02_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "ma_teng_03", function() cm:show_advice("3k_dlc07_campaign_faction_intro_ma_teng_03_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "ma_teng_04", function() cm:show_advice("3k_dlc07_campaign_faction_intro_ma_teng_04_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "ma_teng_05", function() cm:show_advice("3k_dlc07_campaign_faction_intro_ma_teng_05_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "ma_teng_06", function() cm:show_advice("3k_dlc07_campaign_faction_intro_ma_teng_06_advisor"); end );
...
function cutscene_intro_skipped(advice_to_play)
	...
	cm:show_advice("3k_dlc07_campaign_faction_intro_ma_teng_01_advisor");
	cm:show_advice("3k_dlc07_campaign_faction_intro_ma_teng_02_advisor");
	cm:show_advice("3k_dlc07_campaign_faction_intro_ma_teng_03_advisor");
	cm:show_advice("3k_dlc07_campaign_faction_intro_ma_teng_04_advisor");
	cm:show_advice("3k_dlc07_campaign_faction_intro_ma_teng_05_advisor");
	cm:show_advice("3k_dlc07_campaign_faction_intro_ma_teng_06_advisor");
...
function turn_one_region_visibility()
	...
	-- Han Sui
	modify_faction:make_region_seen_in_shroud("3k_main_jincheng_capital");
...
function add_turn_one_character_map_pins()
	...
	output("3k_main_faction_ma_teng_start.lua: Adding turn one character map pins.");
	-- Create a table connecting our map_pin records with our derived character CQIs
	local map_pin_characters = 
	{
		["3k_dlc07_startpos_pin_ma_teng_han_sui"] = cm:query_faction("3k_main_faction_han_sui"):faction_leader():cqi(),
		["3k_dlc07_startpos_pin_ma_teng_ma_teng"] = cm:query_faction("3k_main_faction_ma_teng"):faction_leader():cqi(),
		["3k_dlc05_startpos_pin_ma_teng_liu_biao"] = cm:query_faction("3k_main_faction_liu_biao"):faction_leader():cqi(),
	}
...
function add_turn_one_settlement_map_pins()
	output("3k_main_faction_ma_teng_start.lua: Adding turn one settlement map pins.");
