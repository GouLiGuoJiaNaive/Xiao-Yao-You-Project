...
cm:add_first_tick_callback_mp_new(
	function() 
		...
		cm:set_camera_position(
			308.16,	-- camera x position 
			407.56,	-- camera y position 
			5.79,	-- camera d position 
			-0.377943,	-- camera b position 
			0.31	-- camera h position			
		);
	end
...
function cutscene_intro_play()
	...
	cutscene_intro:action( function() cutscene_intro:cindy_playback("script/campaign/dlc07_guandu/factions/campaing_intro_cutscenes/scenes/zhang_yan_198.CindyScene", 0, 6); end, 0 );

	cutscene_intro:add_cinematic_trigger_listener( "zhang_yan_01", function() cm:show_advice("3k_dlc07_campaign_faction_intro_zhang_yan_01_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "zhang_yan_02", function() cm:show_advice("3k_dlc07_campaign_faction_intro_zhang_yan_02_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "zhang_yan_03", function() cm:show_advice("3k_dlc07_campaign_faction_intro_zhang_yan_03_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "zhang_yan_04", function() cm:show_advice("3k_dlc07_campaign_faction_intro_zhang_yan_04_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "zhang_yan_05", function() cm:show_advice("3k_dlc07_campaign_faction_intro_zhang_yan_05_advisor"); end );
...
function cutscene_intro_skipped(advice_to_play)
	...
	cm:show_advice("3k_dlc07_campaign_faction_intro_zhang_yan_01_advisor");
	cm:show_advice("3k_dlc07_campaign_faction_intro_zhang_yan_02_advisor");
	cm:show_advice("3k_dlc07_campaign_faction_intro_zhang_yan_03_advisor");
	cm:show_advice("3k_dlc07_campaign_faction_intro_zhang_yan_04_advisor");
	cm:show_advice("3k_dlc07_campaign_faction_intro_zhang_yan_05_advisor");
...
function turn_one_region_visibility()
	...
	-- Yuan Xi
	modify_faction:make_region_seen_in_shroud("3k_main_youbeiping_capital");
...
function add_turn_one_character_map_pins()
	output("3k_main_faction_zhang_yan_start.lua: Adding turn one character map pins.");
		-- Create a table connecting our map_pin records with our derived character CQIs
		local map_pin_characters = 
		{
			["3k_dlc07_startpos_pin_zhang_yan_zhang_yan"] = cm:query_faction("3k_main_faction_zhang_yan"):faction_leader():cqi(),
		}
...
function add_turn_one_settlement_map_pins()
	output("3k_main_faction_zhang_yan_start.lua: Adding turn one settlement map pins for zhang_yan's faction.");

	-- Create a table connecting our map_pin records with our region records /settlements
	local map_pin_settlements = 
		{
			["3k_dlc05_startpos_pin_zhang_yan_yuan_shao"] = "3k_main_anping_capital",
		}
