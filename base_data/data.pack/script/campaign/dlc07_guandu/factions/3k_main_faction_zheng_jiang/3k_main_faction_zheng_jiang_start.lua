...
cm:add_first_tick_callback_mp_new(
	function() 
		...
		cm:set_camera_position(
			352.45,	-- camera x position 
			354.64,	-- camera y position 
			4.13,	-- camera d position 
			-0.248395,	-- camera b position 
			0.59	-- camera h position			
		);	
	end
...
function cutscene_intro_play()
	...
	cutscene_intro:action( function() cutscene_intro:cindy_playback("script/campaign/dlc07_guandu/factions/campaing_intro_cutscenes/scenes/zheng_jiang_198.CindyScene", 0, 6); end, 0 );

	cutscene_intro:add_cinematic_trigger_listener( "zheng_jiang_01", function() cm:show_advice("3k_dlc07_campaign_faction_intro_zheng_jiang_01_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "zheng_jiang_02", function() cm:show_advice("3k_dlc07_campaign_faction_intro_zheng_jiang_02_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "zheng_jiang_03", function() cm:show_advice("3k_dlc07_campaign_faction_intro_zheng_jiang_03_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "zheng_jiang_04", function() cm:show_advice("3k_dlc07_campaign_faction_intro_zheng_jiang_04_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "zheng_jiang_05", function() cm:show_advice("3k_dlc07_campaign_faction_intro_zheng_jiang_05_advisor"); end );
...
function cutscene_intro_skipped(advice_to_play)
	...
	cm:show_advice("3k_dlc07_campaign_faction_intro_zheng_jiang_01_advisor");
	cm:show_advice("3k_dlc07_campaign_faction_intro_zheng_jiang_02_advisor");
	cm:show_advice("3k_dlc07_campaign_faction_intro_zheng_jiang_03_advisor");
	cm:show_advice("3k_dlc07_campaign_faction_intro_zheng_jiang_04_advisor");
	cm:show_advice("3k_dlc07_campaign_faction_intro_zheng_jiang_05_advisor");
...
function add_turn_one_character_map_pins()
	output("3k_main_faction_zheng_jiang_start.lua: Adding turn one character map pins.");
		-- Create a table connecting our map_pin records with our derived character CQIs
		local map_pin_characters = 
		{
			["3k_startpos_pin_zheng_jiang_zheng_jiang"] = cm:query_faction(local_faction_key):faction_leader():cqi(),
		}
...
function add_turn_one_settlement_map_pins()
	...
	local map_pin_settlements = 
		{
			["3k_dlc05_startpos_pin_zheng_jiang_liu_bei"] = "3k_main_donghai_capital",
			["3k_dlc05_startpos_pin_zheng_jiang_cao_cao"] = "3k_main_penchang_capital",
		}
