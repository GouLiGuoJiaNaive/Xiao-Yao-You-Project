	...
	function() 
		...
		-- Set starting camera
			cm:set_camera_position(
				352.866,	-- camera x position 
				349.517,	-- camera y position 
				4.52,		-- camera d position 
...
function cutscene_intro_play()
	...
	cutscene_intro:action( function() cutscene_intro:cindy_playback("script/campaign/dlc07_guandu/factions/campaing_intro_cutscenes/scenes/cao_cao_198.CindyScene", 0, 6); end, 0 );

	cutscene_intro:add_cinematic_trigger_listener( "cao_cao_01", function() cm:show_advice("3k_dlc07_campaign_faction_intro_cao_cao_01_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "cao_cao_02", function() cm:show_advice("3k_dlc07_campaign_faction_intro_cao_cao_02_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "cao_cao_03", function() cm:show_advice("3k_dlc07_campaign_faction_intro_cao_cao_03_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "cao_cao_04", function() cm:show_advice("3k_dlc07_campaign_faction_intro_cao_cao_04_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "cao_cao_05", function() cm:show_advice("3k_dlc07_campaign_faction_intro_cao_cao_05_advisor"); end );
...
function cutscene_intro_skipped(advice_to_play)
	...
	cm:show_advice("3k_dlc07_campaign_faction_intro_cao_cao_01_advisor");
	cm:show_advice("3k_dlc07_campaign_faction_intro_cao_cao_02_advisor");
	cm:show_advice("3k_dlc07_campaign_faction_intro_cao_cao_03_advisor");
	cm:show_advice("3k_dlc07_campaign_faction_intro_cao_cao_04_advisor");
	cm:show_advice("3k_dlc07_campaign_faction_intro_cao_cao_05_advisor");
...
---------------------------------------------------------------
--	Turn One Map Pins - Cao Cao Guandu
---------------------------------------------------------------0
...
function add_turn_one_character_map_pins()
	...
	local map_pin_characters = 
		{
			["3k_dlc07_startpos_pin_cao_cao_cao_cao"] = cm:query_faction("3k_main_faction_cao_cao"):faction_leader():cqi(),
			["3k_dlc07_startpos_pin_cao_cao_zheng_jiang"] = cm:query_faction("3k_main_faction_zheng_jiang"):faction_leader():cqi(),
			["3k_dlc07_startpos_pin_cao_cao_gong_du"] = cm:query_faction("3k_main_faction_yellow_turban_anding"):faction_leader():cqi(),
			["3k_dlc07_startpos_pin_cao_cao_liu_bei"] = cm:query_faction("3k_main_faction_liu_bei"):faction_leader():cqi(),
			["3k_dlc07_startpos_pin_cao_cao_yuan_shao"] = cm:query_faction("3k_main_faction_yuan_shao"):faction_leader():cqi(),
		}
...
function add_turn_one_settlement_map_pins()
	output("3k_main_faction_cao_cao_start.lua: Adding turn one settlement map pins for Sun Jian's faction.");

	-- Create a table connecting our map_pin records with our region records /settlements
	local map_pin_settlements = 
		{
			["3k_dlc07_startpos_pin_cao_cao_captive_emperor"] = "3k_main_yingchuan_capital"
		}
