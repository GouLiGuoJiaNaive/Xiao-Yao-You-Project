...
cm:add_first_tick_callback_mp_new(
	function() 
		...
		cm:set_camera_position(
			102.79,	-- camera x position 
			181.39,	-- camera y position 
			10.41,	-- camera d position 
			-0.299034,	-- camera b position 
			6.22	-- camera h position			
		);
	end
...
function cutscene_intro_play()
	...
	cutscene_intro:action( function() cutscene_intro:cindy_playback("script/campaign/dlc07_guandu/factions/campaing_intro_cutscenes/scenes/meng_huo_198.CindyScene", 0, 6); end, 0 );

	cutscene_intro:add_cinematic_trigger_listener( "meng_huo_01", function() cm:show_advice("3k_dlc07_campaign_faction_intro_meng_huo_01_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "meng_huo_02", function() cm:show_advice("3k_dlc07_campaign_faction_intro_meng_huo_02_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "meng_huo_03", function() cm:show_advice("3k_dlc07_campaign_faction_intro_meng_huo_03_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "meng_huo_04", function() cm:show_advice("3k_dlc07_campaign_faction_intro_meng_huo_04_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "meng_huo_05", function() cm:show_advice("3k_dlc07_campaign_faction_intro_meng_huo_05_advisor"); end );
...
function cutscene_intro_skipped(advice_to_play)
	...
	cm:show_advice("3k_dlc07_campaign_faction_intro_meng_huo_01_advisor");
	cm:show_advice("3k_dlc07_campaign_faction_intro_meng_huo_02_advisor");
	cm:show_advice("3k_dlc07_campaign_faction_intro_meng_huo_03_advisor");
	cm:show_advice("3k_dlc07_campaign_faction_intro_meng_huo_04_advisor");
	cm:show_advice("3k_dlc07_campaign_faction_intro_meng_huo_05_advisor");
...
function add_turn_one_character_map_pins()
	output("3k_main_faction_nanman_king_meng_huo_start.lua: Adding turn one character map pins.");
		-- Create a table connecting our map_pin records with our derived character CQIs
		local map_pin_characters = 
		{
			["3k_dlc06_startpos_pin_meng_huo_meng_huo"] = cm:query_faction("3k_dlc06_faction_nanman_king_meng_huo"):faction_leader():cqi(),
			["3k_dlc07_startpos_pin_meng_huo_mulu"] = cm:query_faction("3k_dlc06_faction_nanman_king_mulu"):faction_leader():cqi(),
		}
...
function add_turn_one_settlement_map_pins()
	...
	local map_pin_settlements = 
		{
			["3k_dlc07_startpos_pin_meng_huo_shi_xie"] = "3k_main_jiaozhi_capital",
		}
