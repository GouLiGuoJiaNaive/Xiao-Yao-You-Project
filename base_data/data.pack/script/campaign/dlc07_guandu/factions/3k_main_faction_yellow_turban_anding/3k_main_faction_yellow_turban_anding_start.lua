...
cm:add_first_tick_callback_mp_new(
	function() 
		...
		cm:set_camera_position(
			329.58,	-- camera x position 
			296.64,	-- camera y position 
			6.00,	-- camera d position 
			-0.388272,	-- camera b position 
			0.38	-- camera h position			
		);
	end
...
function cutscene_intro_play()
	...
	cutscene_intro:action( function() cutscene_intro:cindy_playback("script/campaign/dlc07_guandu/factions/campaing_intro_cutscenes/scenes/gong_du_198.CindyScene", 0, 6); end, 0 );

	cutscene_intro:add_cinematic_trigger_listener( "gong_du_01", function() cm:show_advice("3k_dlc07_campaign_faction_intro_gong_du_01_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "gong_du_02", function() cm:show_advice("3k_dlc07_campaign_faction_intro_gong_du_02_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "gong_du_03", function() cm:show_advice("3k_dlc07_campaign_faction_intro_gong_du_03_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "gong_du_04", function() cm:show_advice("3k_dlc07_campaign_faction_intro_gong_du_04_advisor"); end );
...
function cutscene_intro_skipped(advice_to_play)
	...
	cm:show_advice("3k_dlc07_campaign_faction_intro_gong_du_01_advisor");
	cm:show_advice("3k_dlc07_campaign_faction_intro_gong_du_02_advisor");
	cm:show_advice("3k_dlc07_campaign_faction_intro_gong_du_03_advisor");
	cm:show_advice("3k_dlc07_campaign_faction_intro_gong_du_04_advisor");
...
---------------------------------------------------------------
--	Turn One Region Visibility: Gong Du
---------------------------------------------------------------
...
function add_turn_one_character_map_pins()
	output("3k_main_faction_yellow_turban_anding_start.lua: Adding turn one character map pins.");
		-- Create a table connecting our map_pin records with our derived character CQIs
		local map_pin_characters = 
		{
			["3k_dlc07_startpos_pin_gong_du_cao_cao"] = cm:query_faction("3k_main_faction_cao_cao"):faction_leader():cqi(),
			["3k_dlc07_startpos_pin_gong_du_gong_du"] = cm:query_faction("3k_main_faction_yellow_turban_anding"):faction_leader():cqi(),
			["3k_dlc07_startpos_pin_gong_du_liu_bei"] = cm:query_faction("3k_main_faction_liu_bei"):faction_leader():cqi(),
			["3k_dlc07_startpos_pin_gong_du_yuan_shao"] = cm:query_faction("3k_main_faction_yuan_shao"):faction_leader():cqi(),
		}
...
function add_turn_one_settlement_map_pins()
	output("3k_main_faction_yellow_turban_anding.lua: Adding turn one settlement map pins for Sun Jian's faction.");
...
function end_turn_map_pin_removal_listener()
	output("3k_main_faction_yellow_turban_anding.lua: Adding End Turn Map Pin Removal Listener.");
	...
	core:add_listener(
		...
		function(context)
			output("3k_main_faction_yellow_turban_anding.lua: Turn one has ended.");
			return context:query_model():turn_number() == 1;
		end,

		-- Remove the scripted pins.
		function(context)
			output("3k_main_faction_yellow_turban_anding.lua: Removing guide map pins.");
