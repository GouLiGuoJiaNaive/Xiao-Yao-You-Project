...
cm:add_first_tick_callback_mp_new(
	function() 
		...
		cm:set_camera_position(
			331.56,	-- camera x position 
			373.70,	-- camera y position 
			4.99,	-- camera d position 
			-0.332766,	-- camera b position 
			0.34	-- camera h position			
		);
	end
...
function cutscene_intro_play()
	...
	cutscene_intro:action( function() cutscene_intro:cindy_playback("script/campaign/dlc07_guandu/factions/campaing_intro_cutscenes/scenes/lui_bei_198.CindyScene", 0, 6); end, 0 );

	cutscene_intro:add_cinematic_trigger_listener( "liu_bei_01", function() cm:show_advice("3k_dlc07_campaign_faction_intro_liu_bei_01_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "liu_bei_02", function() cm:show_advice("3k_dlc07_campaign_faction_intro_liu_bei_02_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "liu_bei_03", function() cm:show_advice("3k_dlc07_campaign_faction_intro_liu_bei_03_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "liu_bei_04", function() cm:show_advice("3k_dlc07_campaign_faction_intro_liu_bei_04_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "liu_bei_05", function() cm:show_advice("3k_dlc07_campaign_faction_intro_liu_bei_05_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "liu_bei_06", function() cm:show_advice("3k_dlc07_campaign_faction_intro_liu_bei_06_advisor"); end );
...
function cutscene_intro_skipped(advice_to_play)
	...
	cm:show_advice("3k_dlc07_campaign_faction_intro_liu_bei_01_advisor");
	cm:show_advice("3k_dlc07_campaign_faction_intro_liu_bei_02_advisor");
	cm:show_advice("3k_dlc07_campaign_faction_intro_liu_bei_03_advisor");
	cm:show_advice("3k_dlc07_campaign_faction_intro_liu_bei_04_advisor");
	cm:show_advice("3k_dlc07_campaign_faction_intro_liu_bei_05_advisor");
	cm:show_advice("3k_dlc07_campaign_faction_intro_liu_bei_06_advisor");
...
function turn_one_region_visibility()
	...
	-- Liu Zhang
	modify_faction:make_region_seen_in_shroud("3k_main_chengdu_capital");
...
---------------------------------------------------------------
--	Turn One Map Pins: Liu Bei Guandu -- [DS]
---------------------------------------------------------------0
...
function add_turn_one_character_map_pins()
	...
	local map_pin_characters = 
		{
			["3k_dlc07_startpos_pin_liu_bei_cao_cao"] = cm:query_faction("3k_main_faction_cao_cao"):faction_leader():cqi(),
			["3k_dlc07_startpos_pin_liu_bei_chen_deng"] = cm:query_faction("3k_dlc07_faction_chen_deng"):faction_leader():cqi(),
			["3k_dlc07_startpos_pin_liu_bei_gong_du"] = cm:query_faction("3k_main_faction_yellow_turban_anding"):faction_leader():cqi(),
			["3k_dlc07_startpos_pin_liu_bei_liu_bei"] = cm:query_faction("3k_main_faction_liu_bei"):faction_leader():cqi(),
			["3k_dlc07_startpos_pin_liu_bei_yuan_shao"] = cm:query_faction("3k_main_faction_yuan_shao"):faction_leader():cqi(),
		}
...
function add_turn_one_settlement_map_pins()
	output("3k_main_faction_liu_bei_start.lua: Adding turn one settlement map pins ");
