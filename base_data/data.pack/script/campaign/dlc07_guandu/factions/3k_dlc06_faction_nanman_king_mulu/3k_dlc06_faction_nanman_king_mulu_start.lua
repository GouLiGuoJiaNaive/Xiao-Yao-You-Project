...
cm:add_first_tick_callback_mp_new(
	function() 
		...
		cm:set_camera_position(
			115.17,	-- camera x position 
			192.46,	-- camera y position 
			12.79,	-- camera d position 
			-0.321802,	-- camera b position 
			9.03	-- camera h position			
		);
	end
...
function cutscene_intro_play()
	...
	cutscene_intro:action( function() cutscene_intro:cindy_playback("script/campaign/dlc07_guandu/factions/campaing_intro_cutscenes/scenes/king_mulu_198.CindyScene", 0, 6); end, 0 );

	cutscene_intro:add_cinematic_trigger_listener( "king_mulu_01", function() cm:show_advice("3k_dlc07_campaign_faction_intro_king_mulu_01_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "king_mulu_02", function() cm:show_advice("3k_dlc07_campaign_faction_intro_king_mulu_02_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "king_mulu_03", function() cm:show_advice("3k_dlc07_campaign_faction_intro_king_mulu_03_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "king_mulu_04", function() cm:show_advice("3k_dlc07_campaign_faction_intro_king_mulu_04_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "king_mulu_05", function() cm:show_advice("3k_dlc07_campaign_faction_intro_king_mulu_05_advisor"); end );
...
function cutscene_intro_skipped(advice_to_play)
	...
	cm:show_advice("3k_dlc07_campaign_faction_intro_king_mulu_01_advisor");
	cm:show_advice("3k_dlc07_campaign_faction_intro_king_mulu_02_advisor");
	cm:show_advice("3k_dlc07_campaign_faction_intro_king_mulu_03_advisor");
	cm:show_advice("3k_dlc07_campaign_faction_intro_king_mulu_04_advisor");
	cm:show_advice("3k_dlc07_campaign_faction_intro_king_mulu_05_advisor");
...
---------------------------------------------------------------
--	Turn One Region Visibility: King Mulu
---------------------------------------------------------------
...
function turn_one_region_visibility()
	...
	local modify_faction = cm:modify_faction("3k_dlc06_faction_nanman_king_mulu");
...
-- Shi Xie
modify_faction:make_region_seen_in_shroud("3k_main_jiaozhi_capital");
...
---------------------------------------------------------------
--	Turn One Map Pins: King Mulu -- [DS]
---------------------------------------------------------------0

function add_turn_one_character_map_pins()
	output("3k_main_faction_nanman_king_mulu_start.lua: Adding turn one character map pins.");
		-- Create a table connecting our map_pin records with our derived character CQIs
		local map_pin_characters = 
		{
			["3k_dlc06_startpos_pin_king_mulu_king_mulu"] = cm:query_faction("3k_dlc06_faction_nanman_king_mulu"):faction_leader():cqi(),
			["3k_dlc07_startpos_pin_king_mulu_meng_huo"] = cm:query_faction("3k_dlc06_faction_nanman_king_meng_huo"):faction_leader():cqi(),
			["3k_dlc07_startpos_pin_king_mulu_shamoke"] = cm:query_faction("3k_dlc06_faction_nanman_king_shamoke"):faction_leader():cqi(),
		}
...
function add_turn_one_settlement_map_pins()
	output("3k_main_faction_nanman_king_mulu_start.lua: Adding turn one settlement map pins for king_mulu's faction.");
...
function end_turn_map_pin_removal_listener()
	output("3k_main_faction_nanman_king_mulu_start.lua: Adding End Turn Map Pin Removal Listener.");
	...
	core:add_listener(
		...
		function(context)
			output("3k_main_faction_nanman_king_mulu_start.lua: Turn one has ended.");
			return context:query_model():turn_number() == 1;
		end,

		-- Remove the scripted pins.
		function(context)
			output("3k_main_faction_nanman_king_mulu_start.lua: Removing guide map pins.");
