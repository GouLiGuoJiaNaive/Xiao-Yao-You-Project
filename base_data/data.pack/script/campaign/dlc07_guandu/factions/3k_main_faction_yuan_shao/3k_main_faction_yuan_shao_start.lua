...
cm:add_first_tick_callback_mp_new(
	function() 
		...
		cm:set_camera_position(
			330.675,	-- camera x position 
			395.363,	-- camera y position 
			5.82,		-- camera d position 
			-0.324622,	-- camera b position 
			1.19		-- camera h position			
		);
	end
...
function cutscene_intro_play()
	...
	cutscene_intro:action( function() cutscene_intro:cindy_playback("script/campaign/dlc07_guandu/factions/campaing_intro_cutscenes/scenes/yuan_shao_198.CindyScene", 0, 6); end, 0 );

	cutscene_intro:add_cinematic_trigger_listener( "yuan_shao_01", function() cm:show_advice("3k_dlc07_campaign_faction_intro_yuan_shao_01_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "yuan_shao_02", function() cm:show_advice("3k_dlc07_campaign_faction_intro_yuan_shao_02_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "yuan_shao_03", function() cm:show_advice("3k_dlc07_campaign_faction_intro_yuan_shao_03_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "yuan_shao_04", function() cm:show_advice("3k_dlc07_campaign_faction_intro_yuan_shao_04_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "yuan_shao_05", function() cm:show_advice("3k_dlc07_campaign_faction_intro_yuan_shao_05_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "yuan_shao_06", function() cm:show_advice("3k_dlc07_campaign_faction_intro_yuan_shao_06_advisor"); end );
...
function cutscene_intro_skipped(advice_to_play)
	...
	cm:show_advice("3k_dlc07_campaign_faction_intro_yuan_shao_01_advisor");
	cm:show_advice("3k_dlc07_campaign_faction_intro_yuan_shao_02_advisor");
	cm:show_advice("3k_dlc07_campaign_faction_intro_yuan_shao_03_advisor");
	cm:show_advice("3k_dlc07_campaign_faction_intro_yuan_shao_04_advisor");
	cm:show_advice("3k_dlc07_campaign_faction_intro_yuan_shao_05_advisor");
	cm:show_advice("3k_dlc07_campaign_faction_intro_yuan_shao_06_advisor");
...
function add_turn_one_character_map_pins()
	...
	output("3k_main_faction_yuan_shao_start.lua: Adding turn one character map pins.");
	-- Create a table connecting our map_pin records with our derived character CQIs
	local map_pin_characters = 
	{
		["3k_dlc07_startpos_pin_yuan_shao_gong_du"] = cm:query_faction("3k_main_faction_yellow_turban_anding"):faction_leader():cqi(),
		["3k_dlc07_startpos_pin_yuan_shao_liu_bei"] = cm:query_faction("3k_main_faction_liu_bei"):faction_leader():cqi(),
		["3k_dlc07_startpos_pin_yuan_shao_yuan_shao"] = cm:query_faction("3k_main_faction_yuan_shao"):faction_leader():cqi(),
		["3k_dlc07_startpos_pin_yuan_shao_yuan_tan"] = cm:query_faction("3k_dlc05_faction_yuan_tan"):faction_leader():cqi(),
	}
...
local map_pin_settlements = 
	{
		["3k_dlc07_startpos_pin_yuan_shao_cao_cao"] = "3k_main_dongjun_capital",
	}
