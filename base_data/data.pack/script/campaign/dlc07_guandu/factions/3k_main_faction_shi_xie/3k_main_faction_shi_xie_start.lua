...
cm:add_first_tick_callback_mp_new(
	function() 
		...
		cm:set_camera_position(
			196.36,	-- camera x position 
			130.50,	-- camera y position 
			7.89,	-- camera d position 
			-0.432597,	-- camera b position 
			1.58	-- camera h position			
		);
	end
...
function cutscene_intro_play()
	...
	cutscene_intro:action( function() cutscene_intro:cindy_playback("script/campaign/dlc07_guandu/factions/campaing_intro_cutscenes/scenes/shi_xie_198.CindyScene", 0, 6); end, 0 );

	cutscene_intro:add_cinematic_trigger_listener( "shi_xie_01", function() cm:show_advice("3k_dlc07_campaign_faction_intro_shi_xie_01_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "shi_xie_02", function() cm:show_advice("3k_dlc07_campaign_faction_intro_shi_xie_02_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "shi_xie_03", function() cm:show_advice("3k_dlc07_campaign_faction_intro_shi_xie_03_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "shi_xie_04", function() cm:show_advice("3k_dlc07_campaign_faction_intro_shi_xie_04_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "shi_xie_05", function() cm:show_advice("3k_dlc07_campaign_faction_intro_shi_xie_05_advisor"); end );
...
function cutscene_intro_skipped(advice_to_play)
	...
	cm:show_advice("3k_dlc07_campaign_faction_intro_shi_xie_01_advisor");
	cm:show_advice("3k_dlc07_campaign_faction_intro_shi_xie_02_advisor");
	cm:show_advice("3k_dlc07_campaign_faction_intro_shi_xie_03_advisor");
	cm:show_advice("3k_dlc07_campaign_faction_intro_shi_xie_04_advisor");
	cm:show_advice("3k_dlc07_campaign_faction_intro_shi_xie_05_advisor");
...
function add_turn_one_character_map_pins()
		...
		output("3k_main_faction_shi_xie_start.lua: Adding turn one character map pins.");
		-- Create a table connecting our map_pin records with our derived character CQIs
		local map_pin_characters = 
		{
			["3k_dlc07_startpos_pin_shi_xie_shi_xie"] = cm:query_faction("3k_main_faction_shi_xie"):faction_leader():cqi(),
		}
...
function add_turn_one_settlement_map_pins()
	output("3k_main_faction_shi_xie_start.lua: Adding turn one settlement map pins for Sun Jian's faction.");

	-- Create a table connecting our map_pin records with our region records /settlements
	local map_pin_settlements = 
		{
			["3k_dlc07_startpos_pin_shi_xie_mulu"] = "3k_dlc06_jiaozhi_resource_3",
			["3k_dlc07_startpos_pin_shi_xie_meng_huo"] = "3k_main_jiaozhi_resource_2",
			["3k_dlc07_startpos_pin_shi_xie_liu_biao"] = "3k_main_lingling_resource_1",
		}
...
function end_turn_map_pin_removal_listener()
	output("3k_main_faction_shi_xie_start.lua: Adding End Turn Map Pin Removal Listener.");
