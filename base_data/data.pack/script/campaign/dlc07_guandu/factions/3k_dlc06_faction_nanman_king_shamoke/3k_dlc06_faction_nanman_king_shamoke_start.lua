...
cm:add_first_tick_callback_mp_new(
	function() 
		...
		cm:set_camera_position(
			220.91,	-- camera x position 
			232.36,	-- camera y position 
			9.43,	-- camera d position 
			-0.372626,	-- camera b position 
			4.16	-- camera h position			
		);
	end
...
function cutscene_intro_play()
	...
	cutscene_intro:action( function() cutscene_intro:cindy_playback("script/campaign/dlc07_guandu/factions/campaing_intro_cutscenes/scenes/king_shamoke_198.CindyScene", 0, 6); end, 0 );

	cutscene_intro:add_cinematic_trigger_listener( "shamoke_01", function() cm:show_advice("3k_dlc07_campaign_faction_intro_king_shamoke_01_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "shamoke_02", function() cm:show_advice("3k_dlc07_campaign_faction_intro_king_shamoke_02_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "shamoke_03", function() cm:show_advice("3k_dlc07_campaign_faction_intro_king_shamoke_03_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "shamoke_04", function() cm:show_advice("3k_dlc07_campaign_faction_intro_king_shamoke_04_advisor"); end );
	cutscene_intro:add_cinematic_trigger_listener( "shamoke_05", function() cm:show_advice("3k_dlc07_campaign_faction_intro_king_shamoke_05_advisor"); end );
...
function cutscene_intro_skipped(advice_to_play)
	...
	cm:show_advice("3k_dlc07_campaign_faction_intro_king_shamoke_01_advisor");
	cm:show_advice("3k_dlc07_campaign_faction_intro_king_shamoke_02_advisor");
	cm:show_advice("3k_dlc07_campaign_faction_intro_king_shamoke_03_advisor");
	cm:show_advice("3k_dlc07_campaign_faction_intro_king_shamoke_04_advisor");
	cm:show_advice("3k_dlc07_campaign_faction_intro_king_shamoke_05_advisor");
...
---------------------------------------------------------------
--	Turn One Region Visibility: King Shamoke
---------------------------------------------------------------
...
function turn_one_region_visibility()
	...
	local modify_faction = cm:modify_faction("3k_dlc06_faction_nanman_king_shamoke");
...
function add_turn_one_character_map_pins()
	output("3k_main_faction_nanman_king_shamoke_start.lua: Adding turn one character map pins.");
		-- Create a table connecting our map_pin records with our derived character CQIs
		local map_pin_characters = 
		{
			["3k_dlc06_startpos_pin_shamoke_shamoke"] = cm:query_faction("3k_dlc06_faction_nanman_king_shamoke"):faction_leader():cqi(),
		}
...
function add_turn_one_settlement_map_pins()
	output("3k_main_faction_nanman_king_shamoke_start.lua: Adding turn one settlement map pins for shamoke's faction.");

	-- Create a table connecting our map_pin records with our region records /settlements
	local map_pin_settlements = 
		{
			["3k_dlc07_startpos_pin_shamoke_mulu"] = "3k_main_zangke_resource_2",
		}
...
function end_turn_map_pin_removal_listener()
	output("3k_main_faction_nanman_king_shamoke_start.lua: Adding End Turn Map Pin Removal Listener.");
	...
	core:add_listener(
		...
		function(context)
			output("3k_main_faction_nanman_king_shamoke_start.lua: Turn one has ended.");
			return context:query_model():turn_number() == 1;
		end,

		-- Remove the scripted pins.
		function(context)
			output("3k_main_faction_nanman_king_shamoke_start.lua: Removing guide map pins.");
