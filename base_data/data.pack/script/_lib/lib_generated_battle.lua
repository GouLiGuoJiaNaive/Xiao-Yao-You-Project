...
--- @r boolean battle has started is specified then it will be assumed that the script name is a blank string. No more than one army in the specified alliance can contain units with the supplied script name.
--- @r generated_army
...
--	GENERATED CUTSCENE
--
-- @c generated_cutscene Generated Cutscene
-- @page generated_battle
...
function generated_battle:enqueue_cutscene_elements(cutscene_intro, gc)
	...
	-- SETUP --
		...
		if gc.is_debug then
			self.bm:out(element.id .. "= " .. tostring(speech) .. "," .. tostring(subtitle) .. "," .. tostring(camera) .. "," .. tostring(min_length) .. "," .. tostring(loop_camera) .. "," .. tostring(wait_for_vo));
		end
