...
function campaign_ui_manager:start_campaign_ui_listeners()
	...
	core:add_listener(
		"campaign_selection_listener",
		"ScriptEventLocalPlayerFactionTurnEnd",
		true,
		function()
...
function campaign_ui_manager:is_dilemma_open()
	local uic_layout_dilemma = find_uicomponent(core:get_ui_root(), "hud_campaign", "event_feed_hub", "event_single", "layout_dilemma");
...
function campaign_ui_manager:unhighlight_character_by_cqi(cqi, use_marker)
	return self:unhighlight_character_action(char_lookup_str(cqi), use_marker);
end;
...
function campaign_ui_manager:highlight_corruption(value, pulse_strength, force_highlight)
	...
	local cm = get_cm();
	local uic = find_uicomponent(core:get_ui_root(), "hud_campaign", "info_panel_holder", "primary_info_panel_holder", "info_panel_background", "ProvinceInfoPopup", "frame_corruption");
...
function campaign_ui_manager:highlight_public_order(value, pulse_strength, force_highlight)
	...
	local cm = get_cm();
	local uic = find_uicomponent(core:get_ui_root(), "hud_campaign", "info_panel_holder", "primary_info_panel_holder", "info_panel_background", "ProvinceInfoPopup", "frame_PO_income");
