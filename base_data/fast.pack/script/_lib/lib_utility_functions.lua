...
--- @r number Rounded value
function math.round(num, numDecimalPlaces)

	if not is_number(num) then
		script_error("ERROR: math.round - Passed in number is not a number " .. tostring(num));
		return false;
	end;

	if not is_number(numDecimalPlaces) then
		script_error("ERROR: math.round - Passed in numDecimalPlaces is not a number " .. tostring(numDecimalPlaces));
		return false;
	end;
