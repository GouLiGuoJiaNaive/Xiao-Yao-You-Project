...
function is_query_diplomacy_deal_list(obj)
	if string.sub(tostring(obj), 1, 42) == "QUERY_DIPLOMACY_DEAL_LIST_SCRIPT_INTERFACE" then
		return true;
	end;
...
function is_query_diplomacy_deal_component(obj)
	if string.sub(tostring(obj), 1, 47) == "QUERY_DIPLOMACY_DEAL_COMPONENT_SCRIPT_INTERFACE" then
		return true;
	end;
...
function is_query_diplomacy_proposed_component(obj)
	if string.sub(tostring(obj), 1, 51) == "QUERY_DIPLOMACY_PROPOSED_COMPONENT_SCRIPT_INTERFACE" then
		return true;
	end;
...
function is_query_military_force_retinue(obj)
	return string.sub(tostring(obj), 1, 45) == "QUERY_MILITARY_FORCE_RETINUE_SCRIPT_INTERFACE"
end
...
--- @p object object
--- @r boolean table contains object
