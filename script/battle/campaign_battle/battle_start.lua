...
if effect.get_advice_level() >= 2 then
	force_require("default_battle_objectives");
end;
...
if ( battle_type == "land_normal" -- Only for land battles
	...
	force_require("3k_campaign_battle_tutorial");
	...
	force_require("3k_battle_advice");
	battle_advice_system:register_campaign_battle();


end;

require("script/battle/xyy_ai_battle/xyy_ai_battle");
require("script/battle/xyy_ai_battle/xyy_battle_pannel");
