...
function dlc04_global_events:new_game()
	cm:modify_region("3k_main_luoyang_capital"):apply_effect_bundle("3k_main_effect_bundle_world_leader_effects_region",
		-1);
end
...
function dlc04_global_events:mandate_war_events()
	local mandate_war_start_dilemmas = global_event:new("mandate_war_start_dilemmas",
		"DLC04_MandateOfHeavenWarStartedDilemmas");
	...
	mandate_war_start_dilemmas:add_dilemma(
	"3k_dlc04_progression_global_yellow_turban_rebellion_starts_dilemma_emperor_variant");                                     -- Fires for the emperor
	...
	local mandate_war_start_incidents = global_event:new("mandate_war_start_incidents",
		"DLC04_MandateOfHeavenWarStartedIncidents");
	...
	mandate_war_start_incidents:add_incident(
	"3k_dlc04_progression_global_yellow_turban_rebellion_starts_incident_emperor_variant");                                       -- Fires for the emperor
...
function dlc04_global_events:fall_of_the_han()
	...
	local emperor_dies = global_event:new("emperor_dies", "WorldStartOfRoundEvent",
		function()
			return cdir_mission_manager:get_turn_number() >= 33
		end);
	emperor_dies:add_dilemma("3k_dlc04_global_event_fallofhan_00_emperor_feeling_ill_dilemma",
		function(faction) return cm:is_human_faction("3k_dlc04_faction_empress_he") end);
	emperor_dies:add_dilemma_choice_outcome("3k_dlc04_global_event_fallofhan_00_emperor_feeling_ill_dilemma", 0,
		"EmperorSaved", 0);
	emperor_dies:add_dilemma_choice_outcome("3k_dlc04_global_event_fallofhan_00_emperor_feeling_ill_dilemma", 1,
		"EmperorDied", 100);
	emperor_dies:add_incident("3k_dlc04_global_event_fallofhan_00_global_emperor_dies_incident",
		function(faction) return not cm:is_human_faction("3k_dlc04_faction_empress_he") end, "EmperorDied");                                                                                       -- Fires for ALL players
	...
	if not cm:is_human_faction("3k_dlc04_faction_empress_he") then -- We assume an alternate history if the Han are a human faction.
		...
		he_jin_killed:add_incident("3k_dlc04_global_event_fallofhan_01a_global_eunuchs_kill_he_jin_incident",
			function(faction) return self:is_character_template_alive("3k_dlc04_template_historical_he_jin_metal") end);                                                                                                   -- Fires for ALL players, contains the 'kill he jin payload'
		-- Or a generic other character.
		he_jin_killed:add_incident("3k_dlc04_global_event_fallofhan_01b_global_eunuchs_kill_official_incident",
			function(faction) return not self:is_character_template_alive("3k_dlc04_template_historical_he_jin_metal") end);                                                                                               -- Fires for ALL players, contains the 'kill official payload'
		...
		dz_avenge_he_jin:add_mission("3k_dlc04_global_event_fallofhan_02a_dong_zhuo_avenge_he_jin_mission",
			function() return global_events_manager:get_flag("EunuchsKilledHeJin") end, "OfficialAvenged",
			"OfficialAvenged");                                                                                                                                                                                               -- Fires for Dong Zhuo Only, if failed, go-to next
		dz_avenge_he_jin:add_mission("3k_dlc04_global_event_fallofhan_02b_dong_zhuo_avenge_official_mission",
			function() return global_events_manager:get_flag("EunuchsKilledOfficial") end, "OfficialAvenged",
			"OfficialAvenged");                                                                                                                                                                                               -- Fires for Dong Zhuo Only, if failed, go-to next
		...
		eunuchs_killed:add_incident("3k_dlc04_global_event_fallofhan_03a_dong_zhuo_kill_the_eunuchs_incident",
			function(q_faction) return q_faction:name() == "3k_main_faction_dong_zhuo" end, "EunuchsKilled",
			"EunuchsKilled");                                                                                                                                                                                               -- Dong Zhuo arriving after killing the eunuchs
		eunuchs_killed:add_incident("3k_dlc04_global_event_fallofhan_03a_global_kill_the_eunuchs_incident",
			function(q_faction) return q_faction:name() ~= "3k_main_faction_dong_zhuo" end, "EunuchsKilled",
			"EunuchsKilled");                                                                                                                                                                                               -- Eunuchs being killed by anyone else.
		eunuchs_killed:register();


		--004 Eunuchs flee, Empire collapses. Dong Zhuo considers seizing the emperor via event chain
		local dz_can_sieze_emperor = global_event:new("dz_can_sieze_emperor", "WorldStartOfRoundEvent",
			function() return global_events_manager:get_flag("eunuchs_killed") end);
		...
		dz_can_sieze_emperor:add_dilemma_choice_outcome(
			"3k_dlc04_global_event_fallofhan_04a_dong_zhuo_seizing_the_emperor_dz_dilemma", 0, "EmperorSeized", 100,
			function()
				diplomacy_manager:force_confederation("3k_main_faction_dong_zhuo", "3k_dlc04_faction_empress_he");
				cm:modify_faction("3k_main_faction_dong_zhuo"):make_region_capital(cm:query_region("3k_main_luoyang_capital"))
				global_events_manager:set_flag("DongZhuoSeizedTheEmpire");
			end);                                                                                                                                             -- Confederate Han Dynasty
		dz_can_sieze_emperor:add_dilemma_choice_outcome(
		"3k_dlc04_global_event_fallofhan_04a_dong_zhuo_seizing_the_emperor_dz_dilemma", 1, "DidntSeizeEmperor", 0);                                           -- Decreases DZ's intimidation
...
function dlc04_global_events:the_peach_garden()
	...
	peach_garden_00:add_post_event_callback(function()
		...
		local m_char_zhang_fei = m_faction:create_character_from_template("general", "3k_general_fire",
			"3k_main_template_historical_zhang_fei_hero_fire", true);
		local m_char_guan_yu = m_faction:create_character_from_template("general", "3k_general_wood",
			"3k_main_template_historical_guan_yu_hero_wood", true);
		...
		if found_pos then
			cm:create_force_with_existing_general(m_char_zhang_fei:query_character():command_queue_index(),
				local_faction_key, "", region_key, x, y, "liu_bei_zhang_fei", nil, 100);
		end;
		...
		if found_pos then
			cm:create_force_with_existing_general(m_char_guan_yu:query_character():command_queue_index(),
				local_faction_key, "", region_key, x, y, "liu_bei_guan_yu", nil, 100);
		end;
...
function dlc04_global_events:xiahou_bros_join_cao_cao()
	...
	local xiahou_bros = global_event:new("xiahou_bros", "FactionTurnStart",
		function(context)
			return progression:has_progression_feature(context:faction(), "rank_noble") and
			context:faction():name() == local_faction_key;
		end);
	...
	xiahou_bros:add_post_event_callback(function()
		-- Xiahou Dun
		local xiahou_dun_character = cm:query_model():character_for_template(
		...
		if not xiahou_dun_character or xiahou_dun_character:is_null_interface() then
			cm:modify_faction(local_faction_key):create_character_from_template("general", "3k_general_wood",
				"3k_main_template_historical_xiahou_dun_hero_wood", true);
		end
		-- Xiahou Yuan
		local xiahou_yuan_character = cm:query_model():character_for_template(
		...
		if not xiahou_yuan_character or xiahou_yuan_character:is_null_interface() then
			cm:modify_faction(local_faction_key):create_character_from_template("general", "3k_general_fire",
				"3k_main_template_historical_xiahou_yuan_hero_fire", true);
		end
...
function dlc04_global_events:lu_bu_betrays_ding_yuan()
	local lu_bu_betrays_ding_yuan = global_event:new("lu_bu_betrays_ding_yuan", "WorldStartOfRoundEvent",
		function(context)
			return cdir_mission_manager:get_turn_number() >= 30 and
			not cm:query_faction("3k_main_faction_dong_zhuo"):is_human();
		end);
	lu_bu_betrays_ding_yuan:add_incident("3k_dlc04_historical_global_lu_bu_defects_to_dong_zhuo_dz_npc")
	lu_bu_betrays_ding_yuan:add_other_player_incident(
	"3k_dlc04_historical_global_lu_bu_defects_to_dong_zhuo_dz_npc_mp_dummy")
...
function dlc04_global_events:misc()
	...
	local sun_jian_finds_the_imperial_seal = global_event:new("sun_jian_finds_the_imperial_seal",
	...
	sun_ren_is_born:add_post_event_callback(function()
		...
		-- create sun ren.
		local m_char_sun_ren = m_faction_sun_jian:create_character_from_template("general", "3k_general_fire",
			"3k_main_template_historical_lady_sun_shangxiang_hero_fire", false);
...
function dlc04_global_events:transition_events()
	...
	local transition_event_war_over = global_event:new("transition_event_war_over",
	...
	local transition_event_emperor = global_event:new("transition_event_emperor", "WorldPowerTokenGainedEvent",
		function(context) return not context.token or context:token() == "emperor" end);
	transition_event_emperor:set_delay_events(true);
	-- Dong Zhuo owns emperor (and either allied or not).
	transition_event_emperor:add_incident("3k_dlc04_transition_incident_emperor_captured_dong_zhuo_allied",
		function(q_faction) return cm:is_world_power_token_owned_by("emperor", "3k_main_faction_dong_zhuo") end);
	transition_event_emperor:add_incident("3k_dlc04_transition_incident_emperor_captured_dong_zhuo_not_allied",
		function(q_faction) return cm:is_world_power_token_owned_by("emperor", "3k_main_faction_dong_zhuo") end);
	transition_event_emperor:add_incident("3k_dlc04_transition_incident_emperor_captured_eunuchs",
		function(q_faction) return cm:is_world_power_token_owned_by("emperor", "3k_dlc04_faction_empress_he") end);
	...
	transition_event_emperor:add_incident("3k_dlc04_transition_incident_emperor_captured_player",
		function(q_faction) return cm:is_world_power_token_owned_by("emperor", q_faction:name()) end);
	transition_event_emperor:add_incident("3k_dlc04_transition_incident_emperor_captured_player_dong_zhuo",
		function(q_faction) return cm:is_world_power_token_owned_by("emperor", q_faction:name()) end);
...
function dlc04_global_events:luoyang_capture_listener()
	...
	core:add_listener(
		...
		function(context)                    -- Criteria
			...
			return region_key == "3k_main_luoyang_capital" and
			context:settlement():faction():name() == "3k_dlc04_faction_empress_he";                                                    --Criteria Test
		end,
...
function dlc04_global_events:emperor_capture_events()
	...
	local event1 = global_event:new(
		...
		function(context)
			return context:garrison_residence():region():name() == "3k_main_luoyang_capital" and
			context:query_character():faction():subculture() == "3k_main_chinese" and
			not cm:world_power_token_exists("emperor");
		end);
	...
	event1:add_dilemma("3k_dlc04_global_event_fallofhan_04a_dong_zhuo_seizing_the_emperor_dz_dilemma",
		function(q_faction)
			return q_faction:name() == "3k_main_faction_dong_zhuo"
				and
				(cm:query_region("3k_main_luoyang_capital"):is_abandoned() or cm:query_region("3k_main_luoyang_capital"):owning_faction():name() == "3k_main_faction_dong_zhuo") -- Have to do ALL the conditionals here otherwise, both will fire.
		end)                                                                                                                                                            -- Choose whether to seize the emperor,  DZ version
	event1:add_dilemma_choice_outcome("3k_dlc04_global_event_fallofhan_04a_dong_zhuo_seizing_the_emperor_dz_dilemma", 0,
		"EmperorSeized", 100,
		function()
			diplomacy_manager:force_confederation("3k_main_faction_dong_zhuo", "3k_dlc04_faction_empress_he")
			cm:modify_faction("3k_main_faction_dong_zhuo"):make_region_capital(cm:query_region("3k_main_luoyang_capital"))
		end);                                                                                                                                  -- Confederate Han Dynasty
	event1:add_dilemma_choice_outcome("3k_dlc04_global_event_fallofhan_04a_dong_zhuo_seizing_the_emperor_dz_dilemma", 1,
		"DidntSeizeEmperor", 0);                                                                                                               -- Lower intimidation
	...
	event1:add_dilemma("3k_dlc04_global_event_fallofhan_04c_global_seizing_the_emperor_dilemma",
		function(q_faction)
			return cm:query_region("3k_main_luoyang_capital"):owning_faction():name() == q_faction:name()
				and q_faction:name() ~=
				"3k_main_faction_dong_zhuo"            -- Have to do ALL the conditionals here otherwise, both will fire.
		end);                                          -- Choose whether to seize the emperor
	event1:add_dilemma_choice_outcome("3k_dlc04_global_event_fallofhan_04c_global_seizing_the_emperor_dilemma", 0,
		"EmperorSeized", 90,
		function(context)
			diplomacy_manager:force_confederation(cm:query_region("3k_main_luoyang_capital"):owning_faction():name(),
				"3k_dlc04_faction_empress_he")
			cm:modify_faction(cm:query_region("3k_main_luoyang_capital"):owning_faction()):make_region_capital(
			cm:query_region("3k_main_luoyang_capital"))
		end);                                                                                                                             -- Confederate Han Dynasty
	event1:add_dilemma_choice_outcome("3k_dlc04_global_event_fallofhan_04c_global_seizing_the_emperor_dilemma", 1,
		"DidntSeizeEmperor", 10);                                                                                                         -- Don't confederate
	...
	event2:add_incident("3k_dlc04_global_event_fallofhan_04a_global_seizing_the_emperor_dz_npc_incident",
		function(faction) return (cm:query_region("3k_main_luoyang_capital"):is_abandoned() or cm:query_region("3k_main_luoyang_capital"):owning_faction():name() == "3k_main_faction_dong_zhuo") and
			cm:query_region("3k_main_luoyang_capital"):owning_faction():name() ~= faction:name() end);                                                                                                                                                                                                                                                                                                             -- Not for DZ. Performs the confederation.
	event2:add_other_player_incident(
	"3k_dlc04_global_event_fallofhan_04a_global_seizing_the_emperor_dz_npc_dummy_incident",
		function(faction) return (cm:query_region("3k_main_luoyang_capital"):is_abandoned() or cm:query_region("3k_main_luoyang_capital"):owning_faction():name() == "3k_main_faction_dong_zhuo") and
			cm:query_region("3k_main_luoyang_capital"):owning_faction():name() ~= faction:name() end);                                                                                                                                                                                                                                                                                                             -- Not for DZ. No effects
	-- else. Confederates the Han.
	event2:add_incident("3k_dlc04_global_event_fallofhan_04b_global_seizing_the_emperor_npc_incident",
		function(faction) return cm:query_region("3k_main_luoyang_capital"):owning_faction():name() ~=
			"3k_main_faction_dong_zhuo" and
			cm:query_region("3k_main_luoyang_capital"):owning_faction():name() ~= faction:name() end);                                                                                                                                                                                                                                                                                                             -- Not for DZ. Performs the confederation.
	...
	event3:add_pre_event_callback(function(context, event) --- spawn the world power token for the emperor faction if they're still around
		if not cm:modify_faction("3k_dlc04_faction_empress_he"):query_faction():is_dead() then
			...
			if cm:modify_faction("3k_main_faction_dong_zhuo"):query_faction():is_human() then
				emperor_destination = campaign_emperor_manager:find_best_faction_for_emperor(
				cm:modify_faction("3k_main_faction_dong_zhuo"):query_faction(), -50)
			else
				emperor_destination = campaign_emperor_manager:find_best_faction_for_emperor(
				cm:modify_faction("3k_main_faction_dong_zhuo"):query_faction(), 150)
			end
...
function dlc04_global_events:liu_yan_takeover_from_que_jian()
	...
	que_jian_dies_event:add_post_event_callback(
		function(context)
			local liu_yan_character = cm:query_model():character_for_template(
			"3k_main_template_historical_liu_yan_hero_water")
			local lady_liu_character = cm:query_model():character_for_template(
			"3k_main_template_generated_lady_liu_mengan_hero_water")
			local liu_zhang_character = cm:query_model():character_for_template(
			"3k_main_template_historical_liu_zhang_hero_earth")
			local que_jian_character = cm:query_model():character_for_template(
			...
			if not liu_yan_character:is_null_interface() and not liu_yan_character:is_dead() then
				cm:modify_character(liu_yan_character:cqi()):move_to_faction_and_make_recruited(
			...
			if not lady_liu_character:is_null_interface() and not lady_liu_character:is_dead() then
				cm:modify_character(lady_liu_character:cqi()):move_to_faction_and_make_recruited(
				"3k_main_faction_liu_yan")
			end

			if not liu_zhang_character:is_null_interface() and not liu_zhang_character:is_dead() then
				cm:modify_character(liu_zhang_character:cqi()):move_to_faction_and_make_recruited(
				"3k_main_faction_liu_yan")
			end
	...
	for i, faction_key in ipairs(coalition_factions) do
		if faction_key == coalition_leader_key then
			...
			if q_faction and not q_faction:is_null_interface() and not q_faction:is_dead() then
				diplomacy_manager:apply_automatic_deal_between_factions(coalition_leader_key, faction_key,
					"data_defined_situation_create_coalition_yuan_shao");
			end;
		end
	end;
end;
