...
function apply_DLC05_diplomatic_availability()
	...
	cm:modify_model():enable_diplomacy("faction:3k_main_faction_cao_cao", "subculture:3k_dlc05_subculture_bandits", "treaty_components_attitude_manipulation_positive,treaty_components_attitude_manipulation_negative,treaty_components_instigate_proxy_war_proposer,treaty_components_schemes_resource_offer", "hidden")
