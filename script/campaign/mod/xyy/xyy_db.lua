...
gst.all_items_names = {
    ...
    ['3k_main_ancillary_follower_hua_tuo'] = { dlc = "tke", category = "follower", tier = "unique", en = "Hua Tuo", kr = "화타", zh = "華佗", cn = "军医", },
    ...
    ['tri_point_spear'] = { dlc = "xyy", category = "weapon", tier = "unique", en = "Tri-Point Double-Edged Spear", kr = "", zh = "三尖两刃枪", cn = "三尖两刃刀", },
    ['hlyjdingzhiaawuqi'] = { dlc = "xyy", category = "weapon", tier = "unique", en = "Sacrificial Sword", kr = "", zh = "祭礼剑", cn = "祭礼剑", },
    ['hlyjdingzhiabwuqi'] = { dlc = "xyy", category = "weapon", tier = "unique", en = "Royal Longsword", kr = "", zh = "宗室长剑", cn = "宗室长剑", },
}

--初级氪金    ------------------精制-----------------

gst.store_random_item1_weapon = {
    --武器
...
gst.store_random_item1_follower = {
    --随从
...
gst.store_random_item1_accessory = {
    --附件
...
gst.store_random_item2_weapon = {
    ...
    "exceptional,hlyjdingzhiaawuqi,祭礼剑",
    "exceptional,hlyjdingzhiabwuqi,宗室长剑",
}

gst.store_random_item2_armour = {
    --护甲
...
gst.store_random_item2_follower = {
    --随从
...
gst.store_random_item2_accessory = {
    --附件
...
gst.store_random_item3_weapon = {
    ...
    "unique,3k_main_ancillary_weapon_two_handed_axe_unique,破胆斧",
    ...
    "unique,tri_point_spear,三尖两刃枪"
}

gst.store_random_item3_armour = {
    --护甲
...
gst.store_random_item3_follower = {
    --随从
...
gst.store_random_item3_accessory = {
    --附件
...
gst.all_character_detils = {
    ['hlyjby'] = { ['name'] = "C酱", ['subtype'] = '3k_general_fire' },
    ['hlyjch'] = { ['name'] = "钟离", ['subtype'] = '3k_general_earth', ['weapon'] = { 'hlyjchwuqi_faction' } },
    ['hlyjci'] = { ['name'] = "甘雨", ['subtype'] = '3k_general_water' },
    ['hlyjcj'] = { ['name'] = "卡芙卡", ['subtype'] = '3k_general_fire', ['weapon'] = { 'hlyjcjwuqi_faction' }, ['movie'] = 'ep_faction_game_lost_sima_ai' },
    ['hlyjdingzhie'] = { ['name'] = "停云", ['subtype'] = '3k_general_water' },
    ['hlyjck'] = { ['name'] = "镜流", ['subtype'] = '3k_general_metal', ['weapon'] = { 'hlyjckwuqi_faction' } },
    ['hlyjcl'] = { ['name'] = "那维莱特", ['subtype'] = '3k_general_fire' },
    ['hlyjcm'] = { ['name'] = "雷电将军", ['subtype'] = '3k_general_fire', ['weapon'] = { 'hlyjcmwuqi' } },
    ['hlyjdf'] = { ['name'] = "九条裟罗", ['subtype'] = '3k_general_fire' },
    ['hlyjcn'] = { ['name'] = "刻晴", ['subtype'] = '3k_general_metal', ['weapon'] = { 'hlyjcnwuqi' } },
    ['hlyjco'] = { ['name'] = "芙宁娜", ['subtype'] = '3k_general_water', ['weapon'] = { 'hlyjcowuqi' } },
    ['hlyjcp'] = { ['name'] = "符玄", ['subtype'] = '3k_general_earth' },
    ['hlyjcq'] = { ['name'] = "安柏", ['subtype'] = '3k_general_fire' },
    ['hlyjcr'] = { ['name'] = "丽莎", ['subtype'] = '3k_general_water' },
    ['hlyjcs'] = { ['name'] = "妮露", ['subtype'] = '3k_general_wood', ['weapon'] = { 'hlyjcswuqi' } },
    ['hlyjct'] = { ['name'] = "阮・梅", ['subtype'] = '3k_general_water' },
    ['hlyjcu'] = { ['name'] = "珊瑚宫心海", ['subtype'] = '3k_general_water' },
    ['hlyjcv'] = { ['name'] = "提纳里", ['subtype'] = '3k_general_metal' },
    ['hlyjcw'] = { ['name'] = "真理医生", ['subtype'] = '3k_general_wood' },
    ['hlyjcx'] = { ['name'] = "胡桃", ['subtype'] = '3k_general_wood', ['weapon'] = { 'hlyjcxwuqi' } },
    ['hlyjcy'] = { ['name'] = "夜兰", ['subtype'] = '3k_general_water' },
    ['hlyjcz'] = { ['name'] = "希儿", ['subtype'] = '3k_general_fire', ['weapon'] = { 'hlyjczwuqi' } },
    ['hlyjda'] = { ['name'] = "优菈", ['subtype'] = '3k_general_wood', ['weapon'] = { 'hlyjdawuqi' } },
    ['hlyjdc'] = { ['name'] = "空", ['subtype'] = '3k_general_earth' },
    ['hlyjdd'] = { ['name'] = "荧", ['subtype'] = '3k_general_metal' },
    ['hlyjde'] = { ['name'] = "千织", ['subtype'] = '3k_general_earth', ['weapon'] = { 'hlyjdewuqi' } },
    ['hlyjdg'] = { ['name'] = "娜维娅", ['subtype'] = '3k_general_wood', ['weapon'] = { 'hlyjdgwuqi' } },
    ['hlyjdh'] = { ['name'] = "黑天鹅", ['subtype'] = '3k_general_water' },
    ['hlyjdi'] = { ['name'] = "吟霖", ['subtype'] = '3k_general_fire' },
    ['hlyjdj'] = { ['name'] = "流萤", ['subtype'] = '3k_general_fire', ['weapon'] = { 'hlyjdjwuqi' } },
    ['hlyjdk'] = { ['name'] = "黄泉", ['subtype'] = '3k_general_fire', ['weapon'] = { 'hlyjdkwuqi' } },
    ['hlyjdl'] = { ['name'] = "今汐", ['subtype'] = '3k_general_wood', ['weapon'] = { 'hlyjdlwuqi' } },
    ['hlyjdm'] = { ['name'] = "长离", ['subtype'] = '3k_general_fire', ['weapon'] = { 'hlyjdmwuqi' } },
    ['hlyjdo'] = { ['name'] = "八重神子", ['subtype'] = '3k_general_earth' },
    ['hlyjdp'] = { ['name'] = "宵宫", ['subtype'] = '3k_general_fire' },
    ['hlyjdq'] = { ['name'] = "飞霄", ['subtype'] = '3k_general_fire', ['weapon'] = { 'hlyjdqwuqi', 'hlyjdqwuqi2' } },
    ['hlyjds'] = { ['name'] = "景元", ['subtype'] = '3k_general_earth', ['weapon'] = { 'hlyjdswuqi' } },
    ['hlyjdr'] = { ['name'] = "守岸人", ['subtype'] = '3k_general_earth' },
    ['hlyjdu'] = { ['name'] = "花火", ['subtype'] = '3k_general_earth' },
    ['hlyjdt'] = { ['name'] = "申鹤", ['subtype'] = '3k_general_metal', ['weapon'] = { 'hlyjdtwuqi' } },
    ['hlyjdv'] = { ['name'] = "星见雅", ['subtype'] = '3k_general_metal', ['weapon'] = { 'hlyjdvwuqi' } },
    ['hlyjdw'] = { ['name'] = "忘归人", ['subtype'] = '3k_general_fire', ['weapon'] = { 'hlyjdwwuqi' } },
    ['hlyjdx'] = { ['name'] = "砂金", ['subtype'] = '3k_general_metal' },
    ['hlyjdy'] = { ['name'] = "珂莱塔", ['subtype'] = '3k_general_wood', ['weapon'] = { 'hlyjdywuqi' } },
    ['hlyjdz'] = {['name']="神里绫华", ['subtype']='3k_general_metal', ['weapon']={'hlyjdzwuqi'}},
    ['hlyjea'] = { ['name'] = "菲比", ['subtype'] = '3k_general_earth', ['weapon'] = { 'hlyjeawuqi' } },
    ['hlyjeb'] = { ['name'] = "坎特蕾拉", ['subtype'] = '3k_general_water' },
    ['hlyjec'] = { ['name'] = "艾莲", ['subtype'] = '3k_general_wood', ['weapon'] = { 'hlyjecwuqi' } },
    ['hlyjed'] = { ['name'] = "琳妮特", ['subtype'] = '3k_general_metal', ['weapon'] = { 'hlyjedwuqi' } },
}

gst.xyy_character_list = {
    "hlyjch", 
    "hlyjci", 
    "hlyjcj", 
    "hlyjck", 
...
gst.cant_be_maimed_characters = {
    "hlyja",
    "3k_dlc04_template_historical_zhang_jue_healer"
}

gst.character_relationship = {
    {['character_from'] = "hlyjcj", ['character_to'] = 'hlyjdj', ['relationship'] = '3k_dlc05_relationship_trigger_set_startpos_romance'}, --卡芙卡对流萤
    {['character_from'] = "hlyjco", ['character_to'] = 'hlyjcl', ['relationship'] = '3k_dlc05_relationship_trigger_set_startpos_romance'}, --芙宁娜对那维莱特
    {['character_from'] = "hlyjcx", ['character_to'] = 'hlyjch', ['relationship'] = '3k_dlc05_relationship_trigger_set_startpos_romance'}, --胡桃对钟离
    {['character_from'] = "hlyjdc", ['character_to'] = 'hlyjdd', ['relationship'] = '3k_main_relationship_trigger_set_event_family_member'}, --空和荧
    {['character_from'] = "hlyjdl", ['character_to'] = 'hlyjdm', ['relationship'] = '3k_dlc05_relationship_trigger_set_startpos_romance'}, --长离和今汐
    {['character_from'] = "hlyjdo", ['character_to'] = 'hlyjcu', ['relationship'] = '3k_xyy_relationship_trigger_set_kokomi_and_miko'}, --心海和八重神子
    {['character_from'] = "hlyjdo", ['character_to'] = 'hlyjcm', ['relationship'] = '3k_xyy_relationship_trigger_set_raiden_ei_and_miko'}, --雷电将军和八重神子
    {['character_from'] = "hlyjck", ['character_to'] = 'hlyjds', ['relationship'] = '3k_dlc05_relationship_trigger_set_startpos_romance'}, --镜流和景元
    {['character_from'] = "hlyjdt", ['character_to'] = 'hlyjci', ['relationship'] = '3k_dlc05_relationship_trigger_set_startpos_romance'}, --申鹤和甘雨
    {['character_from'] = "hlyjdw", ['character_to'] = 'hlyjct', ['relationship'] = '3k_dlc05_relationship_trigger_set_startpos_romance'}, --停云和阮梅
    {['character_from'] = "hlyjdz", ['character_to'] = 'hlyjdd', ['relationship'] = '3k_xyy_relationship_trigger_set_ayaka_and_lumine'}, --神里绫华和荧
    {['character_from'] = "hlyjeb", ['character_to'] = 'hlyjdy', ['relationship'] = '3k_xyy_relationship_trigger_set_cantarella_and_carlotta'}, --坎特蕾拉和珂莱塔
    {['character_from'] = "hlyjdf", ['character_to'] = 'hlyjcm', ['relationship'] = '3k_dlc05_relationship_trigger_set_startpos_romance'}, --九条裟罗和雷电将军
    {['character_from'] = "hlyjcm", ['character_to'] = 'hlyjcu', ['relationship'] = '3k_main_relationship_trigger_set_event_negative_betrayed'}, --心海和雷电将军
}

gst.xyy_character_up_pool = {
    'hlyjcj',
    'hlyjec',
    'hlyjed'
};
...
gst.separatist_factions = {
    ['3k_main_faction_anding'] = "3k_main_faction_anding_separatists",
    ['3k_main_faction_anping'] = "3k_main_faction_anping_separatists",
    ['3k_main_faction_ba'] = "3k_main_faction_ba_separatists",
    ['3k_main_faction_badong'] = "3k_main_faction_badong_separatists",
    ['3k_main_faction_baxi'] = "3k_main_faction_baxi_separatists",
    ['3k_main_faction_beihai'] = "3k_main_faction_beihai_separatists",
    ['3k_main_faction_bohai'] = "3k_main_faction_bohai_separatists",
    ['3k_main_faction_cai_mao'] = "3k_main_faction_cai_mao_separatists",
    ['3k_main_faction_cangwu'] = "3k_main_faction_cangwu_separatists",
    ['3k_main_faction_cao_cao'] = "3k_main_faction_cao_separatists",
    ['3k_main_faction_changan'] = "3k_main_faction_changan_separatists",
    ['3k_main_faction_changsha'] = "3k_main_faction_changsha_separatists",
    ['3k_main_faction_chen'] = "3k_main_faction_chen_separatists",
    ['3k_main_faction_chengdu'] = "3k_main_faction_chengdu_separatists",
    ['3k_main_faction_daijun'] = "3k_main_faction_daijun_separatists",
    ['3k_main_faction_dong_zhuo'] = "3k_main_faction_dong_separatists",
    ['3k_main_faction_donghai'] = "3k_main_faction_donghai_separatists",
    ['3k_main_faction_dongjun'] = "3k_main_faction_dongjun_separatists",
    ['3k_main_faction_donglai'] = "3k_main_faction_donglai_separatists",
    ['3k_main_faction_dongou'] = "3k_main_faction_dongou_separatists",
    ['3k_main_faction_fuling'] = "3k_main_faction_fuling_separatists",
    ['3k_main_faction_gao_gan'] = "3k_main_faction_gao_gan_separatists",
    ['3k_main_faction_gaoliang'] = "3k_main_faction_gaoliang_separatists",
    ['3k_main_faction_gongsun_du'] = "3k_main_faction_gongsun_du_separatists",
    ['3k_main_faction_gongsun_zan'] = "3k_main_faction_gongsun_separatists",
    ['3k_main_faction_guangling'] = "3k_main_faction_guangling_separatists",
    ['3k_main_faction_han_empire'] = "3k_main_faction_han_empire_separatists",
    ['3k_main_faction_han_fu'] = "3k_dlc04_faction_han_fu_separatists",
    ['3k_main_faction_han_sui'] = "3k_main_faction_han_sui_separatists",
    ['3k_main_faction_hanzhong'] = "3k_main_faction_hanzhong_separatists",
    ['3k_main_faction_hedong'] = "3k_main_faction_hedong_separatists",
    ['3k_main_faction_henei'] = "3k_main_faction_henei_separatists",
    ['3k_main_faction_hepu'] = "3k_main_faction_hepu_separatists",
    ['3k_main_faction_huang_zu'] = "3k_main_faction_huang_zu_separatists",
    ['3k_main_faction_jia_long'] = "3k_main_faction_jia_long_separatists",
    ['3k_main_faction_jianan'] = "3k_main_faction_jianan_separatists",
    ['3k_main_faction_jiangxia'] = "3k_main_faction_jiangxia_separatists",
    ['3k_main_faction_jiangyang'] = "3k_main_faction_jiangyang_separatists",
    ['3k_main_faction_jianning'] = "3k_main_faction_jianning_separatists",
    ['3k_main_faction_jianye'] = "3k_main_faction_jianye_separatists",
    ['3k_main_faction_jiaozhi'] = "3k_main_faction_jiaozhi_separatists",
    ['3k_main_faction_jincheng'] = "3k_main_faction_jincheng_separa...",
    ['3k_main_faction_jingzhou'] = "3k_main_faction_jingzhou_separatists",
    ['3k_main_faction_kong_rong'] = "3k_main_faction_kong_rong_separatists",
    ['3k_main_faction_kong_zhou'] = "3k_main_faction_kong_zhou_separatists",
    ['3k_main_faction_kuaiji'] = "3k_main_faction_kuaiji_separatists",
    ['3k_main_faction_langye'] = "3k_main_faction_langye_separatists",
    ['3k_main_faction_lingling'] = "3k_main_faction_lingling_separatists",
    ['3k_main_faction_liu_bei'] = "3k_main_faction_liu_bei_separatists",
    ['3k_main_faction_liu_biao'] = "3k_main_faction_liu_biao_separatists",
    ['3k_main_faction_liu_dai'] = "3k_main_faction_liu_dai_separatists",
    ['3k_main_faction_liu_yan'] = "3k_main_faction_liu_yan_separatists",
    ['3k_main_faction_liu_yao'] = "3k_main_faction_liu_yao_separatists",
    ['3k_main_faction_liu_yu'] = "3k_main_faction_liu_yu_separatists",
    ['3k_main_faction_lu_bu'] = "3k_dlc05_faction_lu_bu_separatists",
    ['3k_main_faction_lu_zhi'] = "3k_dlc04_faction_lu_zhi_separatists",
    ['3k_main_faction_lujiang'] = "3k_main_faction_lujiang_separatists",
    ['3k_main_faction_luling'] = "3k_main_faction_luling_separatists",
    ['3k_main_faction_luoyang'] = "3k_main_faction_luoyang_separatists",
    ['3k_main_faction_ma_teng'] = "3k_main_faction_ma_teng_separatists",
    ['3k_main_faction_nanhai'] = "3k_main_faction_nanhai_separatists",
    ['3k_main_faction_nanyang'] = "3k_main_faction_nanyang_separatists",
    ['3k_main_faction_penchang'] = "3k_main_faction_penchang_separatists",
    ['3k_main_faction_pingyuan'] = "3k_main_faction_pingyuan_separatists",
    ['3k_main_faction_poyang'] = "3k_main_faction_poyang_separatists",
    ['3k_main_faction_runan'] = "3k_main_faction_runan_separatists",
    ['3k_main_faction_shangdang'] = "3k_main_faction_shangdang_separatists",
    ['3k_main_faction_shangyong'] = "3k_main_faction_shangyong_separatists",
    ['3k_main_faction_shi_xie'] = "3k_main_faction_shi_separatists",
    ['3k_main_faction_shoufang'] = "3k_main_faction_shoufang_separatists",
    ['3k_main_faction_sun_jian'] = "3k_main_faction_sun_separatists",
    ['3k_main_faction_taishan'] = "3k_main_faction_taishan_separatists",
    ['3k_main_faction_taiyuan'] = "3k_main_faction_taiyuan_separatists",
    ['3k_main_faction_tao_qian'] = "3k_main_faction_tao_qian_separatists",
    ['3k_main_faction_tong\'an'] = "3k_main_faction_tong\'an_separatists",
    ['3k_main_faction_wang_kuang'] = "3k_main_faction_wang_kuang_separatists",
    ['3k_main_faction_wang_lang'] = "3k_main_faction_wang_lang_separatists",
    ['3k_main_faction_weijun'] = "3k_main_faction_weijun_separatists",
    ['3k_main_faction_wudu'] = "3k_main_faction_wudu_separatists",
    ['3k_main_faction_wuling'] = "3k_main_faction_wuling_separatists",
    ['3k_main_faction_wuwei'] = "3k_main_faction_wuwei_separatists",
    ['3k_main_faction_xiangyang'] = "3k_main_faction_xiangyang_separatists",
    ['3k_main_faction_xihe'] = "3k_main_faction_xihe_separatists",
    ['3k_main_faction_xindu'] = "3k_main_faction_xindu_separatists",
    ['3k_main_faction_yangzhou'] = "3k_main_faction_yangzhou_separatists",
    ['3k_main_faction_yanmen'] = "3k_main_faction_yanmen_separatists",
    ['3k_main_faction_ye'] = "3k_main_faction_ye_separatists",
    ['3k_main_faction_yingchuan'] = "3k_main_faction_yingchuan_separatists",
    ['3k_main_faction_yizhou'] = "3k_main_faction_yizhou_separatists",
    ['3k_main_faction_youbeiping'] = "3k_main_faction_youbeiping_separatists",
    ['3k_main_faction_youzhou'] = "3k_main_faction_youzhou_separatists",
    ['3k_main_faction_yu'] = "3k_main_faction_yu_separatists",
    ['3k_main_faction_yuan_shao'] = "3k_main_faction_yuan_separatists",
    ['3k_main_faction_yuan_shu'] = "3k_main_faction_yuan_shu_separatists",
    ['3k_main_faction_yulin'] = "3k_main_faction_yulin_separatists",
    ['3k_main_faction_yuzhang'] = "3k_main_faction_yuzhang_separatists",
    ['3k_main_faction_zangke'] = "3k_main_faction_zangke_separatists",
    ['3k_main_faction_zhai_rong'] = "3k_main_faction_zhai_rong_separatists",
    ['3k_main_faction_zhang_chao'] = "3k_main_faction_zhang_chao_separatists",
    ['3k_main_faction_zhang_lu'] = "3k_main_faction_zhang_separatists",
    ['3k_main_faction_zhang_yan'] = "3k_main_faction_zhang_yan_separatists",
    ['3k_main_faction_zhang_yang'] = "3k_main_faction_zhang_yang_separatists",
    ['3k_main_faction_zhongshan'] = "3k_main_faction_zhongshan_separatists",
    ['3k_dlc04_faction_bian_zhang'] = "3k_dlc04_faction_bian_zhang_separatists",
    ['3k_dlc04_faction_cao_song'] = "3k_dlc04_faction_cao_song_separatists",
    ['3k_dlc04_faction_chen_gui'] = "3k_dlc04_faction_chen_gui_separatists",
    ['3k_dlc04_faction_chu_gong'] = "3k_dlc04_faction_chu_gong_separatists",
    ['3k_dlc04_faction_dai'] = "3k_dlc04_faction_dai_separatists",
    ['3k_dlc04_faction_ding_yuan'] = "3k_dlc04_faction_ding_yuan_separatists",
    ['3k_dlc04_faction_dong'] = "3k_dlc04_faction_dong_separatists",
    ['3k_dlc04_faction_dong_he'] = "3k_dlc04_faction_dong_he_separatists",
    ['3k_dlc04_faction_empress_he'] = "3k_dlc04_faction_empress_he_separatists",
    ['3k_dlc04_faction_liang_rebels'] = "3k_dlc04_faction_liang_rebels_separatists",
    ['3k_dlc04_faction_liu_hong'] = "3k_dlc04_faction_liu_hong_separatists",
    ['3k_dlc04_faction_liu_xun'] = "3k_dlc04_faction_liu_xun_separatists",
    ['3k_dlc04_faction_lu_kang'] = "3k_dlc04_faction_lu_kang_separatists",
    ['3k_dlc04_faction_lu_zhi'] = "3k_dlc04_faction_lu_zhi_separatists",
    ['3k_dlc04_faction_prince_liu_chong'] = "3k_dlc04_faction_prince_liu_chong_separatists",
    ['3k_dlc04_faction_qiao_mao'] = "3k_dlc04_faction_qiao_mao_separatists",
    ['3k_dlc04_faction_wang_rui'] = "3k_dlc04_faction_wang_rui_separatists",
    ['3k_dlc04_faction_wei'] = "3k_dlc04_faction_wei_separatists",
    ['3k_dlc04_faction_xin_xuan'] = "3k_dlc04_faction_xin_xuan_separatists",
    ['3k_dlc04_faction_ying_shao'] = "3k_dlc04_faction_ying_shao_separatists",
    ['3k_dlc04_faction_yizhou_island'] = "3k_dlc04_faction_yizhou_island_separatists",
    ['3k_dlc04_faction_yuan_yi'] = "3k_dlc04_faction_yuan_yi_separatists",
    ['3k_dlc04_faction_zhang_bao'] = "3k_dlc04_faction_zhang_bao_separatists",
    ['3k_dlc04_faction_zhang_jue'] = "3k_dlc04_faction_zhang_jue_separatists",
    ['3k_dlc04_faction_zhang_liang'] = "3k_dlc04_faction_zhang_liang_separatists",
    ['3k_dlc04_faction_zhou_xin'] = "3k_dlc04_faction_zhou_xin_separatists",
    ['3k_dlc05_faction_hua_xin'] = "3k_dlc05_faction_hua_xin_separatists",
    ['3k_dlc05_faction_sheng_xian'] = "3k_dlc05_faction_sheng_xian_separatists",
    ['3k_dlc05_faction_shi_huang'] = "3k_dlc05_faction_shi_huang_separatists",
    ['3k_dlc05_faction_shi_wu'] = "3k_dlc05_faction_shi_wu_separatists",
    ['3k_dlc05_faction_shi_yi'] = "3k_dlc05_faction_shi_yi_separatists",
    ['3k_dlc05_faction_sun_ce'] = "3k_dlc05_faction_sun_ce_separatists",
    ['3k_dlc05_faction_tian_kai'] = "3k_dlc05_faction_tian_kai_separatists",
    ['3k_dlc05_faction_white_tiger_yan'] = "3k_dlc05_faction_white_tiger_yan_separatists",
    ['3k_dlc05_faction_wu_jing'] = "3k_dlc05_faction_wu_jing_separatists",
    ['3k_dlc05_faction_xu_gong'] = "3k_dlc05_faction_xu_gong_separatists",
    ['3k_dlc05_faction_xu_zhao'] = "3k_dlc05_faction_xu_zhao_separatists",
    ['3k_dlc05_faction_xue_li'] = "3k_dlc05_faction_xue_li_separatists",
    ['3k_dlc05_faction_yang_feng'] = "3k_dlc05_faction_yang_feng_separatists",
    ['3k_dlc05_faction_yuan_tan'] = "3k_dlc05_faction_yuan_tan_separatists",
    ['3k_dlc05_faction_zang_ba'] = "3k_dlc05_faction_zang_ba_separatists",
    ['3k_dlc05_faction_zhu_fu'] = "3k_dlc05_faction_zhu_fu_separatists",
    ['3k_dlc06_faction_jiuzhen'] = "3k_dlc06_faction_jiuzhen_separatists",
    ['3k_dlc06_faction_liaodong'] = "3k_dlc06_faction_liaodong_separatists",
    ['3k_dlc06_faction_nanman_ahuinan'] = "3k_dlc06_faction_nanman_ahuinan_separatists",
    ['3k_dlc06_faction_nanman_dongtuna'] = "3k_dlc06_faction_nanman_dongtuna_separatists",
    ['3k_dlc06_faction_nanman_jiangyang'] = "3k_dlc06_faction_nanman_jiangyang_separatists",
    ['3k_dlc06_faction_nanman_jianning'] = "3k_dlc06_faction_nanman_jianning_separatists",
    ['3k_dlc06_faction_nanman_jiaozhi'] = "3k_dlc06_faction_nanman_jiaozhi_separatists",
    ['3k_dlc06_faction_nanman_jinhuansanjie'] = "3k_dlc06_faction_nanman_jinhuansanjie_separatists",
    ['3k_dlc06_faction_nanman_king_duosi'] = "3k_dlc06_faction_nanman_king_duosi_separatists",
    ['3k_dlc06_faction_nanman_king_meng_huo'] = "3k_dlc06_faction_nanman_king_meng_huo_separatists",
    ['3k_dlc06_faction_nanman_king_mulu'] = "3k_dlc06_faction_nanman_king_mulu_separatists",
    ['3k_dlc06_faction_nanman_king_shamoke'] = "3k_dlc06_faction_nanman_king_shamoke_separatists",
    ['3k_dlc06_faction_nanman_king_wutugu'] = "3k_dlc06_faction_nanman_king_wutugu_separatists",
    ['3k_dlc06_faction_nanman_lady_zhurong'] = "3k_dlc06_faction_nanman_lady_zhurong_separatists",
    ['3k_dlc06_faction_nanman_mangyachang'] = "3k_dlc06_faction_nanman_mangyachang_separatists",
    ['3k_dlc06_faction_nanman_tu_an'] = "3k_dlc06_faction_nanman_tu_an_separatists",
    ['3k_dlc06_faction_nanman_xi_ni'] = "3k_dlc06_faction_nanman_xi_ni_separatists",
    ['3k_dlc06_faction_nanman_yang_feng'] = "3k_dlc06_faction_nanman_yang_feng_separatists",
    ['3k_dlc06_faction_nanman_yongchang'] = "3k_dlc06_faction_nanman_yongchang_separatists",
    ['3k_dlc06_faction_nanman_yunnan'] = "3k_dlc06_faction_nanman_yunnan_separatists",
    ['3k_dlc06_faction_nanman_zangke'] = "3k_dlc06_faction_nanman_zangke_separatists",
    ['3k_dlc06_faction_xiapi'] = "3k_dlc06_faction_xiapi_separatists",
    ['3k_dlc06_faction_yongchang'] = "3k_dlc06_faction_yongchang_separatists",
    ['3k_dlc06_faction_yunnan'] = "3k_dlc06_faction_yunnan_separatists",
    ['3k_dlc07_faction_chen_deng'] = "3k_dlc07_faction_chen_deng_separatists",
    ['3k_dlc07_faction_li_shu'] = "3k_dlc07_faction_li_shu_separatists",
    ['3k_dlc07_faction_shanyue_rebels'] = "3k_dlc07_faction_shanyue_rebels_separatists",
    ['3k_dlc07_faction_shi_hui'] = "3k_dlc07_faction_shi_hui_separatists",
    ['3k_dlc07_faction_yuan_xi'] = "3k_dlc07_faction_yuan_xi_separatists",
    ['3k_dlc07_faction_zhang_lu'] = "3k_dlc07_faction_zhang_lu_separatists",
    ['3k_dlc07_faction_zhang_meng'] = "3k_dlc07_faction_zhang_meng_separatists",
    ['3k_dlc07_faction_zhang_xiu'] = "3k_dlc07_faction_zhang_xiu_separatists",
    ['3k_main_faction_yellow_turban_anding'] = "3k_main_faction_yellow_turban_rebels",
    ['3k_main_faction_yellow_turban_taishan'] = "3k_main_faction_yellow_turban_rebels",
    ['3k_main_faction_yellow_turban_generic'] = "3k_main_faction_yellow_turban_rebels"
}

gst.gatepass_table = {
    ["3k_dlc06_hulao_pass"] = { ["x"] = 295.88, ["y"] = 371.34 },
    ["3k_dlc06_gu_pass"] = { ["x"] = 266.49, ["y"] = 405.28 },
    ["3k_dlc06_hangu_pass"] = { ["x"] = 257.15, ["y"] = 368.86 },
    ["3k_dlc06_jiameng_pass"] = { ["x"] = 155.62, ["y"] = 339.73 },
    ["3k_dlc06_kui_pass"] = { ["x"] = 232.43, ["y"] = 305.41 },
    ["3k_dlc06_qi_pass"] = { ["x"] = 263.82, ["y"] = 377.52 },
    ["3k_dlc06_san_pass"] = { ["x"] = 177, ["y"] = 370.57 },
    ["3k_dlc06_tong_pass"] = { ["x"] = 229.76, ["y"] = 367.87 },
    ["3k_dlc06_wu_pass"] = { ["x"] = 224.41, ["y"] = 360.16 },
}

gst.building_list = {
    ["xyy_roguelike_craft_accessories"] = {
        "3k_district_government_administration_5",                       --皇宫
        "3k_district_government_administration_6",                       --腐败皇宫
        "3k_district_government_administration_black_mountain_palace_5", --黑山大殿
        "3k_ytr_district_government_organisation_yellow_turban_5",       --黄巾总寨
        "3k_district_government_administration_decadence_5",             --仲家宫殿
        "3k_district_government_administration_yuan_5",                  --袁氏宫殿
    },
    ["xyy_roguelike_craft_accessories_1"] = {
        "3k_district_government_administration_4",                       --郡府
        "3k_district_government_administration_5",                       --皇宫
        "3k_district_government_administration_6",                       --腐败皇宫
        "3k_district_government_administration_black_mountain_palace_4", --黑山公堂
        "3k_district_government_administration_black_mountain_palace_5", --黑山大殿
        "3k_ytr_district_government_organisation_yellow_turban_4",       --渠帅府
        "3k_ytr_district_government_organisation_yellow_turban_5",       --黄巾总寨
        "3k_district_government_administration_decadence_4",             --仲家郡府
        "3k_district_government_administration_decadence_5",             --仲家宫殿
        "3k_district_government_administration_yuan_4",                  --袁氏郡府
        "3k_district_government_administration_yuan_5",                  --袁氏宫殿
    },
    ["xyy_roguelike_craft_weapons"] = {
        "3k_resource_metal_craftsmen_weapon_3",        --传奇冶兵所
        "3k_resource_metal_craftsmen_weapon_bandit_3", --隐蔽要塞（武器坊）
    },
    ["xyy_roguelike_craft_weapons_1"] = {
        "3k_resource_metal_craftsmen_weapon_3",        --传奇冶兵所
        "3k_resource_metal_craftsmen_weapon_bandit_3", --隐蔽要塞（武器坊）
        "3k_district_military_equipment_weapons_3",    --冶兵所
        "3k_district_military_equipment_ranged_3",     --制弓所
    },
    ["xyy_roguelike_craft_mounts"] = {
        "3k_resource_metal_craftsmen_animal_3",        --传奇驯兽场
        "3k_resource_metal_craftsmen_animal_bandit_3", --大贼徒营地（驯兽场）
    },
    ["xyy_roguelike_craft_mounts_1"] = {
        "3k_resource_metal_craftsmen_animal_3",        --传奇驯兽场
        "3k_resource_metal_craftsmen_animal_bandit_3", --大贼徒营地（驯兽场）
        "3k_resource_fire_northern_horses_5",          --胡马场
        "3k_resource_metal_craftsmen_animal_bandit_3", --大贼徒营地（马场）
    },
    ["xyy_roguelike_craft_armors"] = {
        "3k_resource_metal_craftsmen_armour_3",        --传奇铸甲所
        "3k_resource_metal_craftsmen_armour_bandit_3", --隐蔽要塞（护甲坊）
    },
    ["xyy_roguelike_craft_armors_1"] = {
        "3k_resource_metal_craftsmen_armour_3",        --传奇铸甲所
        "3k_resource_metal_craftsmen_armour_bandit_3", --隐蔽要塞（护甲坊）
        "3k_district_military_equipment_armour_3",     --铸甲所
    },
}

gst.locked_character = {
    ["hlyjdj"] = { ["reason"] = "mod_xyy_character_browser_locked_hlyjdj" },
    ["hlyjdw"] = { ["reason"] = "mod_xyy_character_browser_locked_hlyjdw" },
    ["hlyjdv"] = { ["reason"] = "mod_xyy_character_browser_locked_hlyjdv" },
    ["hlyjeb"] = { ["reason"] = "mod_xyy_character_browser_locked_hlyjea" },
}
