...
cdir_events_manager.post_trigger_actions = {
	...
	["3k_main_historical_liu_zhuge_liang_npc_incident"] = {
		function()
            ...
            if not zhuge_liang or zhuge_liang:is_null_interface() then
	...
	["3k_main_historical_cao_sima_yi_npc_incident"] = {
		function()
            local sima_yi = cm:query_model():character_for_template("3k_main_template_historical_sima_yi_hero_water")
            if not sima_yi or sima_yi:is_null_interface() then
